...
El modelo de datos es el de RT §7.1: `ALUMNO`, `TRABAJO`, `PIEZA`, `COMPONENTE` y `OBSERVACION`, con `OriginalJson` conservado íntegro y nunca reescrito (RN-08).
