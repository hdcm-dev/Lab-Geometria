...
>
> Copia archivada de `PRODUCT-MANIFEST-Fabrica-De-Geometria.md` en su versión **4.0**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de reescribir el bloque de procedencia en la fase **M5** de la migración 10.0 → 13.3 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 4.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`PRODUCT-MANIFEST-Fabrica-De-Geometria.md`](../../PRODUCT-MANIFEST-Fabrica-De-Geometria.md)
>
