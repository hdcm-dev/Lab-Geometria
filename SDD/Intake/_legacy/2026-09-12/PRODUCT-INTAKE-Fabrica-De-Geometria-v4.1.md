...
| X-10 | Túnel saliente con dominio propio para el backend | [DECISIÓN, RT §15.1] Con la marca **[A VERIFICAR]** heredada de la fuente sobre la disponibilidad de un dominio propio, que §22 registra. Resolvería R-02, R-04 y R-05 de una vez, pero exige un dominio propio y **debilita la premisa de la topología**: si la API queda alcanzable desde la facultad, el front en el hosting deja de ser necesario | Reevaluar si aparece un dominio propio o si PT-01 obliga a mover el front |
