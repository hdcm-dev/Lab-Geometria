...
**Tres decisiones del Product Owner del 2026-08-12**, que cierran las zonas de frontera que `SDD/Docs/Producto/Norma-De-Nomenclatura.md` 1.0 había elevado. La norma es la fuente: **este intake las registra, no las redeclara**, y **no renombra todavía ningún identificador**. El renombre es una tanda posterior y se ejecuta contra el glosario de la norma, en el orden de su §8.
...
**Lo que este intake no hace.** No transcribe el glosario: son **155 identificadores en seis clases** y su fuente única es la norma §6.2 a §6.8. **Ningún identificador de este documento cambia en la versión 1.30.** La regla operativa que rige a partir de acá es la de la norma §6.1: **si un concepto no está en el glosario, no se traduce por criterio propio — se agrega primero**.
