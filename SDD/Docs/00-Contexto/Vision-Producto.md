...
| RG-07 | **El hosting gratuito da de baja el sitio si no recibe al menos cinco visitas en el mes.** Es una condición del plan gratuito, verificada en el panel de la cuenta el 2026-08-13, y choca de frente con la forma de uso del producto: un laboratorio de aula se usa **por ráfagas**, concentrado en los días de entrega, y entre una entrega y la siguiente puede pasar un mes entero sin que nadie lo abra | Media: no depende de una falla sino de que el calendario de la materia deje un mes sin actividad, cosa que ocurre entre cursadas y en receso | **Alto**: el laboratorio desaparece de la dirección pública sin que nadie haya hecho nada mal, y volver a ponerlo en línea exige rehacer el despliegue, que es manual (R-07) | **Una comprobación periódica contra la dirección pública**, que ya existe: es la misma petición con la que se cierra `PT-01.a`, y correrla una vez por semana cuesta un comando. **Con una salvedad que hay que verificar antes de confiar en ella: no está comprobado que el proveedor cuente una petición automática como visita**; mientras no lo esté, la mitigación efectiva es **abrir la dirección pública con un navegador** unas pocas veces al mes. Y como red de contención, la publicación se puede rehacer: el procedimiento está documentado | Administrador del laboratorio |
