...
| F-04 | Establecer contraseña en el primer ingreso efectivo del alumno, sin envío de correo. **El alumno se identifica con la contraseña provisoria que el sistema produce al habilitarlo** —el mismo mecanismo del reseteo de F-26— y la cambia por el camino de RN-02013 (**RN-02016**, `PRODUCT-INTAKE` 1.13) | `d` |
...
- [ ] Un alumno se registra, es habilitado por el administrador —lo que le produce una **contraseña provisoria** que la pantalla le muestra al administrador para que se la comunique—, entra con esa provisoria, **queda obligado a cambiarla** y recién entonces accede a su panel, sin que intervenga ningún correo (F-02, F-03, F-04, RN-02016).
- [ ] **Ningún punto del producto acepta un correo y una contraseña nueva sin credencial**: toda operación que fija una contraseña ocurre con la cuenta ya autenticada (RN-02016).
