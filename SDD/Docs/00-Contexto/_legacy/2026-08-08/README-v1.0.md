...
**Trazabilidad upstream:** PRODUCT-INTAKE §2 (stakeholders y cantidad de personas del equipo), §13 (composición del producto), PRODUCT-MANIFEST §5 (flag `equipo_n`)
...
|---|---|---|
| `Vision-Producto.md` | Por qué existe el producto, a quién sirve, qué promete, sus objetivos con métrica y plazo, sus restricciones, sus riesgos y el **glosario raíz del dominio** | Propuesto, versión 1.0 |
| `Alcance-Producto.md` | Qué entra y qué no entra, con la justificación de cada exclusión, los supuestos de los que depende el alcance y los criterios de aceptación del producto | Propuesto, versión 1.0 |
| `Roadmap-Producto.md` | Las ocho fases, sus dependencias y los criterios verificables de transición entre ellas. Sin fechas, por decisión declarada aguas arriba | Propuesto, versión 1.0 |
| `Compatibilidad-Plataformas.md` | Las tres matrices de plataforma del producto, sus divergencias, la regla de precedencia y el estado de verificación de cada una | Propuesto, versión 1.0 |
| `README.md` | Este archivo: índice de la sección, orden de lectura, omisiones declaradas y stakeholders | Propuesto, versión 1.0 |
...
- **Valores pendientes de confirmación.** Los targets de las tres métricas de negocio están rotulados como asunción en el intake y esperan confirmación del Product Owner (`Alcance-Producto.md` §6.1). Se usan como valores vigentes hasta que la confirmación llegue.
