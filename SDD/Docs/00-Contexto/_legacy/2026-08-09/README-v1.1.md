...
>
> Copia archivada de `README.md` en su versión **1.1**, tomada el 2026-08-09 por el orquestador SDD **antes** de despachar la propagación de la Fase B2 (`Master-Prompt.md` §8).
>
> - **Estado:** `Superado`
...
**Trazabilidad upstream:** PRODUCT-INTAKE 1.3 §2 (stakeholders y cantidad de personas del equipo), §4.2 (colisión de vocabulario de `Pendiente`), §13 (composición del producto), PRODUCT-MANIFEST §5 (flag `equipo_n`)
...
|---|---|---|
| `Vision-Producto.md` | Por qué existe el producto, a quién sirve, qué promete, sus objetivos con métrica y plazo, sus restricciones, sus riesgos y el **glosario raíz del dominio** | Propuesto, versión 1.1 |
| `Alcance-Producto.md` | Qué entra y qué no entra, con la justificación de cada exclusión, los supuestos de los que depende el alcance y los criterios de aceptación del producto | Propuesto, versión 1.1 |
| `Roadmap-Producto.md` | Las ocho fases comprometidas, `a` a `h`, más el tramo pendiente `i…`, con sus dependencias y los criterios verificables de transición. Sin fechas, por decisión declarada aguas arriba | Propuesto, versión 1.1 |
...
| `README.md` | Este archivo: índice de la sección, orden de lectura, omisiones declaradas y stakeholders | Propuesto, versión 1.1 |
...
| El mismo docente, en su papel de **administrador del laboratorio**, con la cuenta única de administrador | Beneficiario y operador | Habilita, bloquea y da de baja cuentas; revisa, filtra y agrupa los trabajos de toda la comisión |
...
- **Punto abierto escalado.** El alcance del objetivo OBJ-01 quedó escalado al Product Owner: su target cuenta siete etapas y el alcance comprometido pasó a ocho. Está declarado en `Vision-Producto.md` §5 y **no se resuelve en esta categoría**.
