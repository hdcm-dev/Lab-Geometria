...
|---|---|
| El servidor de información **ignora** el pedido de ascenso y responde **200** en vez de **101** (intake §17.6.P.9) | El módulo de WebSocket **no está habilitado para el sitio**, porque el plan no lo incluye. Un servidor que no tiene el módulo activo no completa el ascenso: atiende la petición como una petición corriente |
