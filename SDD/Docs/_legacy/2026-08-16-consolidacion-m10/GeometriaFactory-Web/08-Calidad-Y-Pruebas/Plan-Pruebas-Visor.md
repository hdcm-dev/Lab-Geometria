...
**Qué cubre.** Los **veintiún** casos de prueba de [`Casos-Prueba-Referenciales.md`](Casos-Prueba-Referenciales.md), repartidos entre los **tres** momentos que [`../06-Backlog-Tecnico/Product-Backlog.md`](../../../06-Backlog-Tecnico/_fusion/Visor/Product-Backlog.md) §2 declara como épicas: la etapa `a`, el **momento de medición de `PT-02` y `PT-03`** —antes de comprometer la etapa `g`— y la etapa `g`.
...
- [ ] Las historias del momento cumplen los **siete** criterios de [`../06-Backlog-Tecnico/Definition-Of-Ready.md`](../../../06-Backlog-Tecnico/_fusion/Visor/Definition-Of-Ready.md) §1, incluidos el quinto —qué garantías ejerce— y el sexto —todo código usado es uno de los siete—.
...
Alineados con los **seis** riesgos arquitectónicos de [`../05-Arquitectura-Tecnica/Arquitectura-Proyecto-Codigo.md`](../../../05-Arquitectura-Tecnica/_fusion/Visor/Arquitectura-Proyecto-Codigo.md) §9, más dos propios de esta categoría.
