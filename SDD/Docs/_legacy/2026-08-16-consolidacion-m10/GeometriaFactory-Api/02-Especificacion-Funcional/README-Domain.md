...
La serie es **contigua de RN-02001 a RN-02016**. La columna del invariante es la correspondencia que declara `PRODUCT-INTAKE` §17.1.P.2 · GeometriaFactory-Domain: los invariantes no son reglas distintas, son las mismas vistas desde el dominio.
