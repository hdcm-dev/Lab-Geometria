...
| Reglas de negocio aplicables | [**RN-02013**](../Reglas-De-Negocio/RN-02013-Cambio-Forzado-Antes-De-Toda-Otra-Capacidad.md), **con el tramo que esta capa puede romper sola**: un punto de acceso fuera de la guardia la incumple sin que nada falle. [RN-02001](../Reglas-De-Negocio/RN-02001-Administrador-Unico-Y-Papeles-Fijos.md), por el papel que cada punto exige. [RN-02010](../Reglas-De-Negocio/RN-02010-Desenlace-Exclusivo-Del-Administrador-Y-Terminalidad.md), en el único punto donde el papel insuficiente tiene código del contrato |
