...
| Reglas de negocio aplicables | [RN-02007](../Reglas-De-Negocio/RN-02007-Baja-Con-Arrastre-Y-Confirmacion-Escrita.md), con su tramo acá: **el punto transporta el correo escrito y no procede sin él**. [RN-02001](../Reglas-De-Negocio/RN-02001-Administrador-Unico-Y-Papeles-Fijos.md), por el papel que los tres puntos exigen y por la cuenta que no admite baja. [RN-02006](../Reglas-De-Negocio/RN-02006-Cuenta-Pendiente-O-Bloqueada-Sin-Acceso.md), porque la situación que este punto cambia es la que decide el acceso. [RN-02012](../Reglas-De-Negocio/RN-02012-Reseteo-Conserva-La-Cuenta-Y-Sus-Trabajos.md) **por contraste**: el reseteo es otro punto, otro verbo y otro contrato, y **no pasa por acá** |
