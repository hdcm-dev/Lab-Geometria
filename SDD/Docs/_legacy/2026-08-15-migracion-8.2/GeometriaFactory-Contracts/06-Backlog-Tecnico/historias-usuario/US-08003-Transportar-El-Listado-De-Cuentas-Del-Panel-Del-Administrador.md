# US-08003 — Transportar el listado de cuentas del panel del administrador

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-08003-Transportar-El-Listado-De-Cuentas-Del-Panel-Del-Administrador.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
La capacidad `F-03` del intake §4 declara el panel del administrador, y `F-26` declara que el reseteo se acciona **desde el mismo panel**. El contrato de uso es [`CU-08002`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-08002-Contrato-De-Administracion-De-Cuentas.md).
...
- Given una cuenta con la marca de cambio de contraseña pendiente, When se arma su entrada, Then la marca no viaja como campo que impida operar en la respuesta de sesión: ese camino es el de `RT-10` y es US-08014.
...
| RN que refiere por identificador | RN-08001, RN-08006 |
