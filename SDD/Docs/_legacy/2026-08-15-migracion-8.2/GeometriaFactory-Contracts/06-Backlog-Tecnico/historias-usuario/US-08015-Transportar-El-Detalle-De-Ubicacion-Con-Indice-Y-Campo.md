# US-08015 — Transportar el detalle de ubicación con índice de figura y campo

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-08015-Transportar-El-Detalle-De-Ubicacion-Con-Indice-Y-Campo.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`RN-08009` declara que los mensajes de error de validación indican **índice de figura y campo**, nunca un texto genérico, y `PRODUCT-INTAKE` §17.4.P.5 la ancla explícitamente al tipo de respuesta de error de este proyecto de código. Es la restricción transversal `RT-02` de `02` §6.
...
`Must` por `RN-08009`, declarada cerrada en `PRODUCT-INTAKE` §4.1, y por derivar de `F-09`, `Must Have`.
