# US-08004 — Transportar el cambio de situación de la cuenta

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-08004-Transportar-El-Cambio-De-Situacion-De-La-Cuenta.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
La capacidad `F-03` del intake §4 declara las cuatro operaciones del administrador sobre una cuenta; ésta transporta las tres no destructivas. `RN-08016` declara que habilitar produce la provisoria y que la pantalla se la muestra al administrador para que se la comunique.
...
| RN que refiere por identificador | RN-08001, RN-08006, RN-08014, RN-08016 |
| BT derivadas | BT-08008, BT-08010 |
...
**La provisoria la produce el sistema y no la escribe el administrador** (`RN-08014`); su mecanismo —que no sea adivinable y que no se repita— es de `GeometriaFactory-Infrastructure`. Lo que este tipo hace es transportarla una sola vez, hacia el administrador que la comunica.
