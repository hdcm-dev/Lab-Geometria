# US-08001 — Transportar el canje de credenciales y la respuesta de sesión de cuatro campos

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-08001-Transportar-El-Canje-De-Credenciales-Y-La-Respuesta-De-Sesion.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
La capacidad `F-05` del intake §4 declara el inicio y el cierre de sesión. El contrato de uso es [`CU-08001`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-08001-Contrato-De-Canje-De-Credenciales-Y-Sesion.md). `PRODUCT-INTAKE` §17.4.P.5 declara que ningún tipo lleva el hash de la contraseña ni la clave de firma, y `05` §8 fija la respuesta de sesión en exactamente cuatro campos.
...
| BT derivadas | BT-08006, BT-08008, BT-08009 |
