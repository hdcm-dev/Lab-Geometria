# US-08013 — Transportar la observación con su severidad y su par de valores

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-08013-Transportar-La-Observacion-Con-Severidad-Y-Par-De-Valores.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`NB-00005` es la visibilidad del error de cálculo. La capacidad `F-10` del intake §4 declara la verificación de los valores recalculándolos y las advertencias **que no bloquean**. `02` §4.1 declara que este proyecto de código transporta la severidad y el par de valores en campos propios.
...
- Given un trabajo con advertencias y sin errores, When se consulta su estado en el mismo detalle, Then es `Pendiente`: la advertencia no bloquea, por `RN-08005`.
...
| RN que refiere por identificador | RN-08005, RN-08008, RN-08009 |
