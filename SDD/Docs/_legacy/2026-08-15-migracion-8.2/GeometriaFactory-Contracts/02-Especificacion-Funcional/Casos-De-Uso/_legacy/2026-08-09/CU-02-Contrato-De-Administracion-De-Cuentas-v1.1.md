...
- El contrato no declara ningún tipo que transporte una contraseña provisoria ni un enlace de recuperación: no hay canal de correo en el producto (exclusiones X-1 y X-2 de `Alcance-Producto.md` §5).
