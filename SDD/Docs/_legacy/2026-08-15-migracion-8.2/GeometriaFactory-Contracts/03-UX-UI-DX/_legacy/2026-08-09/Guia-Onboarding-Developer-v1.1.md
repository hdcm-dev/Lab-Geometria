...
**Autor:** DX Lead (AG-03)
**Variante:** DX
**Trazabilidad upstream:** `02-Especificacion-Funcional/Especificacion-Funcional.md` §1, §2, §6 (`RT-01` a `RT-09`); `CU-01` §10 y §17, `CU-02` §17, `CU-03` §1, CA-01, CA-02, §6.1 y §17, `CU-04` CA-01, §6.1, §10 y §17, `CU-05` CA-05, CA-06, CA-07, CA-08, §6.1 y §17, `CU-06` §6, CA-01, §10 y §17, `CU-07` §6, CA-03, CA-05, §10 y §17; `00-Contexto/Vision-Producto.md` §9.1 (Estado del trabajo, Enviar, Aprobar / Rechazar, Comentario) y §9.2; `00-Contexto/Alcance-Producto.md` §2.2 y §8; `01-Necesidades-Negocio/Necesidades-De-Negocio/NB-04-Interpretacion-Fiel-Del-Dato-Del-Alumno.md` §1; `NB-09-Desenlace-Explicito-De-La-Entrega.md` §1; `PRODUCT-INTAKE` 1.3 §4.1, §4.2, §17.4 P.3, P.5, P.6, P.8, P.10 y P.11, §15, §16, §16.1
...
- **Reference** — los siete contratos de uso `CU-01` a `CU-07`, y [`../02-Especificacion-Funcional/Especificacion-Funcional.md`](../02-Especificacion-Funcional/Especificacion-Funcional.md) §6 para las nueve restricciones transversales. Es la descripción normativa de la superficie; esta sección no la duplica.
