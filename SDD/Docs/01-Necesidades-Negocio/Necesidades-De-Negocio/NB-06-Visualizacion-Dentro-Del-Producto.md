...
| Trazabilidad upstream | PRODUCT-INTAKE 1.7 §1 (idea y problema), §3 (diferenciadores D-3 y D-4), §4 (capacidades F-11, F-13 y F-25), §4.1 (regla RN-11), §6 (flujos 2, 2.1 y 3), §17.7 P.10 (el movimiento automático no altera la disposición), §20 (escenarios E-1 y E-7); `Vision-Producto.md` §1, §3 y §9; `Alcance-Producto.md` §4.1, §4.2 y §8; `Roadmap-Producto.md` §3 y §5.2 |
