...
>
> Esta es una **copia archivada** del documento `NB-05-Visibilidad-Del-Error-De-Calculo.md` en su versión **1.0**, tomada el 2026-08-08 por el orquestador SDD antes de que la versión vigente la superara (`Master-Prompt.md` §5 y §5.1).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-08
> - **Versión vigente:** [`NB-05-Visibilidad-Del-Error-De-Calculo.md`](../../NB-00005-Visibilidad-Del-Error-De-Calculo.md)
>
...
| Trazabilidad upstream | PRODUCT-INTAKE §1 (idea y problema), §3 (diferenciador D-2), §4 (capacidad F-10), §6 (flujo 2), §7 (caso límite CL-4), §8 (métrica de valor didáctico entregado), §20 (escenarios E-1 a E-4), §22 (asunción A-2); `Vision-Producto.md` §1, §3, §5 y §9; `Alcance-Producto.md` §3 y §8 |
...
| Carácter no bloqueante | Trabajos que quedan impedidos de guardarse o de entregarse por tener advertencias de valor | 0 | Punto de control de la etapa `f` |
