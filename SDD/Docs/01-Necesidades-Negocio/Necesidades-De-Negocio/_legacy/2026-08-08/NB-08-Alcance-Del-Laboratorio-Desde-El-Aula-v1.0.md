...
>
> Esta es una **copia archivada** del documento `NB-08-Alcance-Del-Laboratorio-Desde-El-Aula.md` en su versión **1.0**, tomada el 2026-08-08 por el orquestador SDD antes de que la versión vigente la superara (`Master-Prompt.md` §5 y §5.1).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-08
> - **Versión vigente:** [`NB-08-Alcance-Del-Laboratorio-Desde-El-Aula.md`](../../NB-00008-Alcance-Del-Laboratorio-Desde-El-Aula.md)
>
...
- Si queda sin resolver: todo lo construido en las otras siete necesidades queda inaccesible para sus destinatarios, y el valor entregado es cero.
...
| --- | --- | --- | --- |
| Acceso verificado desde la red de la facultad | Intentos de acceso al laboratorio desde la red de la facultad que resultan exitosos, sobre los intentos de la verificación de campo | 100 % | Punto de control de la etapa `h`, con la verificación de campo declarada |
...
| Despliegue verificado de las dos piezas desplegables | Piezas desplegables del producto verificadas en su destino real, sobre las 2 que lo componen: la pieza pública y la pieza de datos | 2 de 2 | Punto de control de la etapa `h` |
...
| --- | --- | --- |
| Docente de Programación 2 (TUP), responsable de la cátedra y de la Actividad 1, en su papel de Product Owner | Propietario | Declaró la restricción de red como premisa del producto y aceptó por escrito la ausencia de alta disponibilidad; valida el punto de control de la etapa `h` |
...
| --- | --- | --- |
| NB-08 | CU-21 verificar el acceso al laboratorio desde la red de la facultad | a generar |
| NB-08 | CU-22 presentar el estado degradado cuando el servicio de datos no responde | a generar |
