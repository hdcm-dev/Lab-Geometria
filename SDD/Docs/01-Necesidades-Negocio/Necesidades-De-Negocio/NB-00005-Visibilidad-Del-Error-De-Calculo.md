# NB-00005 — Visibilidad del error de cálculo sobre el trabajo propio

| Campo | Valor |
| --- | --- |
| Producto | Fábrica de Geometría |
| Documento | NB-00005-Visibilidad-Del-Error-De-Calculo.md |
| Versión | 1.1 |
| Estado | Aprobado |
| Fecha | 2026-08-08 |
...
- Depende de: NB-00004, porque los valores sólo se pueden recalcular sobre un trabajo cuyas piezas y dimensiones ya fueron interpretadas.
