...
| --- | --- | --- |
| NB-07 | CU-18 listar los trabajos de la comisión, sin los que están en estado `Borrador`, agrupados y filtrados por alumno | a generar |
...
- Es prerequisito de: NB-09, porque el administrador decide sobre los trabajos que este listado le pone delante.
