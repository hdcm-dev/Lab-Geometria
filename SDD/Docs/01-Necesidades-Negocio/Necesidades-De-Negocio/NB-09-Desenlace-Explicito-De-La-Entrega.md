# NB-09 — Desenlace explícito de la entrega
...
| --- | --- | --- |
| NB-09 | CU-24 aprobar un trabajo en estado `Pendiente`, con comentario opcional | a generar |
| NB-09 | CU-25 rechazar un trabajo en estado `Pendiente`, con comentario opcional | a generar |
| NB-09 | CU-26 consultar el desenlace y el comentario del trabajo propio | a generar |
| NB-09 | CU-27 eliminar un trabajo desde el panel del administrador | a generar |

## 8. Dependencias con otras NB

- Depende de: NB-04, porque el desenlace se ejerce sobre trabajos en estado `Pendiente`, y a ese estado sólo se llega por un envío cuyo texto verifica; y NB-07, porque el administrador decide sobre los trabajos que su listado le pone delante.
