...
| NB-03 | CU-09 reeditar un trabajo en estado `Borrador` | a generar |
| NB-03 | CU-10 eliminar un trabajo propio en estado `Borrador` | a generar |
...
La acción de envío que decide entre `Borrador` y `Pendiente` no pertenece a esta necesidad: vive en NB-04, porque lo que decide el estado es el resultado de interpretar el texto. El desenlace de un trabajo en estado `Pendiente` tampoco: vive en NB-09.
