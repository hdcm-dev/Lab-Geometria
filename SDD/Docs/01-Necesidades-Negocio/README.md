...
- **Valores pendientes de confirmación.** Tres targets provienen de la asunción A-2 del intake y esperan confirmación del Product Owner; están identificados en `Necesidades-Negocio.md` §6, junto con el punto abierto de si el objetivo de avance cuenta siete u ocho etapas, que esta categoría no resuelve.
