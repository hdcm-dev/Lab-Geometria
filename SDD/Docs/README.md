...
> **Al 2026-08-31 queda UN punto abierto de nivel producto, y es una decisión del Product Owner que no se puede tomar leyendo el árbol.** Los otros tres que esta sección declaraba se cerraron el mismo día, y **ninguno de los tres se cerró decidiendo: los tres se cerraron mirando.**

| Punto abierto | Titular | Dónde está declarado |
| --- | --- | --- |
| **El volumen de la comisión: cuántos alumnos.** Es **`D5`**, y es la más consecuente de las cuatro decisiones que le quedan al Product Owner. Sostiene abierto **el único valor pendiente del §22** —el caudal de 20 peticiones por minuto, que quedó fuera de la confirmación `D1`— y **la ausencia de paginación en los dos listados**, cuyo diseño supone decenas y no cientos | **Product Owner** | [`Audit/A3-Decisiones-Del-Product-Owner.md`](Audit/A3-Decisiones-Del-Product-Owner.md) `D5`, y `PRODUCT-INTAKE` §22, donde entró como quinta marca el 2026-08-31. **Evento de cierre:** ninguno, y es lo que la vuelve distinta de todas las demás — **no hay dónde ir a mirarla**. Las otras cuatro incógnitas del producto se resuelven solas al desplegar; ésta es un número que existe fuera del árbol |
