...
La audiencia son dos personas concretas del aula —el alumno de la comisión y el docente— y no hay integradores externos ni áreas de auditoría. **«No hay clientes de terceros» fue cierto hasta el intake 4.2**: desde el 2026-09-12 la API se expone a **aplicaciones propias además del front** —que actúan en nombre de esas mismas dos personas, [`ADR-00009`](Unidades-Entrega/GeometriaFactory-Api/05-Arquitectura-Tecnica/Adrs/ADR-00009-La-Api-Autentica-Personas-No-Aplicaciones.md)— y por eso la superficie pública se versiona en la ruta, `/v{MAJOR}/` ([`ADR-00010`](Unidades-Entrega/GeometriaFactory-Api/05-Arquitectura-Tecnica/Adrs/ADR-00010-Version-En-La-Ruta-Solo-Major-Para-La-Superficie-Publica.md)). Esa audiencia acotada explica buena parte de las decisiones técnicas del producto: una sola instancia, un solo curso, un solo administrador y sin escalera de ambientes.
