# US-27 — Exigir el cambio de la contraseña provisoria antes de toda otra capacidad, y levantar la marca al cambiarla

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Domain
**Documento:** US-27-Exigir-El-Cambio-De-La-Provisoria-Antes-De-Toda-Otra-Capacidad.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`Must` por `RN-13`, que `PRODUCT-INTAKE` §4.1 declara con verificación propia, y porque es criterio de la transición `d` → `e` del roadmap §5.2.
