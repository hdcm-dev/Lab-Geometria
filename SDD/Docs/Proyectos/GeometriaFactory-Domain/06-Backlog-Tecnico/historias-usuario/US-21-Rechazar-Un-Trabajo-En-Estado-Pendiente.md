# US-21 — Rechazar un trabajo en estado `Pendiente`, con comentario opcional

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Domain
**Documento:** US-21-Rechazar-Un-Trabajo-En-Estado-Pendiente.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
- Given ese trabajo ya en `Rechazado`, When el alumno intenta reeditarlo o eliminarlo, Then se rechaza, por `INV-07` y por `RN-04`.
...
`PRODUCT-INTAKE` §4.2 declara explícitamente que un alumno que rebote varias veces acumula trabajos rechazados que **sólo el administrador** puede quitar. Esa consecuencia la ejerce US-23.
