# US-06 — Fijar la credencial derivada provisoria en el acto de habilitación

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Domain
**Documento:** US-06-Fijar-La-Credencial-Provisoria-En-El-Acto-De-Habilitacion.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
- Given una cuenta habilitada por este camino, When se evalúa su admisibilidad, Then no es admisible por cambio de contraseña pendiente, que es `INV-09` y se ejerce en US-27.
...
| RN e invariantes que ejerce | RN-16, RN-14, RN-06; INV-09 |
...
`Must` por derivar de `F-04`, `Must Have` en `PRODUCT-INTAKE` §4, y porque `RN-16` es lo que cierra la escritura anónima de contraseña.
...
**La contraseña llega ya derivada** y el dominio no ve valores en claro, no deriva y no compara credenciales por su cuenta (`05` §7, `PRODUCT-INTAKE` §17.1.P.5). Que la provisoria no sea adivinable y no se repita es `RN-14`, y **su mecanismo vive en `GeometriaFactory-Infrastructure`**, no acá.
