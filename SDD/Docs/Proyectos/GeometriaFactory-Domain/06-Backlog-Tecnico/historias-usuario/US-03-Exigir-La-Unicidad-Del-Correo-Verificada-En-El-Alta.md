# US-03 — Exigir la unicidad del correo verificada en el alta

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Domain
**Documento:** US-03-Exigir-La-Unicidad-Del-Correo-Verificada-En-El-Alta.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`RN-02` declara que el correo del alumno es único, e `INV-01` lo expresa como condición permanente. El dominio **declara** la condición y la unicidad efectiva sobre el conjunto la resuelve el consumidor con su puerto de repositorio (`05` §10.3). [`ADR-06`](../../05-Arquitectura-Tecnica/Adrs/ADR-06-El-Dominio-No-Lee-El-Reloj-Ni-El-Conjunto.md) es la decisión que hace que la unicidad entre por parámetro.
...
`Must` por `RN-02`, que `PRODUCT-INTAKE` §4.1 declara cerrada, y porque el correo es la identidad con la que el alumno entra al laboratorio.
...
**El criterio de comparación de dos correos queda abierto** —si se comparan tal cual o normalizados— y no se decide acá: es el punto abierto que [`../../02-Especificacion-Funcional/Especificacion-Funcional.md`](../../02-Especificacion-Funcional/Especificacion-Funcional.md) §9 declara, y este backlog lo convierte en trabajo como BT-16.
