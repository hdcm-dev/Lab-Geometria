...
**Los dos gates condicionados dependen de valores rotulados [ASUNCIÓN] en el intake §22** —asunción `A-3` para la cobertura y `A-5` para el tiempo—: se miden y se registran, y no bloquean la fusión hasta que el Product Owner los confirme (`BT-15`).
