...
**Trazabilidad upstream:** [`Criterios-Validacion.md`](Criterios-Validacion.md) 1.0; [`Estrategia-Calidad.md`](Estrategia-Calidad.md) 1.0 §3; [`../06-Backlog-Tecnico/Definition-Of-Ready.md`](../06-Backlog-Tecnico/Definition-Of-Ready.md) 1.0 §5, que declara que la DoD vive acá; [`../../../00-Contexto/Roadmap-Producto.md`](../../../00-Contexto/Roadmap-Producto.md) §5; [`../../../../Intake/PRODUCT-INTAKE-Fabrica-De-Geometria.md`](../../../../Intake/PRODUCT-INTAKE-Fabrica-De-Geometria.md) **1.19** §15
...
- [ ] Toda condición de rechazo que la historia produce está en el catálogo de [`../03-UX-UI-DX/DX-Error-Messages.md`](../03-UX-UI-DX/DX-Error-Messages.md) y alcanzada por prueba. **Se valida** con `TC-23`.
- [ ] La historia no introdujo ninguna dependencia saliente. **Se valida** con `TC-24`.
...
- [ ] Si la tarea es una puerta —`BT-04`, `BT-05`, `BT-08`, `BT-14`— la puerta se midió al menos una vez y su resultado quedó registrado. **Se valida** con la salida del pipeline.
...
- [ ] Los criterios bloqueantes de [`Criterios-Validacion.md`](Criterios-Validacion.md) —`CV-10` a `CV-13`, `CV-20` a `CV-22`— se cumplen. **Se valida** con el informe del pipeline y con `TC-23`, `TC-24`, `TC-26` y `TC-27`.
...
- [ ] **42 de 42** condiciones alcanzadas y **0** fuera del catálogo. **Se valida** con `TC-23`.
...
- [ ] Los dos valores rotulados **[ASUNCIÓN]** están confirmados por el Product Owner, o su continuidad como asunción está declarada. **Se valida** leyendo el intake §22 y el estado de `BT-15`.
