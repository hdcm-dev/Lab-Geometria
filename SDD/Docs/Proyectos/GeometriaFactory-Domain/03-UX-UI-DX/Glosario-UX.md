...
| 1.3 | 2026-08-10 | Alineación con `PRODUCT-INTAKE` **1.13** —regla **RN-16**, habilitar produce la contraseña provisoria— y con [`DX-Error-Messages.md`](DX-Error-Messages.md) 1.4: la entrada «condición de error del dominio» de §2 actualiza su recuento de **43 a 42** situaciones catalogadas, por la que entra en la habilitación y las dos que salen al dejar de ser posible su causa. **No se acuña ningún término nuevo y ninguno se retira**: el vocabulario de la provisoria y de la marca ya estaba declarado en `Glosario-Funcional.md` §2 y RN-16 no lo amplía, sólo suma un acto que lo usa. |
