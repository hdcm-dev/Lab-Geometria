...
| 1.2 | 2026-08-09 | Alineación con `PRODUCT-INTAKE` **1.7** y con el catálogo de [`DX-Error-Messages.md`](DX-Error-Messages.md) 1.3: la entrada «condición de error del dominio» de §2 actualiza su recuento de **40 a 43** situaciones catalogadas, por las tres que el reseteo de contraseña y el cambio forzado hacen posibles. **No se acuña ningún término nuevo acá**: «contraseña provisoria», «marca de cambio de contraseña pendiente» y «reseteo de contraseña» son vocabulario del dominio y los declara `Glosario-Funcional.md` §2, de modo que esta categoría los referencia y no los redefine. |
| 1.3 | 2026-08-10 | Alineación con `PRODUCT-INTAKE` **1.13** —regla **RN-02016**, habilitar produce la contraseña provisoria— y con [`DX-Error-Messages.md`](DX-Error-Messages.md) 1.4: la entrada «condición de error del dominio» de §2 actualiza su recuento de **43 a 42** situaciones catalogadas, por la que entra en la habilitación y las dos que salen al dejar de ser posible su causa. **No se acuña ningún término nuevo y ninguno se retira**: el vocabulario de la provisoria y de la marca ya estaba declarado en `Glosario-Funcional.md` §2 y RN-02016 no lo amplía, sólo suma un acto que lo usa. |
