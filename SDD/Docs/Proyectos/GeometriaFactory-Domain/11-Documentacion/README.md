...
| ~~La ambigüedad del intake sobre `RN-12` e `INV-09`~~ — **cerrada.** `PRODUCT-INTAKE` §17.1.P.2 declara hoy en su prosa que `RN-12`, `RN-13` y `RN-16` tienen invariante y que es `INV-09`, que es lo que la columna del invariante asigna; se corrigió en el intake **1.11** y el recuento quedó completo en **1.14**. Ver [`../05-Arquitectura-Tecnica/Arquitectura-Proyecto-Codigo.md`](../05-Arquitectura-Tecnica/Arquitectura-Proyecto-Codigo.md) §11 `PA-03` | `Conceptos-Fundamentales`, que va a poder enunciarlo sin salvedad | **Cerrado** por el Product Owner sobre su propio documento |
