...
- **La exigencia de credencial ya fijada, que esta regla dejaba en pie, quedó retirada por RN-16.** Hasta `PRODUCT-INTAKE` 1.12, `CU-13` rechazaba el reseteo de una cuenta que nunca había establecido contraseña, porque el único camino para dársela era el primer ingreso anónimo. **RN-16 suprimió ese camino**, y con él el fundamento del rechazo: hoy el reseteo sobre una cuenta `Pendiente` sin credencial **fija** la provisoria en lugar de reemplazarla, y procede. El retiro **resuelve a favor de esta regla** una tensión que la versión 1.0 registraba sin verla: el rechazo alcanzaba precisamente a la cuenta `Pendiente` que este enunciado declara admitida.
