...
**Trazabilidad upstream:** `PRODUCT-INTAKE-Fabrica-De-Geometria.md` §4.1 (enunciado de RN-03), §17.1.P.2 (INV-02), §7 (CL-5), §17.2.P.5, §17.5.P.5; [`NB-03`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-03-Trabajo-Con-Dueno-Estado-Y-Persistencia.md) §4 y §5
...
- No alcanza al administrador, cuyo alcance sobre los trabajos de la comisión lo fijan RN-11 y RN-04.
...
| 1.1 | 2026-08-09 | Absorbe el enunciado completo que `PRODUCT-INTAKE` 1.3 §4.1 transcribe y el enunciado de INV-02 de §17.1.P.2. Sube minor y archiva el estado anterior por `Master-Prompt.md` §5. El enunciado antepone la formulación de la fuente —«un alumno sólo ve y opera sus propios trabajos»— a la indistinguibilidad, que es su forma de verificación. §3 precisa que la regla alcanza a los cuatro estados y que no alcanza al administrador, cuyo alcance fijan RN-11 y RN-04. |
