...
**Trazabilidad upstream:** `00-Contexto/Vision-Producto.md` §9 (glosario raíz de la cadena), §9.1, §9.2 y §9.3; `PRODUCT-INTAKE-Fabrica-De-Geometria.md` 1.7 §4.2 (colisión de vocabulario de `Pendiente`), §4 (**F-26**), §4.1 (**RN-12**, **RN-13**), §17.1.P.2 (**INV-09**), §12 y §12.1 (glosario del dominio del cliente y choque de vocabulario), §17.1
...
| Contraseña provisoria | Contraseña que **el sistema produce** al resetear una cuenta de alumno, que el administrador le comunica por fuera del producto y que la cuenta está obligada a reemplazar antes de ejercer cualquier otra capacidad. El dominio nunca la conoce ni la produce: llega ya derivada | `Definicion-Modelo-De-Dominio.md`, CU-13, CU-03, CU-04, RN-12, RN-13 | — |
| Marca de cambio de contraseña pendiente | Atributo del alumno, puesto o levantado, que declara que su credencial vigente es una contraseña provisoria. La pone **únicamente** el reseteo y la levanta **únicamente** el reemplazo hecho por la propia cuenta. Se nombra **siempre con la palabra «marca»**, porque `Pendiente` a secas ya nombra un estado de cuenta y un estado de trabajo: ver §3.3 | `Definicion-Modelo-De-Dominio.md`, CU-13, CU-03, CU-04, RN-12, RN-13 | «Cambio de contraseña pendiente» como nombre del atributo. **No** se dice «cuenta pendiente» para nombrarla |
