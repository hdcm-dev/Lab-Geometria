...
| Contraseña provisoria | Contraseña que el administrador fija a una cuenta de alumno al resetearla y que le comunica por fuera del producto, y que la cuenta está obligada a reemplazar antes de ejercer cualquier otra capacidad. El dominio nunca la conoce: llega ya derivada | `Definicion-Modelo-De-Dominio.md`, CU-13, CU-03, CU-04, RN-12, RN-13 | — |
...
| Reseteo de contraseña | Operación **conservadora** del administrador sobre una cuenta de alumno: le fija una contraseña provisoria y le pone la marca, sin cambiar su estado de cuenta, su papel, su identidad ni ninguno de sus trabajos. **Resetear no es dar de baja** | `Definicion-Modelo-De-Dominio.md`, CU-13, CU-02, RN-12 | — |
