...
| Contraseña provisoria | Contraseña que **el sistema produce** al **habilitar** (RN-16) o al **resetear** (RN-14) una cuenta de alumno, que el administrador le comunica por fuera del producto y que la cuenta está obligada a reemplazar antes de ejercer cualquier otra capacidad. El dominio nunca la conoce ni la produce: llega ya derivada | `Definicion-Modelo-De-Dominio.md`, CU-02, CU-13, CU-03, CU-04, RN-12, RN-13, RN-16 | — |
