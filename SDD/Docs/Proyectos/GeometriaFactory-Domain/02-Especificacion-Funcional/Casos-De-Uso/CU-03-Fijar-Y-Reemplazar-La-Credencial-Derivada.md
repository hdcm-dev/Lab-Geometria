...
**Quién ejerce la fijación cambió con `PRODUCT-INTAKE` 1.13, y el reemplazo no.** Hasta la 1.12, la fijación la ejercía el **alumno** en su primer ingreso efectivo, sin haber probado quién era: era la única escritura **de contraseña** del producto que ocurría sin credencial. Con **RN-16** la fijación se ejerce **dentro de la habilitación** de [CU-02](CU-02-Gobernar-El-Ciclo-De-Vida-De-La-Cuenta.md), sobre la contraseña provisoria que el sistema produce, y el alumno llega a elegir la suya por el **reemplazo** de FA-04, ya identificado con esa provisoria. **La capacidad F-04 no desaparece: el alumno sigue eligiendo su contraseña**, y lo que cambió es cómo se identifica la cuenta que la elige.
...
- **Para la fijación, el solicitante es la transición de habilitación de CU-02** y no una petición de la propia cuenta: la fijación y la puesta de la marca de INV-09 son efectos del mismo acto (RN-16).
...
6. El dominio devuelve el alumno con su credencial fijada. **No admite acceso todavía**: la habilitación que ejerce esta fijación deja puesta la marca de cambio de contraseña pendiente, y CU-04 lo devuelve no admisible hasta que el reemplazo de FA-04 la levante (RN-13, RN-16, INV-09).
...
| `CREDENCIAL_YA_FIJADA` | Se solicita fijar por primera vez una credencial que ya tiene valor | Rechaza la operación: el camino correcto es el reemplazo de FA-01. **Desde RN-16 alcanza también a la rehabilitación**, que aporta una provisoria nueva y entra por el reemplazo interno de CU-02 y no por la fijación |
...
| Reglas de negocio aplicables | [RN-06](../Reglas-De-Negocio/RN-06-Cuenta-Pendiente-O-Bloqueada-Sin-Acceso.md), que es la que hace que una cuenta que no está `Habilitado` no llegue a tener credencial útil; [RN-13](../Reglas-De-Negocio/RN-13-Cambio-Forzado-Antes-De-Toda-Otra-Capacidad.md), que es la que hace que el reemplazo de FA-04 levante la marca y que nadie más pueda levantarla; y [RN-16](../Reglas-De-Negocio/RN-16-Habilitar-Produce-La-Provisoria.md), que es la que mueve la fijación de la mano del alumno a la habilitación y unifica el primer ingreso con el cambio posterior al reseteo (FA-05). La máquina de estados de cuenta está en [`Definicion-Modelo-De-Dominio.md`](../Definicion-Modelo-De-Dominio.md) §5.1, y la de la marca en §5.3 |
| Invariantes | INV-06, por la condición de estado; **INV-09**, por el levantamiento de la marca en FA-04 |
| Historias de usuario a generar en 06 | US de fijación de la credencial provisoria dentro de la habilitación, US de cambio de contraseña exigiendo la vigente, **US-27** de cambio obligatorio que levanta la marca y que cubre **también** el primer ingreso (FA-05) |
...
- **No queda ninguna escritura anónima de credencial, y este contrato es donde se comprueba.** Con `PRODUCT-INTAKE` 1.13 §4.1 **RN-16**, precisada por la **1.15**, los dos caminos de este documento exigen identidad: la **fijación** la ejerce la habilitación del administrador, que está autenticado, y el **reemplazo** exige credencial vigente verificada, que es la provisoria. No queda ningún camino por el que una contraseña se fije sobre una cuenta a partir de su solo correo. El defecto que esto cierra lo levantó la emisión de la Fase B de `GeometriaFactory-Api`.
...
| 1.6 | 2026-08-10 | **Absorbe `PRODUCT-INTAKE` 1.13 §4.1 (RN-16) y la precisión de F-04**, que trasladan el ejercicio de la fijación del alumno anónimo a la habilitación. **§1** declara el cambio de quién ejerce la fijación, y deja escrito que **la capacidad F-04 no desaparece**: el alumno sigue eligiendo su contraseña, por el reemplazo y ya identificado. **§3** suma la precondición de que el solicitante de la fijación es la transición de CU-02. **§4** cambia de título —de «fijación en el primer ingreso efectivo» a «fijación en la habilitación»— y su paso 6 deja de declarar que la cuenta admite acceso: la marca de INV-09 queda puesta. **§5** suma **FA-05**, el primer ingreso, que es **el mismo camino que FA-04**; es el punto en el que los dos mecanismos de credencial inicial pasan a ser uno. **§6** amplía la causa de `CREDENCIAL_YA_FIJADA` a la rehabilitación. **§7** suma la marca a la postcondición de la fijación. **§8** rehace CA-01 y suma **CA-07**. **§9** suma RN-16 y reescribe la US prevista. **§10** suma la nota que declara que no queda ninguna escritura anónima de credencial y dónde se comprueba. **Ningún código de rechazo se retira y ninguno se agrega.** Sube minor. |
