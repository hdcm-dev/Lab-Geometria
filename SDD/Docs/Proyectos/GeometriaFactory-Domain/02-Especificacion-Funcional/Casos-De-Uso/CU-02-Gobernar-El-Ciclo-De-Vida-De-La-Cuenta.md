...
| 1.7 | 2026-08-10 | **Absorbe la corrección de `PRODUCT-INTAKE` 1.15 §4.1 (RN-16)**, que declara falsa la afirmación de 1.13 según la cual «no existe ninguna escritura anónima en el sistema»: el **registro de cuenta** es anónimo por diseño y debe seguir siéndolo. **§1** acota la consecuencia estructural de la habilitación —lo que se suprimió fue la única escritura de **contraseña** sin credencial, el primer ingreso anónimo— y deja escrito que el registro de `CU-01` sigue siendo anónimo. **La fila 1.6 de este control de cambios** transcribía la afirmación ancha y pasa a decir «de credencial». **Ninguna precondición, paso, flujo alternativo, rechazo ni criterio de aceptación cambia.** Sube minor. |
