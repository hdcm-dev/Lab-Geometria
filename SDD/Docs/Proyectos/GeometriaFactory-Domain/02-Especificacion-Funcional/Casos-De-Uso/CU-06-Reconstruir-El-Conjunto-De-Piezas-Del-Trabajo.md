...
| Reglas de negocio aplicables | [RN-08](../Reglas-De-Negocio/RN-08-Texto-Original-Conservado-Integro.md), [RN-09](../Reglas-De-Negocio/RN-09-Observacion-De-Error-Con-Posicion-Y-Campo.md) —en cuanto a que la posición reservada de una figura no reconstruida sigue siendo ubicable—, [RN-10](../Reglas-De-Negocio/RN-10-Desenlace-Exclusivo-Del-Administrador-Y-Terminalidad.md) en cuanto a que el contenido de un trabajo terminal no cambia |
| Invariantes | INV-07, que es el que impide reconstruir sobre un trabajo en estado terminal. **RN-08 no tiene invariante asociado**: describe un comportamiento y no una condición permanente (PRODUCT-INTAKE §17.1.P.2) |
| Origen de la identidad posicional | **No es RN-09.** La identidad de la pieza por su posición en el conjunto raíz proviene de `PRODUCT-INTAKE` §17.1.P.11 punto 2, y es la que `POSICION_DE_PIEZA_INVALIDA` protege. RN-09 gobierna la **ubicación de la observación**, no la identidad de la pieza |
...
- **Por qué la posición se reserva en lugar de cerrarse.** La posición es la del texto del alumno, que es la que él ve y la que RN-09 exige informar; renumerar las piezas adoptadas haría que el índice reportado dejara de corresponder con su salida. El escenario E-5 lo verifica: su primera figura es válida a propósito, para que el índice reportado sea 1 y no 0. Por eso el conjunto de piezas adoptadas admite huecos y la cantidad de figuras del conjunto raíz llega como dato: sin ella no habría rango contra el que validar una posición.
