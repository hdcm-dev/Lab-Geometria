# 07 · Plan de sprint — GeometriaFactory-Contracts
...
| Los contratos que este ensamblado materializa, y contra qué arista | [`../../../Producto/Vista-Producto.md`](../../../Producto/Vista-Producto.md) §4 |
| La Definition of Done canónica | `08-Calidad-Y-Pruebas`, **todavía no emitida** |
| La regla operativa de despliegue conjunto | `09-Devops`, **todavía no emitida**. Este plan la eleva como entrada a esa categoría |

## 5. Control de cambios

| Versión | Fecha | Descripción |
| --- | --- | --- |
| 1.0 | 2026-08-10 | Emisión inicial del índice de la sección. Declara el único artefacto emitido, los **cuatro** que se omiten con el motivo de cada uno, el estado del plan al día de la emisión con la historia que queda fuera del tramo comprometido, y dónde vive lo que este plan no decide, incluida la regla operativa de despliegue conjunto que se eleva a 09. |
