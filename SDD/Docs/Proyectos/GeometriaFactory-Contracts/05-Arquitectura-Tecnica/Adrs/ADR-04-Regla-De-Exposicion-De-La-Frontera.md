# ADR-04 — Regla de exposición: lista cerrada de lo que nunca cruza la frontera

**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** ADR-04-Regla-De-Exposicion-De-La-Frontera.md
**Versión:** 1.0
**Estado:** Aprobado
**Fecha:** 2026-08-10
...
Motivación upstream: NB-02, NB-08; RN-06, RN-13, RN-14, RN-16; RA-01 y RA-03; INV-09.
...
| Rutas de archivos de datos y trazas de la implementación | CU-06 §7 |
...
- La solicitud de reseteo lleva **sólo el identificador de cuenta**: no lleva campo de contraseña, porque la provisoria la produce el sistema (RN-14).
- **No existe ningún tipo de establecimiento anónimo de contraseña.** RN-16 lo eliminó: el establecimiento del primer ingreso usa la solicitud de cambio de contraseña, con la provisoria como vigente. El registro de cuenta **sigue siendo anónimo por diseño** y su solicitud es un tipo de este ensamblado; lo que desapareció es la escritura anónima de credencial y no toda escritura anónima.

## 8. Métricas de validación

| Métrica | Objetivo | Cómo se mide |
| --- | --- | --- |
| Campos capaces de transportar dirección, ruta de datos o secreto | Exactamente **0** en las ocho familias | Prueba de inspección de superficie pública (CA-01 de CU-06) |
| Campos de la respuesta de sesión | Exactamente **4** | Inspección de la superficie pública |
| Condiciones que impiden operar transportadas como campo de sesión | Exactamente **0** de las tres | CA-02, CA-05 y CA-06 de CU-01 |
...
| Textos de error que contienen una dirección | Exactamente **0** | CA-04 de CU-06, con el servicio de datos detenido |

## 9. Referencias

- `PRODUCT-INTAKE-Fabrica-De-Geometria.md` 1.15 §14 (RA-01, RA-02, RA-03), §17.4.P.5, §17.5.P.5 y §4.1 (RN-13, RN-14, RN-16).
...
- [`../../02-Especificacion-Funcional/Casos-De-Uso/CU-06-Contrato-De-Respuesta-De-Error.md`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-06-Contrato-De-Respuesta-De-Error.md) §7 y §8; [`CU-01`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-01-Contrato-De-Canje-De-Credenciales-Y-Sesion.md); [`CU-08`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-08-Contrato-De-Reseteo-Y-Cambio-Obligatorio-De-Contrasena.md).
- ADR relacionadas: [`ADR-01`](ADR-01-Tipos-De-Transferencia-Planos-Sin-Dependencias.md), [`ADR-02`](ADR-02-Tipo-De-Error-Unico-Con-Conjunto-Cerrado.md).
