# ADR-05 — Proyección de listado separada del detalle, y el comentario como bloque propio

**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** ADR-05-Proyeccion-De-Listado-Separada-Del-Detalle.md
**Versión:** 1.0
**Estado:** Propuesto
**Fecha:** 2026-08-10
...
Motivación upstream: NB-03, NB-05, NB-07, NB-09; RN-08, RN-09, RN-11.
...
| --- | --- | --- |
| Texto original en la proyección de listado | Exactamente **0** ocurrencias | CA-01 y CA-04 de CU-04, por inspección de la superficie pública |
...
| Campos compartidos entre el comentario y la colección de observaciones | Exactamente **0** | CA-07, CA-08 y CA-09 de CU-05 |
...
- [`../../02-Especificacion-Funcional/Casos-De-Uso/CU-04-Contrato-De-Listado-De-Trabajos.md`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-04-Contrato-De-Listado-De-Trabajos.md) y [`CU-05`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-05-Contrato-De-Detalle-Del-Trabajo-Interpretado.md).
- ADR relacionadas: [`ADR-01`](ADR-01-Tipos-De-Transferencia-Planos-Sin-Dependencias.md), [`ADR-03`](ADR-03-Versionado-Por-Compilacion-Compartida.md).
