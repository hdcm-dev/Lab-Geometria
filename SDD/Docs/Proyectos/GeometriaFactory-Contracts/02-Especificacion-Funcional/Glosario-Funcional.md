...
| Contraseña provisoria | Contraseña que el administrador fija a una cuenta de alumno al resetearla y que le comunica **por fuera del producto**. Viaja en claro dentro de la solicitud de reseteo, del mismo modo que la contraseña presentada viaja en la de canje; lo que ninguna respuesta transporta es su forma almacenada | `Especificacion-Funcional.md`, CU-08, CU-02 | — |
