...
| CU-06 | Respuesta de error neutra, transversal a los demás, con el conjunto cerrado de dieciséis códigos | NB-04, NB-08, NB-09, NB-02 | Propuesto | [CU-06](Casos-De-Uso/CU-06-Contrato-De-Respuesta-De-Error.md) |
...
| Se emitió CU-08 como caso de uso propio | El reseteo es una **familia de tipos nueva**: solicitud con identificador de cuenta y contraseña provisoria, resultado que declara la situación conservada y el cambio pendiente, y dos códigos de error propios. Es el mismo criterio con el que se emitió CU-07. Absorberlo en CU-02 habría puesto en el mismo contrato de uso la solicitud que **elimina** la cuenta y todos sus trabajos y la que los **conserva**, que es exactamente la confusión que F-26 viene a cerrar |
