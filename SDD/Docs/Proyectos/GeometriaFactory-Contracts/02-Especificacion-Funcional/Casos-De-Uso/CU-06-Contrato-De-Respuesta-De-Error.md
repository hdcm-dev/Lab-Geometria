...
| `CONTRATO_OPERACION_EXCLUSIVA_DEL_ADMINISTRADOR` | Quien pide una operación reservada al administrador **fuera del desenlace de un trabajo** —gobernar las cuentas de la comisión (CU-02), ver el listado de la comisión (CU-04) o resetear la contraseña de un alumno (CU-08)— no tiene ese papel | Texto neutro, sin detalles. Terminación controlada **sin escritura** |
| `CONTRATO_ESTADO_NO_PERMITE_MODIFICAR` | Se pide enviar o reeditar un trabajo que está en `Pendiente`, `Finalizado` o `Rechazado`, y que por lo tanto es de sólo lectura (CU-03) | Texto neutro que declara el estado actual, sin detalles. Terminación controlada **sin escritura** |
...
| CA-09 | El conjunto cerrado de códigos | Se recorre entero buscando un código cuya causa sea una cuenta habilitada sin contraseña, o un reseteo sobre una cuenta sin contraseña | **0 códigos** de los diecisiete responden a esas causas: las dos dejaron de ser posibles con **RN-16**, y los dos identificadores que las nombraban salieron del conjunto sin reciclarse |
