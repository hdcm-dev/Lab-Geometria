...
| CU-06 | Contrato de respuesta de error | La forma única con la que un fallo cruza la frontera de servicio: texto neutro, conjunto cerrado de **dieciséis** códigos, ubicación del defecto y ninguna dirección de servicio | NB-04, NB-08, NB-09, NB-02 | [CU-06](Casos-De-Uso/CU-06-Contrato-De-Respuesta-De-Error.md) |
