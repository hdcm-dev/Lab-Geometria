...
| Inspección de superficie | `TC-16` | `QG-04`: el conjunto cerrado tiene exactamente **17** códigos vivos y se producen **0** fuera de él | 15 y 0 | **Se rechaza aunque compile** |
