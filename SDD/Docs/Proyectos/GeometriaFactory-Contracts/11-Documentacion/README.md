...
**Trazabilidad upstream:** [`../../../Producto/11-Documentacion/README.md`](../../../Producto/11-Documentacion/README.md) 1.0; [`../05-Arquitectura-Tecnica/`](../05-Arquitectura-Tecnica/) con sus **5** ADR; [`../02-Especificacion-Funcional/`](../02-Especificacion-Funcional/) con sus **8** casos de uso
