# US-06 — Transportar el envío del trabajo con el texto original como cadena

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-06-Transportar-El-Envio-Del-Trabajo-Con-El-Texto-Original.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
- Given un texto original con las particularidades de formato del emisor real, When viaja en los dos sentidos, Then llega **idéntico**, por `RN-08`.
...
| RN que refiere por identificador | RN-03, RN-04, RN-05, RN-08 |
| BT derivadas | BT-12 |
...
**Enviar es la única acción de guardado** (`F-22`): no hay una operación separada de guardar y otra de enviar, y por eso el contrato no declara dos tipos. El estado resultante es una salida del mismo envío y viaja en la respuesta, que es US-19.
