# US-10 — Transportar el resumen por alumno y por estado del panel del administrador

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-10-Transportar-El-Resumen-Por-Alumno-Y-Por-Estado.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
**Autor:** Scrum Master + Backlog Curator (AG-06)
**Épica:** EP-08 Capacidades de prioridad menor
...
- Given el estado `Borrador`, When se arma el resumen para el administrador, Then esos trabajos no se cuentan, por `RN-11`, con el mismo alcance que el listado.
...
| RN que refiere por identificador | RN-11 |
| BT derivadas | — |
