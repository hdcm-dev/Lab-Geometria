# US-05 — Transportar la baja con su confirmación escrita

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-05-Transportar-La-Baja-Con-Su-Confirmacion-Escrita.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
`RN-07` declara que la baja elimina la cuenta y **todos sus trabajos**, y que exige confirmación explícita escribiendo el correo de la cuenta. La capacidad `F-03` del intake §4 la declara `Must Have`.
...
| RN que refiere por identificador | RN-07, RN-12 |
| BT derivadas | BT-08, BT-10, BT-11 |
...
**La separación entre esta historia y US-21 es la que `F-26` vino a cerrar**: hasta el intake 1.7 el único camino ante un olvido de contraseña era dar de baja y volver a dar de alta, y por `RN-07` eso eliminaba todos los trabajos del alumno. Que sean dos familias de tipos distintas es lo que hace difícil volver a confundirlas.
