# US-08022 — Reutilizar la solicitud de cambio de contraseña para el cambio obligatorio

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-08022-Reutilizar-La-Solicitud-De-Cambio-Para-El-Cambio-Obligatorio.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`02` §3.1 declara que el cambio obligatorio reutiliza el mismo tipo que el cambio voluntario y que lo que difiere es la precondición, que es una regla de `GeometriaFactory-Domain`. `RN-08016` declara que **no existe ninguna escritura anónima de credencial**: toda operación que fija o cambia una contraseña ocurre con la cuenta ya autenticada.
...
- Given la superficie completa del contrato, When se busca un punto que acepte un correo y una contraseña nueva **sin credencial**, Then no existe ninguno, por `RN-08016`.
