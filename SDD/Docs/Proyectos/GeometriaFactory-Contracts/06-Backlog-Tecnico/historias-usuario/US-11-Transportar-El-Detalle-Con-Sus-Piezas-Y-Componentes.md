# US-11 — Transportar el detalle del trabajo interpretado con sus piezas y componentes

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Contracts
**Documento:** US-11-Transportar-El-Detalle-Con-Sus-Piezas-Y-Componentes.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
El contrato de uso es [`CU-05`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-05-Contrato-De-Detalle-Del-Trabajo-Interpretado.md). Es la contracara de [`ADR-05`](../../05-Arquitectura-Tecnica/Adrs/ADR-05-Proyeccion-De-Listado-Separada-Del-Detalle.md): lo que el listado no lleva, lo lleva el detalle. `05` §3.1 lo declara como familia propia.
