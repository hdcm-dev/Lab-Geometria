# US-02 — Transportar el registro de una cuenta de alumno
...
La capacidad `F-02` del intake §4 declara el registro con correo, nombre y apellido, **sin elegir contraseña**. El contrato de uso es [`CU-02`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-02-Contrato-De-Administracion-De-Cuentas.md). `RN-16` cierra además la escritura anónima de contraseña: la credencial la produce la habilitación.
...
- Given la inspección de esta familia, When se busca cualquier tipo de establecimiento anónimo de contraseña, Then no existe ninguno, por `RN-16`.
...
| RN que refiere por identificador | RN-02, RN-16 |
| BT derivadas | BT-10 |
