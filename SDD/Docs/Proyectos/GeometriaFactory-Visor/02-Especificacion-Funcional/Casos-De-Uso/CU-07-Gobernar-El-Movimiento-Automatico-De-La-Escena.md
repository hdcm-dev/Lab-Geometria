# CU-07 — Gobernar el movimiento automático de la escena sobre una instancia viva
...
- La sexta función **no reemplaza** las dos opciones de gobierno que `inicializar` recibe (`CU-01`): esas fijan el estado con el que la instancia nace, y ésta lo cambia después. Las dos vías gobiernan lo mismo y no se contradicen.
