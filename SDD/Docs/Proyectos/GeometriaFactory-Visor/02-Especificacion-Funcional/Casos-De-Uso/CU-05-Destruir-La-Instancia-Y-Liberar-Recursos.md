# CU-05 — Destruir la instancia y liberar sus recursos
...
| FA-03 · Recorrido de ida y vuelta entre trabajos | El componente anfitrión destruye la instancia al salir de una vista y crea una nueva al volver | Cada destrucción libera lo que su inicialización había tomado. Repetido diez veces, la visualización no degrada | `CU-01`, paso 1, para la instancia siguiente |
...
| --- | --- |
| Necesidad de negocio | NB-06, tercer criterio de éxito (continuidad de uso: 10 recorridos de 10) |
...
- «No degradar» se verifica con el criterio del intake y de NB-06: diez recorridos de ida y vuelta entre trabajos, con la visualización funcionando igual al final que al principio. La forma de medirlo la fija 08-Calidad-Y-Pruebas.
