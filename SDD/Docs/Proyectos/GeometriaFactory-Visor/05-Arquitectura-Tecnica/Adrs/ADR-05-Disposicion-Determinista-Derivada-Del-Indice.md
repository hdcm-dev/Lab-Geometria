# ADR-05 — Disposición determinista derivada del índice, y el determinismo es de posición y no de orientación

**Proyecto de código:** GeometriaFactory-Visor
**Documento:** ADR-05-Disposicion-Determinista-Derivada-Del-Indice.md
**Versión:** 1.0
**Estado:** Propuesto
**Fecha:** 2026-08-10
...
Motivación upstream: NB-06, y NB-04 en su parte de piezas dibujadas; capacidades F-13 y F-25; garantía G-6.
...
- ADR relacionadas: [`ADR-02`](ADR-02-Superficie-De-Seis-Funciones-Planas.md), [`ADR-03`](ADR-03-Visualizador-Puro-Sin-Red-Ni-Identidad.md).
