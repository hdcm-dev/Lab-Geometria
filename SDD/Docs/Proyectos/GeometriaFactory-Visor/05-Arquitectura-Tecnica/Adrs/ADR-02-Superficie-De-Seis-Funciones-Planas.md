# ADR-02 — La superficie pública son seis funciones planas, siete garantías y siete códigos

**Proyecto de código:** GeometriaFactory-Visor
**Documento:** ADR-02-Superficie-De-Seis-Funciones-Planas.md
**Versión:** 1.0
**Estado:** Aprobado
**Fecha:** 2026-08-10
...
Motivación upstream: NB-06, NB-04 parcial; capacidades F-11, F-13 y F-25; RA-02.
...
3. **Se acepta que el resultado de dibujo conserve la enumeración de las piezas no dibujadas aunque el anfitrión no la use.** Es la garantía G-5 y es lo que cierra el problema original de NB-06.
...
- ADR relacionadas: [`ADR-01`](ADR-01-Tres-Capas-Con-Fachada-Plana.md), [`ADR-03`](ADR-03-Visualizador-Puro-Sin-Red-Ni-Identidad.md).
