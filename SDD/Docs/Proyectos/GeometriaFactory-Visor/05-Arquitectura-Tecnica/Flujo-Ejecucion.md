...
| --- | --- |
| CU que recorre | `CU-02` para la canalización; `CU-01` y `CU-05` para el ciclo de vida; `CU-07` para el bucle de movimiento; `CU-06` para el recorrido completo sin backend |
| Garantías que sostiene | G-1, G-2, G-4, G-5, G-6 y G-7 |
| ADR que lo gobiernan | ADR-01, ADR-03, ADR-05 |
