# US-22 — Devolver el detalle con piezas, componentes, observaciones y comentario
...
`NB-06` recibe de esta capa que **las piezas, sus componentes y el texto original lleguen al otro lado del proceso** (`02` §7.2), y `NB-09` que el comentario cruce. El contrato de uso es [`CU-07`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-07-Exponer-El-Listado-Y-El-Detalle-De-Los-Trabajos.md).
...
| --- | --- |
| NB upstream | NB-03, NB-05 (parcial), NB-06 (parcial), NB-07 (parcial), NB-09 (parcial) |
| CU cubiertos | CU-07 |
| RN que ejerce | RN-09, RN-03 |
