# US-24 — Traducir cada código del contrato al código de respuesta que le corresponde

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Api
**Documento:** US-24-Traducir-Cada-Codigo-Del-Contrato-Al-Codigo-De-Respuesta.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
Como **producto**, quiero **que cada uno de los quince códigos vivos del contrato tenga su código de respuesta declarado en una sola tabla**, para **que ninguna traducción se improvise en un punto de acceso**.

## 2. Contexto

`02` §3 declara la **traducción a protocolo** como una de las cinco responsabilidades, y §2 lo enuncia: **acá se traduce, y traducir es decidir**; un motivo de la capa de aplicación **no es** un código de respuesta, y un código del contrato **no es** un número de protocolo. El contrato de uso es [`CU-09`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-09-Traducir-El-Motivo-Del-Contrato-A-Respuesta-De-Protocolo.md).

## 3. Criterios de aceptación

- Given el conjunto cerrado de **quince** códigos vivos, When se recorre la tabla de traducción, Then **14 de 15** tienen destino declarado y **1** está declarado **sin destino, con su motivo**.
...
| CU cubiertos | CU-09 |
| RN que ejerce | RN-02, RN-03, RN-09, RN-10 en sus tramos de traducción |
...
**Los quince códigos vivos son quince sobre dieciocho identificadores emitidos**: tres están retirados y **ninguno se recicla**. El recuento se verifica en la tabla del catálogo de la categoría 03 de `GeometriaFactory-Contracts`, que es **la única tabla donde los dieciocho están enumerados juntos**.
