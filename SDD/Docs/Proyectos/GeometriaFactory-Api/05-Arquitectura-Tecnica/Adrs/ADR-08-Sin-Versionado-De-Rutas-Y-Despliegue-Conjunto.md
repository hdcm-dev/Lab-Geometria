# ADR-08 — Sin versionado de rutas, con despliegue conjunto como regla operativa

**Proyecto de código:** GeometriaFactory-Api
**Documento:** ADR-08-Sin-Versionado-De-Rutas-Y-Despliegue-Conjunto.md
**Versión:** 1.0
**Estado:** Aprobado
**Fecha:** 2026-08-10
...
Lo que esta ADR tiene que dejar dicho es **qué reemplaza al versionado**, porque una ausencia sin sustituto es un pendiente y no una decisión. Y hay un punto donde la red no alcanza y conviene nombrarlo: **la configuración de intercambio no rompe ninguna compilación** —por eso [`ADR-02`](ADR-02-Formato-De-Intercambio-Y-Su-Configuracion.md) la fija de un solo lado— y **el esquema del almacén tampoco se recompila**, porque sobrevive al despliegue.

Motivación upstream: NB-08; `PRODUCT-INTAKE` §9 (X-9), §14 (RA-01), §17.4.P.3, §17.5.P.3, §17.5.P.7, §17.5.P.8.
...
- [`../../02-Especificacion-Funcional/Casos-De-Uso/CU-12-Ejercitar-La-Superficie-Con-La-Coleccion-De-Peticiones-Reproducible.md`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-12-Ejercitar-La-Superficie-Con-La-Coleccion-De-Peticiones-Reproducible.md).
- [`../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-03-Versionado-Por-Compilacion-Compartida.md`](../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-03-Versionado-Por-Compilacion-Compartida.md), que es la política que esta ADR aplica en la frontera.
- ADR relacionadas: [`ADR-02`](ADR-02-Formato-De-Intercambio-Y-Su-Configuracion.md), [`ADR-05`](ADR-05-Sin-Paginacion-Con-Condicion-De-Reingreso-Declarada.md), [`ADR-07`](ADR-07-Arranque-En-Dos-Fases-Y-Punto-De-Salud-Sin-Acceso.md).
