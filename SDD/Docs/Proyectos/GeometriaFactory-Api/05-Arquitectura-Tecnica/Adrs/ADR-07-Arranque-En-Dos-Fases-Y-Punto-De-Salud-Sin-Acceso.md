# ADR-07 — Arranque en dos fases, y un punto de salud que no exige acceso

**Proyecto de código:** GeometriaFactory-Api
**Documento:** ADR-07-Arranque-En-Dos-Fases-Y-Punto-De-Salud-Sin-Acceso.md
**Versión:** 1.0
**Estado:** Aprobado
**Fecha:** 2026-08-10
...
Motivación upstream: NB-03, NB-08; `PRODUCT-INTAKE` §17.5.P.3, §17.5.P.4, §17.5.P.8, §17.5.P.10.

## 2. Decisión

**El arranque tiene dos fases y el servicio no escucha hasta que las dos terminaron.** Cinco reglas:

1. **Fase uno: construir el grafo de dependencias.** Si algo falta, **falla en construcción** y no hay servicio. No hay petición que responder ([`ADR-06`](ADR-06-Composicion-De-Raiz-Ciclos-De-Vida-Y-Configuracion.md)).
...
4. `NB-08` recibe acá su tramo propio: el punto de salud y el arranque que se detiene son lo que permite que la pieza pública declare un estado degradado explícito en lugar de fallar sin explicación.
...
- La ruta del almacén llega por la composición de raíz; **esta capa la toma de configuración y `GeometriaFactory-Infrastructure` la recibe** ([`ADR-06`](ADR-06-Composicion-De-Raiz-Ciclos-De-Vida-Y-Configuracion.md)).
...
- [`../../02-Especificacion-Funcional/Casos-De-Uso/CU-11-Arrancar-El-Servicio-Y-Dejar-El-Almacen-En-Condiciones.md`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-11-Arrancar-El-Servicio-Y-Dejar-El-Almacen-En-Condiciones.md).
- [`../../../GeometriaFactory-Infrastructure/05-Arquitectura-Tecnica/Adrs/ADR-07-Transformaciones-Al-Arrancar-Con-Linaje-Inmutable.md`](../../../GeometriaFactory-Infrastructure/05-Arquitectura-Tecnica/Adrs/ADR-07-Transformaciones-Al-Arrancar-Con-Linaje-Inmutable.md), que es la decisión que esta ADR dispara.
- ADR relacionadas: [`ADR-03`](ADR-03-Credencial-Firmada-Papel-Por-Punto-Y-Guardia-Transversal.md), [`ADR-06`](ADR-06-Composicion-De-Raiz-Ciclos-De-Vida-Y-Configuracion.md), [`ADR-08`](ADR-08-Sin-Versionado-De-Rutas-Y-Despliegue-Conjunto.md).
