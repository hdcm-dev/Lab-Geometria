# ADR-05 — Sin paginación, con su condición de reingreso declarada

**Proyecto de código:** GeometriaFactory-Api
**Documento:** ADR-05-Sin-Paginacion-Con-Condicion-De-Reingreso-Declarada.md
**Versión:** 1.0
**Estado:** Aprobado
**Fecha:** 2026-08-10
...
Motivación upstream: NB-07, NB-09; RN-03, RN-11; INV-02; `PRODUCT-INTAKE` §17.5.P.10, §17.4.P.10, §17.3.P.12.
...
1. **El recorte que existe es de alcance, no de tamaño.** El alumno ve lo suyo; el administrador ve la comisión **sin borradores**. Los dos recortes llegan decididos desde la capa de aplicación y esta superficie **no ofrece ningún parámetro** para ampliarlos: es la forma negativa en que `RN-03` y `RN-11` se sostienen acá.
...
- `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.17** §4.1 (RN-03, RN-11), §17.3.P.12, §17.4.P.10 y §17.5.P.10.
...
- [`../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-05-Proyeccion-De-Listado-Separada-Del-Detalle.md`](../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-05-Proyeccion-De-Listado-Separada-Del-Detalle.md), que es la decisión que sostiene el requerimiento de tiempo.
- ADR relacionadas: [`ADR-02`](ADR-02-Formato-De-Intercambio-Y-Su-Configuracion.md), [`ADR-08`](ADR-08-Sin-Versionado-De-Rutas-Y-Despliegue-Conjunto.md).
