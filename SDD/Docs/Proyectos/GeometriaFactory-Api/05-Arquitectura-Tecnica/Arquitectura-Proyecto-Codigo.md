...
| PA-06 | **El alcance de la colección de peticiones.** El intake la declara en dos lugares que **no dicen lo mismo**: §16.1 la describe con «los escenarios E-1 a E-7 como cuerpo» y §18 nombra «los cuerpos de E-2 y E-5». Las dos son anteriores a que `E-8` entrara al intake y ninguna se actualizó. La categoría 02 adopta **los ocho** y lo declara como derivación; esta categoría **hereda esa lectura y no la reabre** | **Product Owner**, para confirmar el alcance y actualizar §16.1 y §18 | Sin fecha comprometida |
...
| PA-10 | **Tres recuentos congelados en documentos ya emitidos, que esta categoría no corrige y declara.** [`../03-UX-UI-DX/DX-Error-Messages.md`](../03-UX-UI-DX/DX-Error-Messages.md) §2.1, §6.1 y §6.2 siguen declarando **dieciocho** entradas de catálogo, **diecisiete** códigos del conjunto cerrado y **dieciséis** con destino, mientras su propia §2.3, su §2.4 y el encabezado de su §3 —corregidos en la emisión 1.2— declaran **quince**, **catorce** y **dieciséis** entradas. Los números vivos son los de `GeometriaFactory-Contracts` `CU-06` §10: **quince** códigos, y esta categoría cuenta sobre ellos | La próxima intervención sobre la categoría 03 de este proyecto de código | Al intervenirla |
