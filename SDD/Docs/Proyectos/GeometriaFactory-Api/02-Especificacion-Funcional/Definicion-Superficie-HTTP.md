...
**Quince puntos de acceso.** El recuento que importa y que se puede comprobar sobre la tabla: **cuatro no exigen acceso firmado** —A-01, A-02, A-03 y A-16—, **A-05 admite las dos formas** y **los diez restantes exigen acceso firmado y quedan bajo la guardia de `CU-02`**. Cuatro más uno más diez son quince. **Ningún punto queda con su forma de identificación abierta**, y ésa es la diferencia con la emisión 1.0.
