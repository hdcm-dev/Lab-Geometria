...
**Y con él desaparece la clase entera de «escritura de contraseña sin credencial».** De los cuatro puntos que no exigen acceso firmado, **ninguno fija una contraseña sobre una cuenta existente**: A-01 canja credenciales, A-02 registra una cuenta sin contraseña, A-03 sólo procede mientras no exista administrador y A-16 es de sólo lectura. Es el enunciado de RN-16 visto desde la superficie, y §7 lo declara como ausencia sostenida.
