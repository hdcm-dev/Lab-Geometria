# CU-00004 — Exponer el gobierno de las cuentas de la comisión

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Api
**Documento:** CU-00004-Exponer-El-Gobierno-De-Las-Cuentas-De-La-Comision.md
**Versión:** 1.3
**Estado:** Aprobado
**Fecha:** 2026-08-12
**Autor:** Analista Funcional + API Designer (AG-02)
**Trazabilidad upstream:** [`NB-00001`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00001-Control-De-Admision-Al-Laboratorio.md); `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.26** §4 (F-03, **F-04** precisada), §4.1 (RN-00001, RN-00006, RN-00007, RN-00013, RN-00014, **RN-00016**), §17.1.P.2 (**INV-09**), §7 (CL-6), §14 (RA-03), §17.5.P.5; `Proyectos/GeometriaFactory-Contracts/.../CU-00002-Contrato-De-Administracion-De-Cuentas.md`; `Proyectos/GeometriaFactory-Application/.../CU-00002-Gobernar-Las-Cuentas-De-La-Comision.md`; `Proyectos/GeometriaFactory-Infrastructure/.../CU-00004-Ejecutar-El-Borrado-Fisico-Y-El-Arrastre-De-La-Baja.md`
...
Exponer los **tres** puntos de acceso con los que el administrador gobierna las cuentas de la comisión: el listado (**A-06**), el cambio de situación (**A-07**) y la baja física (**A-08**). Los tres exigen papel `Administrador` y los tres están bajo la guardia de CU-00002.

**Desde `PRODUCT-INTAKE` 1.13, A-07 devuelve además la contraseña provisoria cuando la situación pretendida es habilitada.** **RN-00016** declara que habilitar una cuenta produce una provisoria con el mismo mecanismo y el mismo tratamiento que el reseteo de CU-00005: el sistema la produce, la respuesta se la devuelve al administrador **una sola vez** para que se la comunique, y la cuenta queda con **cambio de contraseña pendiente** (INV-09). Es lo que suprime del producto el punto de establecimiento anónimo que exponía CU-00003.
...
| Reglas de negocio aplicables | [RN-02007](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02007-Baja-Con-Arrastre-Y-Confirmacion-Escrita.md), con su tramo acá: **el punto transporta el correo escrito y no procede sin él**. [RN-02001](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02001-Administrador-Unico-Y-Papeles-Fijos.md), por el papel que los tres puntos exigen y por la cuenta que no admite baja. [RN-02006](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02006-Cuenta-Pendiente-O-Bloqueada-Sin-Acceso.md), porque la situación que este punto cambia es la que decide el acceso. [RN-02012](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02012-Reseteo-Conserva-La-Cuenta-Y-Sus-Trabajos.md) **por contraste**: el reseteo es otro punto, otro verbo y otro contrato, y **no pasa por acá** |
...
- **La provisoria de A-07 y la de A-09 son el mismo mecanismo con dos disparadores**, y las dos exigencias de CU-00005 valen igual acá: **el administrador no la escribe** (RN-00014), la respuesta la devuelve **una sola vez** y **no entra al registro del servidor** (RA-03). Que vivan en contratos de uso distintos es una consecuencia del recorte por punto de acceso, no una diferencia de tratamiento.
