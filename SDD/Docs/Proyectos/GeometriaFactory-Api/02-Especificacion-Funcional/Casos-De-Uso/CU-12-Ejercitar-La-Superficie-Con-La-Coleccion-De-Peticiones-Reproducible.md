...
- **El alcance de la colección es una derivación declarada, y su motivo es un residuo de la fuente.** El intake la describe en dos lugares con **alcances distintos**, verificados contra el texto vivo de `PRODUCT-INTAKE` **1.18**: §16.1 dice «con los escenarios **E-1 a E-8** como cuerpo» —**los ocho**— y §18, en la muestra **S-2**, dice «con los cuerpos de **E-2 y E-5**» —**dos**—. **Los dos textos están al día: lo que difiere es el alcance, no la antigüedad**, y la fuente no declara cuál manda. Esta categoría adopta **los ocho**, y el fundamento es que **E-8 es el modo de falla que el propio intake llama el más probable de todos**, porque lo produce la configuración regional de la máquina del alumno y no un error de programación: dejarlo fuera de la única demostración ejecutable del proyecto de código principal sería dejar sin demostrar justamente lo que más va a pasar. **Está elevado al Product Owner** en el índice maestro §11, para que declare cuál de los dos alcances rige y alinee §16.1 con §18 S-2.
