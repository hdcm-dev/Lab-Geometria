...
**Trazabilidad upstream:** [`NB-02`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-02-Identidad-Propia-Del-Alumno-Sin-Correo.md); `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.34** (§4.1 RN-13 y su fila de control de cambios 1.34: **con qué se autentica el cambio forzado**), **1.26** §4 (F-05, **F-04** precisada), §4.1 (RN-06, RN-13, **RN-16**), §14 (RA-01, RA-03), §17.5.P.3, §17.5.P.5 y su nota de seguridad, §11 (RN-B5); `Proyectos/GeometriaFactory-Contracts/.../CU-01-Contrato-De-Canje-De-Credenciales-Y-Sesion.md` completo; `Proyectos/GeometriaFactory-Application/.../CU-03-Resolver-El-Ingreso-Y-La-Credencial-Del-Alumno.md`; `Proyectos/GeometriaFactory-Infrastructure/.../CU-08-Emitir-El-Acceso-Firmado.md` y `CU-06-Derivar-La-Contrasena-Y-Verificar-Una-Credencial.md`
...
| `CONTRATO_CAMBIO_DE_CONTRASENA_REQUERIDO` | `403` | La cuenta tiene una provisoria sin cambiar, **producida por la habilitación (RN-16) o por el reseteo (F-26)**: desde el intake 1.13 es también el código del **primer ingreso**. Con motivo; la pieza pública lo convierte en el desvío a **A-05**, que desde el intake **1.34** se alcanza **con la contraseña actual** y sin acceso firmado. **No se emite acceso** |
