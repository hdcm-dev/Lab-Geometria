...
**Trazabilidad upstream:** [`NB-01`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-01-Control-De-Admision-Al-Laboratorio.md); `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.12** §4 (F-03), §4.1 (RN-01, RN-06, RN-07), §7 (CL-6), §14 (RA-03), §17.5.P.5; `Proyectos/GeometriaFactory-Contracts/.../CU-02-Contrato-De-Administracion-De-Cuentas.md`; `Proyectos/GeometriaFactory-Application/.../CU-02-Gobernar-Las-Cuentas-De-La-Comision.md`; `Proyectos/GeometriaFactory-Infrastructure/.../CU-04-Ejecutar-El-Borrado-Fisico-Y-El-Arrastre-De-La-Baja.md`
...
5. Se ejerce el cambio contra la capa de aplicación, que verifica la facultad sobre el dato y valida la transición contra el dominio.
...
- **A-07 con éxito:** la cuenta quedó en la situación resultante, que la respuesta declara. **Sus trabajos no se tocaron.**
...
| CA-02 | Una cuenta en situación `Pendiente` | Se invoca A-07 pidiendo habilitarla | Responde `200` con la situación resultante, y sus trabajos quedan **sin ningún cambio** |
...
- **El listado transporta la marca de cambio de contraseña pendiente**, y no la contraseña ni su valor derivado. Es lo que le permite al administrador ver que una cuenta que él reseteó todavía no cambió su provisoria, sin conocer ningún valor.
