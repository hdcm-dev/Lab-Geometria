# CU-00005 — Exponer el reseteo de la contraseña de un alumno

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Api
**Documento:** CU-00005-Exponer-El-Reseteo-De-La-Contrasena-De-Un-Alumno.md
**Versión:** 1.3
**Estado:** Aprobado
**Fecha:** 2026-08-11
**Autor:** Analista Funcional + API Designer (AG-02)
**Trazabilidad upstream:** [`NB-00001`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00001-Control-De-Admision-Al-Laboratorio.md), [`NB-00002`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00002-Identidad-Propia-Del-Alumno-Sin-Correo.md); `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.26** §4 (**F-26**, F-03, **F-04** precisada), §4.1 (RN-00012, RN-00013, RN-00014, RN-00015, **RN-00016**), §7 (CL-7), §9 (X-2 retirada), §11 (RN-B6 cerrado), §17.1.P.2 (INV-08, INV-09), §14 (RA-03); `Proyectos/GeometriaFactory-Contracts/.../CU-00008-Contrato-De-Reseteo-Y-Cambio-Obligatorio-De-Contrasena.md`; `Proyectos/GeometriaFactory-Application/.../CU-00011-Resetear-La-Contrasena-De-Un-Alumno.md`; `Proyectos/GeometriaFactory-Infrastructure/.../CU-00007-Producir-La-Contrasena-Provisoria-Del-Reseteo.md`
...
- La petición trae acceso firmado con papel `Administrador` y atravesó la guardia de CU-00002.
...
| `CONTRATO_ALUMNO_NO_ENCONTRADO` | `404` | La cuenta referenciada no existe. **Adopción declarada**, con el mismo fundamento de `CU-00004` §10 |
...
| ~~`CONTRATO_RESETEO_NO_APLICABLE_A_CUENTA_SIN_CONTRASENA`~~ | — | **Retirado del conjunto cerrado** por `PRODUCT-INTAKE` 1.13 §4.1 (**RN-00016**). Existía porque el camino declarado para una cuenta sin contraseña era el primer ingreso anónimo; suprimido ese camino, **el reseteo procede** y fija la provisoria en lugar de reemplazarla. El retiro cierra además la tensión con **RN-00015**, que declara que el reseteo procede sobre `Pendiente`. **El identificador no se recicla** |
...
| --- | --- |
| Necesidad de negocio | NB-00001 por la operación del administrador; NB-00002 porque es lo que hace sostenible la identidad propia sin canal de correo |
| Reglas de negocio aplicables | [RN-02012](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02012-Reseteo-Conserva-La-Cuenta-Y-Sus-Trabajos.md), que este punto hace observable desde afuera. [RN-02015](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02015-Reseteo-Independiente-Del-Estado-De-Cuenta.md), **de forma estructural**: la superficie no declara parámetro de situación ni respuesta por cuenta no habilitada. [RN-02013](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02013-Cambio-Forzado-Antes-De-Toda-Otra-Capacidad.md), porque este punto es el único que pone la marca. [RN-02014](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02014-Provisoria-Producida-Por-El-Sistema.md), **sin tramo acá**: lo único que esta capa declara sobre ella es **lo que no hace con el valor** |
...
| Contrato de uso que transporta | `GeometriaFactory-Contracts` `CU-00008` |
| Historias de usuario a generar en 06 | US-00014, US-00015, US-00016 |
