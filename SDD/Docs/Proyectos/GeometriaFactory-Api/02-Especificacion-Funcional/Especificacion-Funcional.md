...
| CU-09 | [Traducir el motivo del contrato a respuesta de protocolo](Casos-De-Uso/CU-09-Traducir-El-Motivo-Del-Contrato-A-Respuesta-De-Protocolo.md) | Las dos traducciones, los **catorce** códigos con destino y **el que no lo tiene** | Propuesto |
...
**Once, y ninguno bloqueante. Seis son propios de esta categoría y cinco vienen declarados de aguas arriba y no se reabren.** Los **dos** primeros son huecos de la superficie que esta categoría **encontró y no resolvió**, y los dos siguen elevados al Product Owner. Eran doce y tres respectivamente en la emisión 1.0.
