...
| **El alcance de la colección de peticiones** | **Propio.** El intake la declara en dos lugares con **alcances distintos**, verificados contra el texto vivo de `PRODUCT-INTAKE` **1.18**: §16.1 dice «con los escenarios **E-1 a E-8** como cuerpo» —**los ocho**— y §18 **S-2** dice «con los cuerpos de **E-2 y E-5**» —**dos**—. **No es un recuento envejecido: los dos textos están al día**, y la fuente no declara cuál de los dos alcances manda. `CU-12` adopta los **ocho** y lo declara como derivación, con el fundamento de que E-8 es el modo de falla que el propio intake llama **el más probable** de todos | **Product Owner**, para declarar cuál alcance rige y alinear §16.1 con §18 S-2 |
