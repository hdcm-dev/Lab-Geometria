...
**Trazabilidad upstream:** `00-Contexto/Vision-Producto.md` §9 (glosario raíz de la cadena); `00-Contexto/Alcance-Producto.md`; `01-Necesidades-Negocio/Necesidades-Negocio.md` y las necesidades NB-01 a NB-09; `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.13**, §17.5 íntegro —en particular §17.5.P.2, §17.5.P.3, §17.5.P.4, §17.5.P.5, §17.5.P.6, §17.5.P.8, §17.5.P.10, §17.5.P.11 y §17.5.P.12—, §4 (**F-04** precisada), §4.1 (**las dieciséis reglas**, con **RN-16** nueva del intake 1.13), §4.2, §7 (CL-2, CL-5, CL-8), §9 (X-9), §10, §11 (RN-B5), §13, §14 (**RA-01, RA-02 y RA-03**), §15, §16.1, §18 (S-2), §20 y §21; `PRODUCT-MANIFEST-Fabrica-De-Geometria.md` **1.2** §1, §2, §3 y §5; `Proyectos/GeometriaFactory-Contracts/02-Especificacion-Funcional/` completo, cuyos ocho contratos de uso y cuyo conjunto cerrado de **quince** códigos esta capa transporta y traduce; `Proyectos/GeometriaFactory-Application/02-Especificacion-Funcional/` completo, cuyos **once** casos de uso esta capa orquesta; `Proyectos/GeometriaFactory-Infrastructure/02-Especificacion-Funcional/` completo, cuyos adaptadores esta capa conecta
...
| **Qué código del contrato recibe una operación de administrador pedida por un alumno** | **Propio.** El conjunto cerrado de **quince** códigos tiene `CONTRATO_DESENLACE_EXCLUSIVO_DEL_ADMINISTRADOR`, que por su enunciado sólo cubre el desenlace. La capa de aplicación emite un motivo de facultad requerida en cuatro de sus casos de uso —el gobierno de cuentas, la revisión de la comisión, el desenlace y el reseteo—, y **para los otros tres caminos el contrato no declara ningún código**. Verificado recorriendo la §6 de los ocho contratos de uso. `CU-09` §10 lo declara y **no inventa un código**: los códigos son del ensamblado de contratos | **Product Owner**, y `GeometriaFactory-Contracts` si decide ampliar su conjunto cerrado |
