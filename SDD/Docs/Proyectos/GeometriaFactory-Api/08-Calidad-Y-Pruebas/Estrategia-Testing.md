...
| **Proyecto de código completo** | **75 %** | **70 %** | **60 %** | Intake §17.5.P.6 [ASUNCIÓN]. **El 75 baja el 80 que §2.2 fija para `rest-api`**, ver el párrafo de arriba. El mutation score lo toma prestado de la fila `library` de §2.2, que es la única que lo pide |
