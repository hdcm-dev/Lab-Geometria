...
- [ ] **Ninguna condición que la historia presenta está fuera del conjunto cerrado de diecisiete códigos**, y ninguna se acuñó, renombró ni tradujo a texto acá. **Se valida** con `TC-27`.
