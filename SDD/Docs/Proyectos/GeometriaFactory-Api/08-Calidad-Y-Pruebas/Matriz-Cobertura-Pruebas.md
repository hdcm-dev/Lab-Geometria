...
| Códigos del contrato con traducción declarada | **16 de 17**, con **1** sin destino y su motivo; **0** inventados y **0** renombrados | `TC-24` y `TC-27`, en las dos direcciones | `Pendiente` |
