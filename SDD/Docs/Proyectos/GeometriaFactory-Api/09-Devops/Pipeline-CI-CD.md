...
| `test` | `TC-24` y `TC-27`, comparación en las dos direcciones | `QG-06`: **16 de 17** códigos del contrato con traducción declarada, **1** declarado sin destino con su motivo, **0** inventados y **0** renombrados | 14, 1, 0 y 0 | **Bloqueante** |
