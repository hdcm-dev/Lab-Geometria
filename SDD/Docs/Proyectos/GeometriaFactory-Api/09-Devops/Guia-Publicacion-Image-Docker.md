...
| 2 | **El arranque en frío no se estira** | `TC-00033` | Menos de **30 segundos** [ASUNCIÓN del intake §17.5.P.10]. **Condicionado**: se mide y se registra |
...
| --- | --- | --- |
| El servicio desplegado está roto | Levantar la composición **desde la etiqueta de la etapa anterior**. El motor reconstruye en destino | Intake §17.5.P.8; [`ADR-00008`](../05-Arquitectura-Tecnica/Adrs/ADR-00008-Sin-Versionado-De-Rutas-Y-Despliegue-Conjunto.md) §6, trade-off 3 |
