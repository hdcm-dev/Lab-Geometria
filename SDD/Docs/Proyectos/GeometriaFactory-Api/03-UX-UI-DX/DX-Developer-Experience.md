...
Principio de redacción, aplicado sin excepción a las **16** entradas del catálogo: **qué pasó, por qué pasó, qué hacer al respecto**. Acá la tercera parte tiene dos destinatarios distintos, y esa es la particularidad de esta capa:
