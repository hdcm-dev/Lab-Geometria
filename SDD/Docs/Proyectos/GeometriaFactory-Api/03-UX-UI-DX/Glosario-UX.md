...
| **Entrada del catálogo** | Cada una de las **16** situaciones en las que esta superficie responde con un fallo: **14** códigos del contrato con destino más **2** respuestas sin código | `DX-Error-Messages.md` | **No se dice «error»** para este referente: ver §3.1 |
