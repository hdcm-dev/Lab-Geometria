...
**Trazabilidad upstream:** `../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00009-Desenlace-Explicito-De-La-Entrega.md` §1, §5 (los siete criterios); `../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00007-Revision-De-La-Comision-En-Un-Solo-Lugar.md` §1; `../../../../00-Contexto/Vision-Producto.md` §9.1 (aprobar / rechazar, comentario, estado del trabajo); `PRODUCT-INTAKE-Fabrica-De-Geometria.md` §4 (F-21, F-23, F-24), §4.1 (RN-10004, RN-10010), §4.2, §5 (historia 7.1), §6 (flujo 2.1), §7 (CL-10, CL-11), §9 (retiro de X-5)
...
- El trabajo está abierto desde CU-10008 y CU-10007, FA-01, y está en estado `Pendiente`.
- Los dos estados de desenlace son terminales: ninguna transición sale de ellos.

## 4. Flujo principal

1. El administrador abre un trabajo en estado `Pendiente` y lo revisa en escena y árbol, según CU-10007 FA-01.
...
4. **La pieza pública invoca desde su servidor el contrato de desenlace de la revisión** de `GeometriaFactory-Contracts` CU-10007, con el identificador del trabajo, la decisión y el comentario, que viaja sin poblar si no se escribió nada.
5. La pieza de datos aplica la transición y devuelve el estado alcanzado y el momento en que se registró.
6. La pieza pública muestra el estado alcanzado y devuelve al listado de CU-10008, donde el trabajo ya figura con su estado nuevo.
...
| FA-03 | El administrador retira un trabajo de los que ve, en cualquiera de sus tres estados visibles | La pieza pública pide confirmación e invoca el contrato de eliminación de `GeometriaFactory-Contracts` CU-10003, FA-04, que es **la misma solicitud** que usa el alumno. Lo que difiere es la regla que la acota, y esa regla vive en el dominio | El flujo vuelve al listado de CU-10008, ya sin ese trabajo |
...
| --- | --- |
| Necesidad de negocio | [`NB-00009`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00009-Desenlace-Explicito-De-La-Entrega.md), [`NB-00007`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00007-Revision-De-La-Comision-En-Un-Solo-Lugar.md) |
| Reglas de negocio aplicables | [`RN-02010`](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02010-Desenlace-Exclusivo-Del-Administrador-Y-Terminalidad.md), [`RN-02004`](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02004-Eliminacion-Acotada-Al-Borrador.md) —cubre hoy también la eliminación del administrador sobre cualquier trabajo que ve—, [`RN-02011`](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02011-El-Administrador-No-Ve-Los-Borradores.md) |
| Contratos de uso consumidos | [`GeometriaFactory-Contracts` CU-08007](../../../GeometriaFactory-Contracts/02-Especificacion-Funcional/Casos-De-Uso/CU-08007-Contrato-De-Desenlace-De-La-Revision.md) completo, con FA-01, FA-02 y FA-03; [`CU-08003`](../../../GeometriaFactory-Contracts/02-Especificacion-Funcional/Casos-De-Uso/CU-08003-Contrato-De-Carga-Y-Edicion-Del-Trabajo.md) FA-04; [`CU-08006`](../../../GeometriaFactory-Contracts/02-Especificacion-Funcional/Casos-De-Uso/CU-08006-Contrato-De-Respuesta-De-Error.md) |
| Fachada del visualizador | Ninguna función propia. La revisión visual del trabajo la aporta CU-10007 |
| Historias de usuario a generar en 06 | US-10024, US-10025 |
