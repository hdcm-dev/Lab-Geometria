...
| Contraseña provisoria | La credencial que el administrador fija sobre la cuenta de un alumno al resetearla y le comunica **fuera del producto**, porque no hay canal de correo. Sirve para una sola cosa: entrar a cambiarla | `Especificacion-Funcional.md` §6 (RT-12), CU-02, CU-03, CU-04 | «clave provisoria». **No se dice «contraseña temporal»**: no vence por tiempo, sólo por uso |
...
| Reseteo de contraseña | La quinta operación del panel de cuentas: el administrador reemplaza la credencial de un alumno por una provisoria. **No es una baja y no elimina ningún trabajo** | `Especificacion-Funcional.md` §3, CU-04 | «resetear la clave». **No se dice «recuperación»**: la recuperación autónoma sigue sin existir |
