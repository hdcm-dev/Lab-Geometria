...
| `QG-08` | `TC-31`, sobre el traductor de condiciones | **0** mensajes que expongan dirección de servicio, ruta de datos o traza, sobre los **diecisiete** códigos vivos **y** sobre el camino de ausencia de respuesta | 0 | **Bloqueante.** Es `RA-03` |
