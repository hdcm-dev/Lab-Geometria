...
| QG-08 | **0** mensajes que expongan dirección de servicio, ruta de datos o traza, sobre los **diecisiete** códigos vivos **y** sobre el camino de ausencia de respuesta | `TC-31`, inspección del traductor de condiciones, que es el único lugar por el que un mensaje llega a la persona | Bloquea la fusión. Es `RA-03` |
