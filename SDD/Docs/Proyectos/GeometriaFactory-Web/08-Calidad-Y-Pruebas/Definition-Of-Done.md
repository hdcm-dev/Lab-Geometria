...
- [ ] **Ninguna condición que la historia presenta está fuera de los quince códigos vivos** ni del camino de ausencia de respuesta, y ninguna expone dirección, ruta ni traza. **Se valida** con `TC-31`.
