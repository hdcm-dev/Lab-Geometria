...
| Modificar sus filas, sus umbrales o su recuento de 61 | **No se hace.** Un umbral de deriva se cambia con aprobación humana explícita, no desde esta categoría |
...
| Abrir filas `VER-XX` | **No se hace**: `10-Examples` no está emitida para este proyecto de código, y la matriz ya lo declara |
