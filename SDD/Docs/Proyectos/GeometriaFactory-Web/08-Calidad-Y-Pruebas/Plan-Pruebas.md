...
| RQ-03 | Que un mensaje mostrado lleve una dirección de servicio, una ruta de datos o una traza | Alto | Media, porque entra por el camino de excepción | `TC-31` recorre los **diecisiete** códigos **y** el camino de ausencia de respuesta, sobre el traductor, que es el único punto por el que un mensaje llega a la persona |
