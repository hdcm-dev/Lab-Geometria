...
| Tests previstos en 08 | Guion de demostración de la etapa `c`, con la inspección del navegador que verifica cero apariciones de la credencial de sesión; etapa `d` para la cuenta a la espera de habilitación, para la derivación al establecimiento de contraseña y para el **ingreso con provisoria que deriva al cambio forzado con sesión otorgada**; ruta de administrador pedida por un alumno con sesión; recorrido por teclado |
