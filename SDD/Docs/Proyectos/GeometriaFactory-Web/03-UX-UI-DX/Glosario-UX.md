...
| **Contraseña provisoria** | La credencial que el administrador le fija a un alumno al resetearla y le comunica **fuera del producto**, porque no hay canal de correo. La superficie la muestra **una sola vez** y no la vuelve a mostrar | `Wireframes-Panel-De-Cuentas.md` §3, `Wireframes-Credencial-Propia.md` §3 | Realiza la capacidad F-26. **No se dice «contraseña temporal»**: no vence por tiempo, sólo por uso |
