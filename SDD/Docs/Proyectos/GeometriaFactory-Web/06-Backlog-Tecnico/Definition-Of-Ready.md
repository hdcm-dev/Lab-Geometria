...
6. **Toda condición que la historia presenta a la persona es uno de los quince códigos vivos** del conjunto cerrado de `GeometriaFactory-Contracts`, o el camino de ausencia de respuesta. Una historia que necesite un código nuevo **no está lista**: el conjunto es cerrado y los códigos no se acuñan acá.
