# US-01 — Registrar la cuenta con correo, nombre y apellido, sin campo de contraseña

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Web
**Documento:** US-01-Registrar-La-Cuenta-Sin-Campo-De-Contrasena.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
**El aviso de cuenta esperando habilitación es parte de esta superficie y no del ingreso.** El criterio de transición `d` → `e` exige además que un alumno cuya cuenta está en estado `Pendiente` reciba un aviso explícito al intentar ingresar, y eso es US-04.
