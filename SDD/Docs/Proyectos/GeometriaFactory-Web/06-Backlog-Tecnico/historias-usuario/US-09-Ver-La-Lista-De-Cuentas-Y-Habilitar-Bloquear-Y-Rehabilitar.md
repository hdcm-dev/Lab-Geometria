# US-09 — Ver la lista de cuentas y habilitar, bloquear y rehabilitar, comunicando la provisoria

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Web
**Documento:** US-09-Ver-La-Lista-De-Cuentas-Y-Habilitar-Bloquear-Y-Rehabilitar.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`NB-01` pide control de admisión, `F-03` del intake §4 lo declara `Must Have` y `RN-16` agrega que **habilitar produce la provisoria**. El caso de uso es [`CU-04`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-04-Administrar-Las-Cuentas-De-La-Comision.md) y la superficie es `Panel-De-Cuentas`, que aloja las **cinco** operaciones sobre una cuenta.
