# ADR-06 — El visor se opera sólo por sus seis funciones, y es esta pieza la que consulta el entorno

**Proyecto de código:** GeometriaFactory-Web
**Documento:** ADR-06-Aislamiento-Del-Visor-Tras-Su-Fachada.md
**Versión:** 1.0
**Estado:** Propuesto
**Fecha:** 2026-08-10
...
Motivación upstream: NB-06, NB-04, NB-05; `RA-01`, `RA-02`; `PRODUCT-INTAKE` §17.6.P.3 (regla de aislamiento del visor), §17.6.P.10, §17.6.P.11 punto 5, §17.7 P.3 y P.10; restricciones transversales `RT-04`, `RT-05`, `RT-10`, `RT-11` y `RT-13` de la categoría 02.
...
1. **Se acepta que ampliar la fachada exija coordinar con otro proyecto de código.** Cuando a una superficie le falte algo, el camino está declarado en [`Visor Extensibilidad.md`](../../../GeometriaFactory-Visor/05-Arquitectura-Tecnica/Extensibilidad.md) §5, y no es invocar el interior.
...
- [`../../../GeometriaFactory-Visor/05-Arquitectura-Tecnica/Adrs/ADR-02-Superficie-De-Seis-Funciones-Planas.md`](../../../GeometriaFactory-Visor/05-Arquitectura-Tecnica/Adrs/ADR-02-Superficie-De-Seis-Funciones-Planas.md) y [`ADR-03`](../../../GeometriaFactory-Visor/05-Arquitectura-Tecnica/Adrs/ADR-03-Visualizador-Puro-Sin-Red-Ni-Identidad.md).
- [`../../../GeometriaFactory-Visor/05-Arquitectura-Tecnica/Extensibilidad.md`](../../../GeometriaFactory-Visor/05-Arquitectura-Tecnica/Extensibilidad.md) §5, el procedimiento para cuando al anfitrión le falta algo.
- ADR relacionadas: [`ADR-01`](ADR-01-Render-En-El-Servidor-Con-Circuito-Interactivo.md), [`ADR-04`](ADR-04-Tres-Capas-De-Presentacion.md).
