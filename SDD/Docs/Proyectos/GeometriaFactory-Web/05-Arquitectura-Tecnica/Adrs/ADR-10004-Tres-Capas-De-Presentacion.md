...
| Estado compartido entre superficies en la capa 2, para no volver a pedir | Menos ida y vuelta al navegar entre superficies | Es una caché con otro nombre, y [`ADR-10002`](ADR-10002-Sin-Estado-Propio-Y-Sin-Persistencia.md) ya la descartó con su fundamento. **Descartada, y se declara acá para que no vuelva por la puerta de la capa 2** |
...
3. **Se acepta que la capa 2 no comparta estado entre superficies**, con el ida y vuelta que eso implica al navegar. Es la misma decisión de [`ADR-10002`](ADR-10002-Sin-Estado-Propio-Y-Sin-Persistencia.md), y se repite acá porque la capa 2 es el lugar más natural por donde una caché volvería.
