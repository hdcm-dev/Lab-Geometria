# ADR-01 — Render en el servidor con circuito interactivo, y una sola salida hacia el servicio de datos

**Proyecto de código:** GeometriaFactory-Web
**Documento:** ADR-01-Render-En-El-Servidor-Con-Circuito-Interactivo.md
**Versión:** 1.0
**Estado:** Propuesto
**Fecha:** 2026-08-10
...
Motivación upstream: NB-08; `RA-01`, `RA-03`; `PRODUCT-INTAKE` §14, §17.6.P.2, §17.6.P.3, §17.6.P.10 (`PT-01.a`, `PT-01.b`), §17.6.P.11 punto 1 y §17.6.P.12; restricción transversal `RT-01` de la categoría 02.
...
2. La credencial de sesión no necesita llegar al navegador, lo que hace posible [`ADR-03`](ADR-03-Credencial-De-Sesion-En-El-Estado-Del-Circuito.md).
...
- Ninguna superficie invoca al cliente tipado directamente: entre una superficie y la salida hay siempre un servicio de aplicación de front ([`ADR-04`](ADR-04-Tres-Capas-De-Presentacion.md)).
...
- [`../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-04-Regla-De-Exposicion-De-La-Frontera.md`](../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-04-Regla-De-Exposicion-De-La-Frontera.md), que declara del otro lado que **todas** las solicitudes las arma el servidor de la unidad pública.
- ADR relacionadas: [`ADR-03`](ADR-03-Credencial-De-Sesion-En-El-Estado-Del-Circuito.md), [`ADR-04`](ADR-04-Tres-Capas-De-Presentacion.md), [`ADR-06`](ADR-06-Aislamiento-Del-Visor-Tras-Su-Fachada.md).
