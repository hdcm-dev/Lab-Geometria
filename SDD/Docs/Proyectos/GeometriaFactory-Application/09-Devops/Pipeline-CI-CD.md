...
| `test` | Prueba de inspección `TC-04026`, más la revisión del pull request | `QG-04`: **ninguna** prueba de esta capa toca la base de datos real | 0 | **Bloqueante.** Es la puerta propia del intake §17.2.P.8. Ver §2.2 |
