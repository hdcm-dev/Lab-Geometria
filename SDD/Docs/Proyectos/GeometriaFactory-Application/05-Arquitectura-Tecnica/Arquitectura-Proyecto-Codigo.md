...
| --- | --- | --- | --- |
| Repositorio de trabajos | `IWorkRepository` (`PRODUCT-INTAKE` §17.2.P.1) | Gobierno de cuentas, Trabajo, Consulta, Desenlace | ADR-02, ADR-05 |
| Validación de figuras | `IFigureValidator` (`PRODUCT-INTAKE` §17.2.P.1) | Trabajo, sólo en el envío | ADR-02 |
| Reloj del sistema | `ISystemClock` (`PRODUCT-INTAKE` §17.2.P.1) | Alta de cuentas, Gobierno de cuentas, Ingreso y credencial, Trabajo, Desenlace | ADR-02 |
