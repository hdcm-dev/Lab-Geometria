...
1. **Cambio de contraseña pendiente.** Corta antes que las otras tres. Tiene **una sola excepción declarada**: el reemplazo de la propia credencial de `CU-04003` FA-05, que es lo único que la cuenta marcada alcanza y lo único que levanta la marca.
...
- [`../../../GeometriaFactory-Domain/05-Arquitectura-Tecnica/Adrs/ADR-02005-Guarda-Unica-De-Admisibilidad.md`](../../../GeometriaFactory-Domain/05-Arquitectura-Tecnica/Adrs/ADR-02005-Guarda-Unica-De-Admisibilidad.md) §6 punto 1, que es la dependencia de disciplina que esta ADR cierra.
- [`../../../GeometriaFactory-Contracts/02-Especificacion-Funcional/Casos-De-Uso/CU-08006-Contrato-De-Respuesta-De-Error.md`](../../../GeometriaFactory-Contracts/02-Especificacion-Funcional/Casos-De-Uso/CU-08006-Contrato-De-Respuesta-De-Error.md), por el código único de las operaciones bloqueadas por la marca.
