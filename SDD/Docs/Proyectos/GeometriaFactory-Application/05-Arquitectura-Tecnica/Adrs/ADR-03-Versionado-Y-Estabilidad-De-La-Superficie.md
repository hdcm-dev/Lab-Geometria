# ADR-03 — Versionado por compilación compartida y estabilidad de la superficie de dos caras

**Proyecto de código:** GeometriaFactory-Application
**Documento:** ADR-03-Versionado-Y-Estabilidad-De-La-Superficie.md
**Versión:** 1.0
**Estado:** Aprobado
**Fecha:** 2026-08-10
...
- [`../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-03-Versionado-Por-Compilacion-Compartida.md`](../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-03-Versionado-Por-Compilacion-Compartida.md), que toma la misma decisión para la frontera entre las dos unidades desplegables.
- ADR relacionadas: [`ADR-02`](ADR-02-Cuatro-Puertos-Y-La-Frontera-Que-Declaran.md), [`ADR-06`](ADR-06-Resultado-Tipado-Y-Catalogo-Cerrado-De-Condiciones.md).
