...
| Un quinto puerto para producir la contraseña provisoria | Haría explícito que el sistema la produce y no el administrador (RN-04014) | El valor llega ya producido y ya derivado: no hay nada que esta capa le pida a nadie. La categoría 02 lo resolvió así en su §8 y esta ADR no lo reabre |
...
- [`../../../GeometriaFactory-Domain/05-Arquitectura-Tecnica/Adrs/ADR-02006-El-Dominio-No-Lee-El-Reloj-Ni-El-Conjunto.md`](../../../GeometriaFactory-Domain/05-Arquitectura-Tecnica/Adrs/ADR-02006-El-Dominio-No-Lee-El-Reloj-Ni-El-Conjunto.md), que es la decisión del nivel 0 de la que este cuarto puerto se deduce.
