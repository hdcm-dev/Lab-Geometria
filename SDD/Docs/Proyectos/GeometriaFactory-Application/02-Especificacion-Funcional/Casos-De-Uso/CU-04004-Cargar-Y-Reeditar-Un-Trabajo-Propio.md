# CU-04004 — Cargar y reeditar un trabajo propio

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Application
**Documento:** CU-04004-Cargar-Y-Reeditar-Un-Trabajo-Propio.md
**Versión:** 1.1
**Estado:** Aprobado
**Fecha:** 2026-08-12
**Autor:** Analista Funcional + API Designer (AG-02)
**Trazabilidad upstream:** [`NB-00003`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00003-Trabajo-Con-Dueno-Estado-Y-Persistencia.md) §5 (trabajo con existencia propia, conservación del trabajo que no verifica, separación entre alumnos); [`NB-00004`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00004-Interpretacion-Fiel-Del-Dato-Del-Alumno.md) §5 (conservación del original); `00-Contexto/Vision-Producto.md` §9.1; `PRODUCT-INTAKE-Fabrica-De-Geometria.md` §4 (F-06, F-07), §4.1 (RN-04003, RN-04004, RN-04008), §4.2, §6 (flujo 2), §17.2.P.5, §17.2.P.11 punto 3; orquesta [`CU-02005`](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Casos-De-Uso/CU-02005-Crear-Y-Reeditar-Un-Trabajo.md) y [`CU-02009`](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Casos-De-Uso/CU-02009-Resolver-El-Acceso-Del-Alumno-A-Un-Trabajo.md) de GeometriaFactory-Domain
...
La resolución del estado **no ocurre acá**: el alumno tiene una sola acción de guardado, enviar, y es CU-04005 el que interpreta el texto y decide entre `Borrador` y estado `Pendiente`.
...
3. El caso de uso invoca la constitución del trabajo en el dominio, con el solicitante como dueño y el texto original tal cual llegó (RN-04008).
...
| FA-02 | El solicitante no es el dueño del trabajo que quiere reeditar | El caso de uso devuelve no procede con el motivo `TRABAJO_INEXISTENTE_PARA_EL_SOLICITANTE`, deliberadamente indistinguible de la inexistencia (RN-04003, INV-02) | Termina el caso de uso |
...
| `TEXTO_ORIGINAL_ALTERADO` | El consumidor aporta como texto original una versión corregida del que pegó el alumno | Propaga el rechazo del dominio y no materializa nada: el producto no edita el dato del alumno (RN-04008) |
...
| Reglas de negocio aplicables | [RN-02003](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02003-Trabajo-Ajeno-Indistinguible-De-Inexistente.md), [RN-02004](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02004-Eliminacion-Acotada-Al-Borrador.md), [RN-02008](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02008-Texto-Original-Conservado-Integro.md) |
| Casos de uso de dominio orquestados | [CU-02005](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Casos-De-Uso/CU-02005-Crear-Y-Reeditar-Un-Trabajo.md), [CU-02009](../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Casos-De-Uso/CU-02009-Resolver-El-Acceso-Del-Alumno-A-Un-Trabajo.md) |
| Puertos que consume | Repositorio de trabajos, reloj del sistema |
| Historias de usuario a generar en 06 | US-04010, US-04011, US-04012 |
...
- La reedición descarta la interpretación anterior porque el texto cambió; volver a interpretarlo es CU-04005.
...
- La eliminación no está acá: es CU-04009.
...
Agregar datos opcionales al trabajo es compatible. Distinguir hacia afuera el trabajo ajeno del inexistente, o admitir la reedición fuera de `Borrador`, contradicen RN-04003 y RN-04004.
