...
| --- | --- | --- | --- |
| FA-01 | La cuenta fue **recién habilitada** y todavía no cambió la provisoria que la habilitación produjo | El dominio devuelve no admisible con el motivo `CAMBIO_DE_CONTRASENA_PENDIENTE`, **el mismo** que devuelve para una cuenta reseteada. El caso de uso lo devuelve tal cual, y el consumidor lo traduce en el pedido de cambiar la contraseña: es el primer ingreso del flujo de alta, que desde `PRODUCT-INTAKE` 1.13 recorre el camino de RN-13 | Termina el caso de uso |
