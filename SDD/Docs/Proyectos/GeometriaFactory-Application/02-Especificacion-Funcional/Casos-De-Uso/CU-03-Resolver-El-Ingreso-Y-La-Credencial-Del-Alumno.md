...
5. El caso de uso devuelve admisible junto con la identidad y el papel de la cuenta, que es lo que el consumidor necesita para resolver el ingreso.
...
- **Éxito, consulta:** el resultado es admisible con la identidad y el papel, o no admisible con exactamente un motivo. Ninguna cuenta cambia.
- **Éxito, credencial:** la cuenta tiene la credencial derivada nueva y su sello de modificación es el del reloj.
- **Fallo:** la cuenta queda exactamente como estaba.
...
| Tests previstos en 08 | Unitarias con dobles sobre los tres estados de cuenta, la cuenta habilitada sin credencial, la fijación, el reemplazo con y sin verificación, y el correo inexistente |
