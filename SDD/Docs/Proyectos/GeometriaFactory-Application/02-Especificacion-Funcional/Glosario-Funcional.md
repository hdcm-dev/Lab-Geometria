...
| Contraseña provisoria | Valor de credencial que el administrador fija sobre la cuenta de un alumno al resetearla y le comunica fuera del producto. Es **provisoria** porque no sirve para nada más que para cambiarla: mientras esté vigente, la cuenta está confinada al cambio | `Especificacion-Funcional.md` §4, CU-11, CU-03 | «clave provisoria». **No se dice «contraseña temporal»**, que sugiere un vencimiento por tiempo que el producto no tiene |
