...
3. **Esta capa orquesta y decide quién puede, pero no declara reglas.** Las **quince** reglas del producto viven en `GeometriaFactory-Domain`, **las quince con archivo propio allá**, y acá se **ejercen** sobre el pedido concreto (`Especificacion-Funcional.md` §6). Un caso de uso que enunciara una regla nueva estaría mal ubicado; el procedimiento de decisión está en [`Guia-Onboarding-Developer.md`](Guia-Onboarding-Developer.md) §7.3.
