...
| BT-04016 | Construir la orquestación de la consulta, con la proyección sin componentes | feature | EP-T04 | `e` | Alta | Sin fijar | `05` §3.1, componente «Orquestación de la consulta»; `05` §6, las dos decisiones sobre la forma de la consulta; `05` §8, fila de componentes de pieza en el listado; [`Contracts ADR-08005`](../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-08005-Proyeccion-De-Listado-Separada-Del-Detalle.md) | BT-04007, BT-04010 | Las dos consultas salen con su **predicado de alcance ya trasladado a la consulta** y no filtrado en memoria; **0** componentes de pieza cargados en el listado del alumno y en el de la comisión; el detalle sí los trae; el detalle del administrador es **equivalente** al del alumno | US-04017, US-04018, US-04019, US-04020, US-04021, US-04022 |
