# US-31 — Conservar la cuenta, su estado de habilitación y todos sus trabajos después del reseteo

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Application
**Documento:** US-31-Conservar-La-Cuenta-Su-Estado-Y-Todos-Sus-Trabajos-Tras-El-Reseteo.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`RN-12` declara que el reseteo conserva la cuenta y sus trabajos y que **no dispara `RN-07`**. El contrato de uso es [`CU-11`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-11-Resetear-La-Contrasena-De-Un-Alumno.md). `05` §10.2 declara el tramo de esta capa: la postcondición que deja todo intacto y la **ausencia deliberada** de todo retiro.
...
| CU cubiertos | CU-11 |
| RN e invariantes que ejerce | RN-07 por contraste, RN-12, RN-15 |
...
| BT derivadas | BT-07, BT-13 |
| Tests previstos en 08 | Prueba con un alumno con trabajos en tres estados, comprobando la conservación completa |

## 5. Prioridad y estimación

`Must` por `RN-12` y porque el criterio de transición `d` → `e` lo exige verificado **sobre un alumno con trabajos en tres estados distintos y con sus comentarios**.
...
**El contraste con US-06 es el punto de la historia.** La baja arrastra todos los trabajos; el reseteo no toca ninguno. Que las dos operaciones vivan en el mismo panel del administrador es exactamente el motivo por el que la distinción tiene que ser verificable y no sólo declarada.
