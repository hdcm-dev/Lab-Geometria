# US-20 — Listar los trabajos de la comisión excluyendo los borradores

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Application
**Documento:** US-20-Listar-Los-Trabajos-De-La-Comision-Excluyendo-Los-Borradores.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`NB-07` pide revisión de la comisión desde un solo lugar, `RN-11` declara que el administrador no ve los borradores y `F-12` del intake §4 lo declara `Must Have`. El contrato de uso es [`CU-07`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-07-Revisar-Los-Trabajos-De-La-Comision.md). `05` §6 fija que el predicado de alcance **se traslada a la consulta** y no se aplica después.
...
| CU cubiertos | CU-07 |
| RN e invariantes que ejerce | RN-01, RN-11 |
...
| BT derivadas | BT-07, BT-10, BT-16 |
