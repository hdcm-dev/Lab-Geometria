# US-08 — Fijar la credencial derivada provisoria dentro de la habilitación

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Application
**Documento:** US-08-Fijar-La-Credencial-Derivada-Provisoria-Dentro-De-La-Habilitacion.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
`RN-16` declara que habilitar una cuenta produce su contraseña provisoria, con el mismo mecanismo y el mismo tratamiento que la del reseteo. El contrato de uso es [`CU-03`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-03-Resolver-El-Ingreso-Y-La-Credencial-Del-Alumno.md), en su fijación, solicitada por [`CU-02`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-02-Gobernar-Las-Cuentas-De-La-Comision.md). `05` §10.2 asigna el tramo de `RN-16` a esta capa en las operaciones de habilitar y rehabilitar.
...
| CU cubiertos | CU-03, CU-02 |
| RN e invariantes que ejerce | RN-14 (exigida por escrito, ejercida en `GeometriaFactory-Infrastructure`), RN-16; INV-09 |
...
**`RN-14` es la única de las dieciséis sin tramo en esta capa** (`02` §6 y `05` §10.2): que la provisoria no sea adivinable y no se repita lo ejerce `GeometriaFactory-Infrastructure`. Lo que esta historia sí hace es **exigirla por escrito**, para que no se pierda al bajar de contrato a implementación.

## 8. Control de cambios

| Versión | Fecha | Descripción |
| --- | --- | --- |
| 1.0 | 2026-08-10 | Emisión inicial. Confirma y redacta la historia prevista en `02` §7.3 con este identificador, reescrita por `02` 1.5 sobre `RN-16`. |
