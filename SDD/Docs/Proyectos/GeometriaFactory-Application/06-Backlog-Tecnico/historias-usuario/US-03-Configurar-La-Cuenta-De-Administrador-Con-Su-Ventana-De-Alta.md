# US-03 — Configurar la cuenta de administrador con su ventana de alta

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Application
**Documento:** US-03-Configurar-La-Cuenta-De-Administrador-Con-Su-Ventana-De-Alta.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
`NB-01` pide control de admisión al laboratorio y `F-01` del intake §4 lo declara `Must Have`. El contrato de uso es [`CU-10`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-10-Configurar-La-Cuenta-De-Administrador.md), que `02` §8 separó de CU-01 porque **no comparten casi nada**: el estado inicial es opuesto, la credencial se aporta en uno y se prohíbe en el otro, y la ventana de alta existe en uno y no en el otro.
...
- Given una credencial ausente en la solicitud, When se la procesa, Then se rechaza con su motivo: en este camino la credencial **se exige**, al revés que en CU-01.
...
| NB upstream | NB-01 |
| CU cubiertos | CU-10 |
| RN e invariantes que ejerce | RN-01, RN-02, RN-06; INV-05, INV-08 |
...
**La existencia previa de una cuenta con papel `Administrador` la resuelve el puerto y no el dominio.** `Domain ADR-06` declara que el dominio no consulta conjuntos, de modo que esa precondición la aporta esta capa: es la contracara de `INV-05` que `05` §10.3 le asigna.
