# US-07 — Devolver el motivo de una cuenta que no admite ingreso

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Application
**Documento:** US-07-Devolver-El-Motivo-De-Una-Cuenta-Que-No-Admite-Ingreso.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`RN-06` fija que una cuenta `Pendiente` o `Bloqueado` no obtiene acceso, y `02` §6 asigna a esta capa **la consulta de admisibilidad con su motivo**. El contrato de uso es [`CU-03`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-03-Resolver-El-Ingreso-Y-La-Credencial-Del-Alumno.md). `Domain ADR-05` declara la admisibilidad como **puerta única** de las guardas de acceso.
...
| NB upstream | NB-02 |
| CU cubiertos | CU-03 |
| RN e invariantes que ejerce | RN-06, RN-13; INV-06, INV-09 |
...
| BT derivadas | BT-08, BT-14, BT-10 |
