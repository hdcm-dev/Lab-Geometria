# US-11 — Conservar el texto original íntegro al cargar y al reeditar

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Application
**Documento:** US-11-Conservar-El-Texto-Original-Integro-Al-Cargar-Y-Al-Reeditar.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`RN-08` fija que el texto original se conserva íntegro y nunca se reescribe. El contrato de uso es [`CU-04`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-04-Cargar-Y-Reeditar-Un-Trabajo-Propio.md), y `05` §10.2 declara el tramo de esta capa: el texto se entrega tal cual **ni cuando la interpretación falla**.
...
| CU cubiertos | CU-04 |
| RN e invariantes que ejerce | RN-08 |
