# US-28 — Rechazar la configuración de un segundo administrador

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Application
**Documento:** US-28-Rechazar-La-Configuracion-De-Un-Segundo-Administrador.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
- Given una solicitud de auto-registro que pretende el papel `Administrador`, When se la procesa por CU-01, Then también se rechaza: la ventana de alta del administrador es exclusiva de CU-10.
...
| NB upstream | NB-01 |
| CU cubiertos | CU-10 |
| RN e invariantes que ejerce | RN-01; INV-05, INV-08 |
...
`Must` por `RN-01` e `INV-05`, y porque el criterio de transición `c` → `d` exige que el administrador se configure **sólo** mientras no exista ninguno.
