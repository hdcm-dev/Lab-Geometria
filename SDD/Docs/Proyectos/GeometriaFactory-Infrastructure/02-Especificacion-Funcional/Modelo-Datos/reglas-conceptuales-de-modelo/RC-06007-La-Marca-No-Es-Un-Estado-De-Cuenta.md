...
**Trazabilidad upstream:** [`RN-02012`](../../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02012-Reseteo-Conserva-La-Cuenta-Y-Sus-Trabajos.md); [`RN-02013`](../../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02013-Cambio-Forzado-Antes-De-Toda-Otra-Capacidad.md); [`RN-02015`](../../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02015-Reseteo-Independiente-Del-Estado-De-Cuenta.md); `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.14** §17.1.P.2 (**INV-09**) y §17.3.P.4 («Ampliación del 2026-08-08 por el circuito de revisión»); `Proyectos/GeometriaFactory-Domain/02-Especificacion-Funcional/Definicion-Modelo-De-Dominio.md`
...
- La marca alcanza a la entidad **cuenta**. **La ponen la habilitación y el reseteo del administrador, y la levanta únicamente el cambio efectivo hecho por la propia cuenta.** Hasta `PRODUCT-INTAKE` 1.12 la ponía sólo el reseteo, y **RN-06016** le agregó la habilitación (1.13 §4.1). **Traza**: el enunciado de INV-09 en §17.1.P.2 del intake decía «únicamente el reseteo» —frase de la 1.7 que la propia 1.13 pasó a contradecir en su §4.1—, y **el intake `1.14`, del 2026-08-09, lo reescribió**: la marca la ponen las dos operaciones que producen una contraseña provisoria, el reseteo (RN-06014) y la habilitación (RN-06016). Desde la 1.14 esta regla conceptual y la letra de la fuente **coinciden**, igual que `GeometriaFactory-Domain` `Definicion-Modelo-De-Dominio.md` §4.1.
...
| 1.2 | 2026-08-10 | **Absorbe `PRODUCT-INTAKE` 1.13 §4.1 (RN-06016) y la precisión de F-04**: habilitar una cuenta produce su contraseña provisoria y deja la marca puesta. **§3** declara que la marca tiene **dos** orígenes y no uno, y deja la constancia del desfase entre el enunciado de INV-09 en §17.1.P.2 —que sigue diciendo «únicamente el reseteo»— y lo que RN-06016 decide en §4.1 de la misma versión. **La regla no cambia**: la marca sigue sin ser un cuarto estado de cuenta, y sigue siendo ortogonal a la situación. Lo que cambia es cuántos actos la ponen. Sube minor. |
