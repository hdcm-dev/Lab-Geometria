# RC-03 — El valor declarado y el derivado se guardan por separado

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** RC-03-Valor-Declarado-Y-Derivado-Por-Separado.md
**Versión:** 1.1
**Estado:** Propuesto
**Fecha:** 2026-08-10
...
`CU-02` CA-04, que exige que el mensaje de la advertencia **exprese los dos valores** —declarada 36.00, derivada 54.00— y nunca un texto genérico, y CA-08, que compara el texto original antes y después de la verificación. Del lado del almacén, la recuperación del detalle de `CU-03` CA-05 devuelve las piezas con sus observaciones, que llevan los dos valores.
