...
**Trazabilidad upstream:** [`RN-02008`](../../../../GeometriaFactory-Domain/02-Especificacion-Funcional/Reglas-De-Negocio/RN-02008-Texto-Original-Conservado-Integro.md); `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.12** §4.1 (RN-06008), §9 (X-4), §17.3.P.4 («`JsonOriginal` conservado íntegro y nunca reescrito»), §17.3.P.11 punto 2
