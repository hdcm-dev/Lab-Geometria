...
- La marca alcanza a la entidad **cuenta**. **La ponen la habilitación y el reseteo del administrador, y la levanta únicamente el cambio efectivo hecho por la propia cuenta.** Hasta `PRODUCT-INTAKE` 1.12 la ponía sólo el reseteo, y **RN-16** le agregó la habilitación (1.13 §4.1). **Traza**: el enunciado de INV-09 en §17.1.P.2 del intake decía «únicamente el reseteo» —frase de la 1.7 que la propia 1.13 pasó a contradecir en su §4.1—, y **el intake `1.14`, del 2026-08-09, lo reescribió**: la marca la ponen las dos operaciones que producen una contraseña provisoria, el reseteo (RN-14) y la habilitación (RN-16). Desde la 1.14 esta regla conceptual y la letra de la fuente **coinciden**, igual que `GeometriaFactory-Domain` `Definicion-Modelo-De-Dominio.md` §4.1.
...
| 1.3 | 2026-08-10 | **Cierra el hallazgo `C-03` (P1) del informe de auditoría `SDD/Docs/Audit/Coherencia-Corpus-r1.md` 1.0, contra `PRODUCT-INTAKE` 1.14.** La viñeta de **§3** llevaba una «**Constancia**» que declaraba que el enunciado de INV-09 en el intake «sigue diciendo únicamente el reseteo»: la **1.14** reescribió ese enunciado —la marca la ponen el reseteo (RN-14) y la habilitación (RN-16)— y la constancia quedó como una afirmación falsa sobre la fuente. Se reemplaza por la traza: qué decía la fuente, de qué versión venía la frase, cuándo se corrigió, y que desde la 1.14 esta regla conceptual y la letra de la fuente coinciden. La cabecera pasa a citar el intake **1.14**. **El ámbito de aplicación, el enunciado de la regla conceptual y su verificación no cambian.** Sube minor. |
