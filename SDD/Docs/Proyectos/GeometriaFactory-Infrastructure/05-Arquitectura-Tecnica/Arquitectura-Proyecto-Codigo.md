...
**Dos recuentos del intake que esta categoría no puede propagar, y por qué.** `PRODUCT-INTAKE` §17.3.P.4 dice «los siete escenarios de §20» y §17.3.P.6 declara la entrada de la batería como «los escenarios E-1 a E-7»: los dos son anteriores a que `E-8` entrara al intake en su versión 1.7, y **§20 tiene ocho**, contados sobre sus encabezados. Esta categoría cuenta **ocho** y lo declara acá en lugar de repetir el número viejo; corregir la fuente es del Product Owner sobre su propio documento (ver `PA-08` de §11).
...
| PA-08 | **Dos recuentos de escenarios congelados en la fuente**: `PRODUCT-INTAKE` §17.3.P.4 dice «los siete escenarios de §20» y §17.3.P.6 declara la batería «con los escenarios E-1 a E-7», mientras §20 tiene **ocho** desde la versión 1.7. Esta categoría cuenta ocho y lo declara en §10.5; **corregir la fuente es del Product Owner sobre su propio documento** | Product Owner | Sin fecha comprometida |
