...
| --- | --- | --- | --- |
| Puerto de repositorio de trabajos | `IWorkRepository` (`PRODUCT-INTAKE` §17.3.P.1 por remisión a §14) | Adaptador de repositorio de trabajos | ADR-01, ADR-02 |
| Puerto de validación de figuras | `IFigureValidator` (`PRODUCT-INTAKE` §14) | Motor de interpretación de figuras y Motor de verificación de valores | ADR-06 |
| Puerto de reloj del sistema | `ISystemClock` (`PRODUCT-INTAKE` §14) | Adaptador de reloj del sistema | ADR-02 |
