# ADR-04 — Derivación de clave anclada, con sus parámetros versionados junto al valor guardado

**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** ADR-04-Derivacion-De-Clave-Anclada-Con-Parametros-Versionados.md
**Versión:** 1.0
**Estado:** Propuesto
**Fecha:** 2026-08-10
...
Motivación upstream: NB-02; RN-01, RN-06, RN-13, RN-16; INV-06, INV-09; `PRODUCT-INTAKE` §17.3.P.5, §17.5.P.5, §14 (RA-03).
...
- La columna del valor derivado del esquema físico está en [`../Modelo-Datos-Logico.md`](../Modelo-Datos-Logico.md) §2.1, y es **nula mientras la cuenta está `Pendiente`**: toma valor en el acto de habilitación, con la provisoria que produce [`ADR-05`](ADR-05-Contrasena-Provisoria-No-Adivinable-Y-Sin-Repetirse.md).
...
- [`../../02-Especificacion-Funcional/Casos-De-Uso/CU-06-Derivar-La-Contrasena-Y-Verificar-Una-Credencial.md`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-06-Derivar-La-Contrasena-Y-Verificar-Una-Credencial.md) y [`CU-08`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-08-Emitir-El-Acceso-Firmado.md).
- [`../../03-UX-UI-DX/DX-Error-Messages.md`](../../03-UX-UI-DX/DX-Error-Messages.md) §1.4 y §2.4.
- ADR relacionadas: [`ADR-05`](ADR-05-Contrasena-Provisoria-No-Adivinable-Y-Sin-Repetirse.md), [`ADR-07`](ADR-07-Transformaciones-Al-Arrancar-Con-Linaje-Inmutable.md).
