...
| PA-08 | ~~**La condición derivada `CONJUNTO_DE_PIEZAS_NO_RECONSTRUIDO`**~~ (`05` §11 `PA-10`). **CERRADO**: el Product Owner la **confirma tal como está**, con el fundamento que la categoría 02 había declarado. Este backlog no cambia: su prueba sigue siendo parte de BT-21 | **Cerrado** por el Product Owner, `PRODUCT-INTAKE` **1.29** §17.3 P.11 punto 5 | **Resuelto** el **2026-08-12** |
