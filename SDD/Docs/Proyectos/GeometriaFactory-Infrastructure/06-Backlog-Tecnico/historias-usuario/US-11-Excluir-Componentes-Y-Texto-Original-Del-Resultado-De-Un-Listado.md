# US-11 — Excluir componentes y texto original del resultado de un listado

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** US-11-Excluir-Componentes-Y-Texto-Original-Del-Resultado-De-Un-Listado.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`PRODUCT-INTAKE` §17.3.P.12 declara que los componentes se persisten pese a su redundancia **porque son parte del ejercicio**, y que se compensa **no cargándolos nunca en las consultas de listado**. La proyección separada del detalle es además la decisión de [`Contracts ADR-05`](../../../GeometriaFactory-Contracts/05-Arquitectura-Tecnica/Adrs/ADR-05-Proyeccion-De-Listado-Separada-Del-Detalle.md). El contrato de uso es [`CU-03`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-03-Guardar-Y-Recuperar-Los-Trabajos.md).
...
| --- | --- |
| NB upstream | NB-03, NB-07 (parcial) |
| CU cubiertos | CU-03 |
| RN que ejerce | — |
| Componente de `05` §3.1 | Adaptador de repositorio de trabajos |
| Reglas conceptuales de modelo | `RC-04` |
