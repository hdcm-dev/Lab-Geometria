# US-12 — Retirar físicamente un trabajo con todo lo que cuelga de él

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** US-12-Retirar-Fisicamente-Un-Trabajo-Con-Todo-Lo-Que-Cuelga-De-El.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`RN-04` declara **borrado físico**. `02` §5 llama a este contrato de uso **la única operación destructiva del producto**, y `02` §8 declara por qué se separó del guardado: lo que hay que poder verificar del retiro es que **no queda nada**, y eso no es un caso más de la materialización. El contrato de uso es [`CU-04`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-04-Ejecutar-El-Borrado-Fisico-Y-El-Arrastre-De-La-Baja.md).
...
| CU cubiertos | CU-04 |
| RN que ejerce | RN-04, en su mitad de borrado físico |
| Componente de `05` §3.1 | Adaptador de repositorio de trabajos |
| Reglas conceptuales de modelo | `RC-05`, retiro físico con arrastre |
...
`Must` por `RN-04` y porque el criterio de transición `h` → `i…` exige que el administrador elimine un trabajo en estado `Pendiente` y **el trabajo desaparezca**.
