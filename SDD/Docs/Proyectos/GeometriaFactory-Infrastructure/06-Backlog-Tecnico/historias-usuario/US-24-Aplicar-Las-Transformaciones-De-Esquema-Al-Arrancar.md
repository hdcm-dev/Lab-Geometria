# US-24 — Aplicar las transformaciones de esquema al arrancar, sobre base inexistente

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** US-24-Aplicar-Las-Transformaciones-De-Esquema-Al-Arrancar.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`PRODUCT-INTAKE` §17.3.P.11 punto 3 declara las transformaciones **aplicadas al arrancar y no por un paso manual**, y §17.3.P.8 las declara **criterio de aceptación de la etapa `c`**. Y `PT-04`, que se mide en la etapa `a`, exige que la imagen del servicio de datos **arranque, aplique sus actualizaciones de esquema sobre base vacía y responda salud**. El contrato de uso es [`CU-10`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-10-Preparar-El-Almacen-Al-Arrancar.md).
