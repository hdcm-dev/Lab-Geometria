# US-17 — Derivar una contraseña sin guardarla ni registrarla en claro

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** US-17-Derivar-Una-Contrasena-Sin-Guardarla-Ni-Registrarla-En-Claro.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
`02` §1 declara que acá viven **las dos piezas sensibles** del producto, y §4 que **éste es el único punto donde la contraseña en claro se convierte en el valor guardado**. `PRODUCT-INTAKE` §17.3.P.5 lo fija: derivación **nunca en claro ni con resumen simple**. El contrato de uso es [`CU-06`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-06-Derivar-La-Contrasena-Y-Verificar-Una-Credencial.md).
...
| NB upstream | NB-02 |
| CU cubiertos | CU-06 |
| RN que ejerce | — directamente; sostiene la credencial que `RN-13` y `RN-16` gobiernan |
...
| BT derivadas | BT-03, BT-13, BT-22 |
...
**Cuál de las dos funciones candidatas se ancla es `PA-03`** de [`../Product-Backlog.md`](../Product-Backlog.md) §6, cerrado como trabajo en BT-03, con caja temporal en la etapa `a`. La ADR correspondiente fija la **forma** —parámetros versionados, sin valor por defecto silencioso— y el **criterio de elección**; la elección concreta es del equipo.
