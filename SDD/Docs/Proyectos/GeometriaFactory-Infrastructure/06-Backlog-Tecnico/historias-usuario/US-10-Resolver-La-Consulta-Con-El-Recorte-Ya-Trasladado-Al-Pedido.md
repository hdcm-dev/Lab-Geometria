# US-10 — Resolver la consulta con el recorte ya trasladado al pedido

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** US-10-Resolver-La-Consulta-Con-El-Recorte-Ya-Trasladado-Al-Pedido.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
`RN-03` y `RN-11` acotan lo que cada papel ve, y `02` §6 declara que esta capa las ejerce **de forma negativa**: **la consulta sin recorte declarado no se resuelve**. Esta capa **no comprueba pertenencia**; lo que hace es **no ofrecer el camino** por el que la regla se rompería. El contrato de uso es [`CU-03`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-03-Guardar-Y-Recuperar-Los-Trabajos.md).
...
| CU cubiertos | CU-03 |
| RN que ejerce | RN-03 y RN-11, **de forma negativa** |
