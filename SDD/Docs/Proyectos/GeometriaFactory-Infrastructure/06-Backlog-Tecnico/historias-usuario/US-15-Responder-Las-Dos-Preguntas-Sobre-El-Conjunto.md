# US-15 — Responder si un correo está registrado y si ya existe una cuenta con papel `Administrador`

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** US-15-Responder-Las-Dos-Preguntas-Sobre-El-Conjunto.md
**Versión:** 1.0
**Estado:** Propuesta
**Fecha:** 2026-08-10
...
`Domain ADR-06` declara que **el dominio no lee el conjunto de entidades**, y `05` §2.2 identifica esa decisión como el origen de las **dos** preguntas sobre el conjunto que este adaptador responde. El contrato de uso es [`CU-05`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-05-Guardar-Y-Recuperar-Las-Cuentas-De-La-Comision.md).
...
**Estas dos preguntas y las dos restricciones de US-14 son cosas distintas y las dos hacen falta.** La pregunta permite responder con un motivo legible; la restricción impide el resultado aunque la pregunta haya llegado tarde.
