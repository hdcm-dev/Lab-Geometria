# US-21 — Emitir el acceso firmado con sus cuatro reclamos

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** US-21-Emitir-El-Acceso-Firmado-Con-Sus-Cuatro-Reclamos.md
**Versión:** 1.0
**Estado:** Aprobada
**Fecha:** 2026-08-10
...
| NB upstream | NB-02 |
| CU cubiertos | CU-08 |
| RN que ejerce | RN-01 en su parte de transporte del papel |
...
`Must` porque sin el acceso firmado ninguna petición del producto puede declarar identidad, y `RN-06` sólo puede sostenerse si una cuenta no admitida **no llega** hasta acá.
