...
| Insumos de verificación | `SDD/Docs/00-Contexto/`, `SDD/Docs/01-Necesidades-Negocio/` (en particular `NB-00006`), `SDD/Intake/PRODUCT-INTAKE-Fabrica-De-Geometria.md` v1.2, `SDD/Docs/Audit/A-00-01-r1.md` y `A-00-01-r2.md` (sólo lectura) |
...
- **Recomendación.** Sustituir por secciones concretas: `Compatibilidad-Plataformas.md` §2.2 (plataforma del navegador) y §4 (alternativas para plataformas no soportadas); `NB-00004` §4; y en el `README.md` de 02, los documentos y secciones efectivamente consumidos en lugar de las dos carpetas.
