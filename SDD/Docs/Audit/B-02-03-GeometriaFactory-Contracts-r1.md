...
- **Recomendación.** Dos filas en `Glosario-Funcional.md` §2: «Papel», con los dos valores admitidos y la nota de que el contrato lo transporta y no lo hace cumplir —que ya está en CU-02 §10—, y «Estado degradado», con la definición operativa que `Alcance-Producto.md` §8 y `NB-08` §5 ya sostienen. Referenciarlas desde `Glosario-UX.md` §4 en lugar de redefinirlas.
