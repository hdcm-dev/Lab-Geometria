...
**La puerta que comprueba este formulario no certifica todavía la transición.** `scripts/verify-stage-i.sh` mide criterios de una versión anterior del roadmap: su `I-1` verifica el flujo de FTP retirado y su `I-2` exige que producción coincida con `main`, cosa que la estrategia de versionado impide por diseño. Hasta que se reescriba (`DD-R8-1` de [`Mesa-2026-09-13-ciclo-2.md`](Mesa-2026-09-13-ciclo-2.md) §7), la medición se asienta en este documento y la puerta no decide la transición.
