...
| `H-12` | **Enunciado corregido el 2026-08-31** (`M-04` de la mesa). No es **un** apartamiento sino **dos** —el `409` y el `403`—, y no son tres destinos del genérico sino **cuatro** —`503`, `500`, `409` y `403`—, por **dos** apartamientos declarados en un comentario de código. §5.2 afirmaba «bajó de cuatro a dos»: el contrato 1.5 suma la constancia de que tiene cuatro. Falta darles forma de ADR | Product Owner |
