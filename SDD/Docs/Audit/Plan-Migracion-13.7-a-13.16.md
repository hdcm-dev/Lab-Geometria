...
**Estado:** **Presentado al Product Owner, sin aprobar** (lote en EXP-0001 actuación 010). Lleva los veredictos de [`Mesa-2026-09-13.md`](Mesa-2026-09-13.md). **Mientras no se apruebe, nada se escribe en `SDD/Intake/` ni en `SDD/Docs/`** fuera de esta carpeta (dictamen D-1)
