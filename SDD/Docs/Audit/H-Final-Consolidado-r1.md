...
| Identificadores fantasma | **0** | Recuperé con expresión regular todas las series cerradas del producto sobre `Docs/` e `Intake/` excluyendo `_legacy/`, y las contrasté contra el conjunto que declara su instrumento: `RN-01`…`RN-16` (nada fuera de rango), `INV-01`…`INV-09`, `NB-01`…`NB-09`, `PT-01`…`PT-05`, `RA-01`…`RA-03`, `F-01`…`F-26`, `X-1`…`X-9`, `E-1`…`E-8`, `ADR-XX` contra los archivos de cada proyecto (máximo referenciado = máximo existente en los siete), `CU-XX` contra los archivos de cada proyecto. **Ninguna referencia apunta a un identificador inexistente.** Las referencias `CU-20` a `CU-28` que un barrido ingenuo marca son la serie de nivel producto, escrita con prefijo `P·` declarado |
