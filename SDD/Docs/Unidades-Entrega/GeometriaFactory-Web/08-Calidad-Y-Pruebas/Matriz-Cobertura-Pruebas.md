...
| Pasos del guion de demostración | **100 %** de la etapa **y de todas las anteriores** **[ASUNCIÓN del intake §17.6.P.6 en cuanto a expresarlo como puerta]** | `TC-10035`. Gate `QG-04`, bloqueante | Ejecución en el navegador del equipo anfitrión | `Pendiente` |
