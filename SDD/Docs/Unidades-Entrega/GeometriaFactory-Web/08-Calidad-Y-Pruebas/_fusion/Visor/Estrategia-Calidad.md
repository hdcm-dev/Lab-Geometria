...
**En este proyecto de código el filtro más duro no es la revisión: son las dos puertas medidas sobre el artefacto generado.** Lo declara [`../06-Backlog-Tecnico/Definition-Of-Ready.md`](../../../06-Backlog-Tecnico/_fusion/Visor/Definition-Of-Ready.md) §4 y esta estrategia lo adopta: no dependen de que alguien las revise, se miden.
