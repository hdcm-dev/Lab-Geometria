...
Puntero único: [`../02-Especificacion-Funcional/Glosario-Funcional.md`](../../../02-Especificacion-Funcional/_fusion/Visor/Glosario-Funcional.md). Los **veinticuatro** términos que esa categoría acuña se usan acá **con su misma semántica** —eran veinte hasta que la capacidad **F-25** y su sexta función sumaron los cuatro del movimiento automático—. Los que aparecen en más de un artefacto de esta categoría:
