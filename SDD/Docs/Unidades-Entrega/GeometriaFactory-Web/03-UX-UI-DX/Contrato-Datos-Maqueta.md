...
| `DM-10024` | Pieza | `tipo` | Discriminante declarado en el texto | Sí | `Ortoedro` | `SUP-10006`, `SUP-10007`, `SUP-10008` | `Pieza` · Tipo | Seis tipos dibujables. Un tipo fuera del conjunto conocido produce observación de especie error de validación (RN-10009) y condición `TIPO_NO_DIBUJABLE` de la fachada |
