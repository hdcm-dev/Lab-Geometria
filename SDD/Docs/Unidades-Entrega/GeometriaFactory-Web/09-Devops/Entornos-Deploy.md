...
| Estado del proceso | En memoria del servidor del hosting, y **se pierde en cada reciclado**. No hay volumen, no hay caché externa y no hay sesión persistente | Intake §17.6.P.4; [`ADR-10002`](../05-Arquitectura-Tecnica/Adrs/ADR-10002-Sin-Estado-Propio-Y-Sin-Persistencia.md) |
...
| Configuración del bundle | **Ninguna, y es prohibición explícita.** `RA-02`: el bundle no lee configuración propia | [`../../GeometriaFactory-Visor/09-Devops/Entornos-Deploy.md`](_fusion/Visor/Entornos-Deploy.md) §4 |
