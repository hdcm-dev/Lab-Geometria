...
| **Dirección base del servicio de datos**, nombrada por su función | Vive como **secreto del repositorio** y se inyecta al publicar. **La dirección real del servidor propio no se versiona** | Intake §17.6.P.5; [`ADR-10007`](../05-Arquitectura-Tecnica/Adrs/ADR-10007-Direccion-Del-Servicio-De-Datos-Desde-Configuracion.md) §2 |
...
| 4 | **Verificar** según §3, empezando por la dirección pública | La subida terminada sin error **no es la verificación**; el intake §17.6.P.8 lo declara |
