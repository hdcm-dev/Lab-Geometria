...
>
> Copia archivada de `README.md` en su versión **2.0**, el estado que la ronda 2 del corte 09 superó el 2026-08-24 al sincronizar la tabla de documentos.
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 2.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`README.md`](../../README.md)
>
> **Se archiva tarde y se declara.** El audit de **M6** lo levantó como **P0**: este índice subió de 2.0 a 2.1 en el mismo commit que archivaba a sus tres hermanos de carpeta, y **no se copió**. `Master-Prompt.md` §5.1 no admite excepciones de nombre y un `README.md` de categoría no está en su tabla de exenciones. El cuerpo es el que estaba en `407240a^`, recuperado del historial; sólo se reescribieron los enlaces relativos.
