...
| [`Casos-De-Uso/CU-12001-Inicializar-Instancia-Del-Visor.md`](../../../05-Arquitectura-Tecnica/Contrato-Componente-Visor/CU-12001-Inicializar-Instancia-Del-Visor.md) | Contrato de uso de `inicializar`: crear la instancia sobre un elemento de dibujo y obtener su identificador | Propuesto |
| [`Casos-De-Uso/CU-12002-Cargar-El-Texto-Del-Trabajo-Y-Dibujar.md`](../../../05-Arquitectura-Tecnica/Contrato-Componente-Visor/CU-12002-Cargar-El-Texto-Del-Trabajo-Y-Dibujar.md) | Contrato de uso de `cargarJson`: dibujar las piezas por índice y devolver el resultado de dibujo | Propuesto |
| [`Casos-De-Uso/CU-12003-Seleccionar-Una-Pieza-Por-Su-Indice.md`](../../../05-Arquitectura-Tecnica/Contrato-Componente-Visor/CU-12003-Seleccionar-Una-Pieza-Por-Su-Indice.md) | Contrato de uso de `seleccionarPieza`: resaltado exclusivo por índice, que sincroniza el árbol con la escena | Propuesto |
| [`Casos-De-Uso/CU-12004-Redimensionar-La-Escena.md`](../../../05-Arquitectura-Tecnica/Contrato-Componente-Visor/CU-12004-Redimensionar-La-Escena.md) | Contrato de uso de `redimensionar`: ajustar la escena al tamaño vigente del elemento de dibujo | Propuesto |
| [`Casos-De-Uso/CU-12005-Destruir-La-Instancia-Y-Liberar-Recursos.md`](../../../05-Arquitectura-Tecnica/Contrato-Componente-Visor/CU-12005-Destruir-La-Instancia-Y-Liberar-Recursos.md) | Contrato de uso de `destruir`: liberar geometrías, materiales y contexto gráfico e invalidar el identificador | Propuesto |
| [`Casos-De-Uso/CU-12006-Ejercitar-La-Fachada-Sin-Backend.md`](../../../05-Arquitectura-Tecnica/Contrato-Componente-Visor/CU-12006-Ejercitar-La-Fachada-Sin-Backend.md) | Caso de uso transversal: recorrer las seis funciones desde una página integradora sin backend. Materializa el sample S-1 | Propuesto |
| [`Casos-De-Uso/CU-12007-Gobernar-El-Movimiento-Automatico-De-La-Escena.md`](../../../05-Arquitectura-Tecnica/Contrato-Componente-Visor/CU-12007-Gobernar-El-Movimiento-Automatico-De-La-Escena.md) | Contrato de uso de `establecerMovimiento`: prender y apagar los dos movimientos automáticos sobre una instancia viva, sin reconstruirla y sin perder la selección | Propuesto |
...
3. Leer los casos de uso en el orden del ciclo de vida —CU-12001, CU-12002, CU-12003, CU-12004, CU-12005, y después CU-12007, que gobierna el movimiento sobre una instancia ya viva— y cerrar con CU-12006, que los recorre juntos sin backend. **CU-12007 lleva el número más alto y se lee antes que CU-12006**: se emitió más tarde, con la sexta función, y no se renumeró para no romper referencias ya emitidas aguas abajo.
