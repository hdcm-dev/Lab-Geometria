...
**Trazabilidad upstream:** `NB-00006-Visualizacion-Dentro-Del-Producto.md` §1, §4 y §5 (criterios primero, segundo y cuarto); `NB-00004-Interpretacion-Fiel-Del-Dato-Del-Alumno.md` §4, en su parte de piezas efectivamente dibujadas; `00-Contexto/Vision-Producto.md` §3 (diferenciadores D-3 y D-4) y §9; `00-Contexto/Alcance-Producto.md` §4.1; `PRODUCT-INTAKE-Fabrica-De-Geometria.md` §17.7 P.2, P.3 y P.11 (puntos 4 y 5), §14 (RA-02), §20 E-1 y §20 E-7
...
| --- | --- |
| Necesidad de negocio | NB-00006; NB-00004 en su parte de piezas efectivamente dibujadas |
...
- **El estado de los movimientos automáticos sobrevive a la carga.** Cargar otro texto reemplaza el contenido dibujado, no el gobierno de la escena: lo que estaba prendido sigue prendido y las piezas nuevas nacen girando o quietas según ese estado. Cambiarlo es de `establecerMovimiento` (`CU-12007`), y no de este caso de uso.
