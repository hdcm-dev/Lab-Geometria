...
| Componente anfitrión del visualizador | El componente de la pieza pública que aloja el elemento de dibujo, invoca las cinco funciones de la fachada y **opera el ciclo de vida de la instancia**. Es quien invoca `destruir` al descartarse | `Especificacion-Funcional.md` §7, CU-05, CU-07 | El término lo acuña `GeometriaFactory-Visor`; acá se precisa quién lo encarna |
