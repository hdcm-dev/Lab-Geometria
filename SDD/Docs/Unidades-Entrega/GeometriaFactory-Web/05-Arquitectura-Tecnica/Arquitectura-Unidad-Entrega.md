...
| PA-05 | El **punto de quiebre principal en 768 px** y la **proporción próxima a 4:3 de la escena**, los dos rotulados **[ASUNCIÓN]** por la categoría 03 y sujetos a la validación visual. La maqueta se aprobó, de modo que quedaron ejercidos; lo que sigue abierto es si se confirman como valores del producto | El Product Owner sobre la línea de base visual | [`../../../../../changelog.md`](../../../../../changelog.md), etapa `g` § «Decidido en esta etapa, y elevado al punto de control» | **VENCIDO.** La etapa `g` cerró el **2026-08-17** y el punto sigue abierto |
| PA-06 | El **volumen de la comisión**, **[A VERIFICAR]**: el diseño de los dos listados supone decenas y no cientos, y por eso **no incorpora paginación**. Si resultara mucho mayor, la superficie afectada es `Listado-De-La-Comision` y el cambio es acotado | El Product Owner | [`../../../../../changelog.md`](../../../../../changelog.md), etapa `e` § «Decidido en esta etapa, y elevado al punto de control» | **VENCIDO.** La etapa `e` cerró el **2026-08-15** y el punto sigue abierto |
