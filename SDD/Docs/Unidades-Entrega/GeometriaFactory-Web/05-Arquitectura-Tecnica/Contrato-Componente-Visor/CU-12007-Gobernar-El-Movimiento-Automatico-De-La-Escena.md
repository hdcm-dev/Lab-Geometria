...
| --- | --- |
| Necesidad de negocio | NB-00006, en su parte de que la previsualización se mire con comodidad dentro del producto, prevista allá como **CU-28**. La capacidad de origen es **F-25** del intake §4, **`Must Have`** desde el intake 1.7 |
