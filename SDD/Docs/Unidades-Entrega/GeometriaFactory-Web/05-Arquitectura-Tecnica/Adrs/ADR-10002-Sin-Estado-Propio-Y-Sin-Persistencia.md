...
3. El estado degradado se puede diseñar como **superficie** y no como error, porque es una respuesta prevista y no una excepción ([`ADR-10005`](ADR-10005-Estado-Degradado-Como-Superficie.md)).
...
5. El texto original del trabajo **no se guarda ni se reescribe** en ningún punto del recorrido, lo que hace que `RN-10008` no tenga acá ningún lugar donde romperse.
...
- La única memoria del lado del front es el estado del circuito, y lo que guarda está acotado por [`ADR-10003`](ADR-10003-Credencial-De-Sesion-En-El-Estado-Del-Circuito.md).
...
- ADR relacionadas: [`ADR-10003`](ADR-10003-Credencial-De-Sesion-En-El-Estado-Del-Circuito.md), [`ADR-10005`](ADR-10005-Estado-Degradado-Como-Superficie.md).
