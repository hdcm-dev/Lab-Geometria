...
>
> Copia archivada de `US-10010-Dar-De-Baja-Exigiendo-El-Correo-Escrito-Y-Declarando-El-Arrastre.md` en su versión **1.1**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.1
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`US-10010-Dar-De-Baja-Exigiendo-El-Correo-Escrito-Y-Declarando-El-Arrastre.md`](../../US-10010-Dar-De-Baja-Exigiendo-El-Correo-Escrito-Y-Declarando-El-Arrastre.md)
>
...
`RN-10007` exige confirmación escrita y declara el arrastre de todos los trabajos. El caso de uso es [`CU-10004`](../../../../02-Especificacion-Funcional/Casos-De-Uso/CU-10004-Administrar-Las-Cuentas-De-La-Comision.md) FA-02. `05` §10.3 declara qué hace esta pieza por `RN-10007`: exigir el correo escrito **en la superficie** y **declarar antes del intento qué se va a arrastrar**.
...
**La baja y el reseteo viven en el mismo panel y hacen cosas opuestas**, y por eso la superficie declara lo que cada una cuesta antes del intento. US-10030 es la otra mitad de esta distinción.
