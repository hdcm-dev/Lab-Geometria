...
| BT-12005 | Construir el registro de instancias con su invalidación | feature | EP-T02 | Antes de `g` | Alta | No aplica | `05` §3.1, componente «Registro de instancias» | BT-12004 | Cada identificador resuelve a su instancia viva; al liberarla el identificador **queda invalidado** y toda invocación posterior informa `INSTANCIA_DESCONOCIDA`; dos instancias vivas no comparten escena, ni selección, ni disposición (garantía `G-4`) | US-12001, US-12009, US-12010, US-12011 |
