...
**Ninguna tarea inventa alcance.** Cada una nace de un componente de [`../05-Arquitectura-Tecnica/Arquitectura-Proyecto-Codigo.md`](../05-Arquitectura-Tecnica/Arquitectura-Proyecto-Codigo.md) §3.1, de una ADR, de un NFR de su §8, de una puerta técnica del intake §15 o de un punto abierto de `05` §11. Las cuatro que cierran un punto abierto son BT-12003, BT-12009, BT-12017 y BT-12018.
