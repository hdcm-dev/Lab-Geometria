...
>
> Copia archivada de `Product-Backlog.md` en su versión **3.4**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 3.4
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`Product-Backlog.md`](../../Product-Backlog.md)
>
