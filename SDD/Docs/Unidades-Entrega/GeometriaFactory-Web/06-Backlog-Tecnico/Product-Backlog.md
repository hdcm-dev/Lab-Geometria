...
| PA-07 | **El punto de quiebre principal y la proporción de la escena**, los dos rotulados **[ASUNCIÓN]** por la categoría 03 (`05` §11 `PA-05`). Convertido en trabajo como BT-10010 | El Product Owner sobre la línea de base visual | [`../../../../../changelog.md`](../../../../../changelog.md), etapa `g` § «Decidido en esta etapa, y elevado al punto de control» | **VENCIDO.** La etapa `g` cerró el **2026-08-17** y el punto sigue abierto |
| PA-08 | **El volumen de la comisión**, **[A VERIFICAR]** (`05` §11 `PA-06`): el diseño de los dos listados supone decenas y no cientos, y por eso **no incorpora paginación**. Convertido en trabajo como BT-10022 | El Product Owner | [`../../../../../changelog.md`](../../../../../changelog.md), etapa `e` § «Decidido en esta etapa, y elevado al punto de control» | **VENCIDO.** La etapa `e` cerró el **2026-08-15** y el punto sigue abierto |
| PA-09 | Si el **bundle generado se versiona en el repositorio o se ignora** (`05` §11 `PA-07`). Alcanza a esta pieza porque el bundle vive en su directorio de recursos estáticos. Convertido en trabajo como BT-10023 | La categoría 09 | `09-Devops/Estrategia-Versionado.md` y `09-Devops/Pipeline-CI-CD.md`, §ubicación de las puertas | **VENCIDO.** La categoría 09 está emitida desde el **2026-08-11** |
...
| PA-07 | **Si el bundle generado se versiona en el repositorio o se ignora** (`05` §11 `PA-05`). Convertido en trabajo como BT-12003 | La categoría 09 | `09-Devops/Estrategia-Versionado.md` y `09-Devops/Pipeline-CI-CD.md`, §ubicación de las puertas | **VENCIDO.** La categoría 09 está emitida desde el **2026-08-11** |
