...
5. **Toda condición de rechazo que produce existe en el catálogo** de [`../03-UX-UI-DX/DX-Error-Messages.md`](../../../03-UX-UI-DX/_fusion/Domain/DX-Error-Messages.md). Una historia que necesite una condición nueva no está lista: primero se da de alta en 03.
