...
`RN-00006` fija que una cuenta `Pendiente` o `Bloqueado` no obtiene acceso, y `PRODUCT-INTAKE` §17.5.P.5 declara la respuesta **con motivo**, distinta de la genérica de credenciales inválidas. El contrato de uso es [`CU-00001`](../../02-Especificacion-Funcional/Casos-De-Uso/CU-00001-Canjear-Credenciales-Por-Un-Acceso-Firmado.md).
