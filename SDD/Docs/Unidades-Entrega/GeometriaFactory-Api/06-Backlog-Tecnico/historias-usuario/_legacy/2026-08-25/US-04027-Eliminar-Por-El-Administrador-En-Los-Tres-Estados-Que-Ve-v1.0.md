...
>
> Copia archivada de `US-04027-Eliminar-Por-El-Administrador-En-Los-Tres-Estados-Que-Ve.md` en su versión **1.0**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`US-04027-Eliminar-Por-El-Administrador-En-Los-Tres-Estados-Que-Ve.md`](../../US-04027-Eliminar-Por-El-Administrador-En-Los-Tres-Estados-Que-Ve.md)
>
...
| RN e invariantes que ejerce | RN-04004, RN-04011; INV-03 |
...
| BT derivadas | BT-04010, BT-04015 |
...
**Los dos alcances de la eliminación son opuestos y viven en el mismo contrato de uso**: el alumno sólo en `Borrador`, el administrador en todo lo que ve, que es exactamente lo que el alumno no puede tocar. Es la partición que `RN-04004` declara en una sola regla.
