...
>
> Copia archivada de `US-06013-Arrastrar-Todos-Los-Trabajos-De-Una-Cuenta-Dada-De-Baja.md` en su versión **1.0**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`US-06013-Arrastrar-Todos-Los-Trabajos-De-Una-Cuenta-Dada-De-Baja.md`](../../US-06013-Arrastrar-Todos-Los-Trabajos-De-Una-Cuenta-Dada-De-Baja.md)
>
...
| RN que ejerce | RN-06007, en su mitad de arrastre; RN-06004 |
| Componente de `05` §3.1 | Adaptador de repositorio de trabajos, Adaptador de repositorio de cuentas |
| Reglas conceptuales de modelo | `RC-06005` |
...
`Must` por `RN-06007`, y porque `05` §8 fija el NFR de **0** retiros parciales tras una baja interrumpida.
...
**El reseteo no pasa por acá, y es la distinción que el producto vino a cerrar.** `RC-06007` declara que la marca **no es un estado de cuenta** y `RN-06012` que el reseteo conserva la cuenta y sus trabajos: US-06016 es el contraste exacto de esta historia.
