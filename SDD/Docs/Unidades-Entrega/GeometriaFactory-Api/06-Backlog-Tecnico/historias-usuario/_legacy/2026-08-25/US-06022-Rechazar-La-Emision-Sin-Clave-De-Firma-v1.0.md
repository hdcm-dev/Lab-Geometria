...
>
> Copia archivada de `US-06022-Rechazar-La-Emision-Sin-Clave-De-Firma.md` en su versión **1.0**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`US-06022-Rechazar-La-Emision-Sin-Clave-De-Firma.md`](../../US-06022-Rechazar-La-Emision-Sin-Clave-De-Firma.md)
>
...
| ¿Toca el almacén? | **No** |
| BT derivadas | BT-06015, BT-06021, BT-06022 |
...
**Es la segunda de las historias cuyo entregable es una terminación.** Junto con US-06020 y US-06025 forman el grupo que materializa la propiedad de que **un mecanismo que no puede cumplir su promesa se detiene y lo dice**.
