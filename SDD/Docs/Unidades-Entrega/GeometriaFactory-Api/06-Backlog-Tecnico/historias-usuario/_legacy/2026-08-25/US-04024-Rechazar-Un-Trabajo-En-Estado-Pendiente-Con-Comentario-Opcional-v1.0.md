...
>
> Copia archivada de `US-04024-Rechazar-Un-Trabajo-En-Estado-Pendiente-Con-Comentario-Opcional.md` en su versión **1.0**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`US-04024-Rechazar-Un-Trabajo-En-Estado-Pendiente-Con-Comentario-Opcional.md`](../../US-04024-Rechazar-Un-Trabajo-En-Estado-Pendiente-Con-Comentario-Opcional.md)
>
...
| RN e invariantes que ejerce | RN-04004, RN-04010; INV-07 |
...
| BT derivadas | BT-04010, BT-04017 |
...
**Aprobar y rechazar no se fusionaron en una sola historia** aunque compartan pantalla, precondición y regla, porque el resultado observable es distinto y cada uno tiene su criterio de transición propio en el roadmap. Lo que sí comparten es contrato de uso, y por eso los dos citan CU-04008.
