...
>
> Copia archivada de `US-02022-Excluir-Los-Borradores-Del-Alcance-Del-Administrador.md` en su versión **1.0**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`US-02022-Excluir-Los-Borradores-Del-Alcance-Del-Administrador.md`](../../US-02022-Excluir-Los-Borradores-Del-Alcance-Del-Administrador.md)
>
...
`RN-02011` declara que el administrador **no ve los trabajos en `Borrador`**: no forman parte de su flujo de trabajo. La capacidad `F-12` del intake §4 lo declara `Must Have`. Es el aporte parcial de este proyecto de código a `NB-00007`: la consulta que aplica el predicado vive en las capas de arriba ([`../../02-Especificacion-Funcional/Especificacion-Funcional.md`](../../../../02-Especificacion-Funcional/Especificacion-Funcional.md) §5.2).
...
- Given un trabajo en `Borrador`, When se evalúa el alcance del administrador, Then el trabajo **no** entra, por `RN-02011`.
...
| RN e invariantes que ejerce | RN-02011 |
...
`RN-02011` **no tiene invariante asociado**: es una regla de alcance de consulta y no una condición permanente sobre el estado (`PRODUCT-INTAKE` §17.1.P.2 · GeometriaFactory-Domain).
