...
>
> Copia archivada de `US-04017-Listar-Los-Trabajos-Propios-Con-Los-Cuatro-Estados-Distinguibles.md` en su versión **1.0**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`US-04017-Listar-Los-Trabajos-Propios-Con-Los-Cuatro-Estados-Distinguibles.md`](../../US-04017-Listar-Los-Trabajos-Propios-Con-Los-Cuatro-Estados-Distinguibles.md)
>
...
| RN e invariantes que ejerce | RN-04003; INV-02 |
...
`Must` por derivar de `F-08`, `Must Have`, y porque sin el listado propio el alumno no tiene dónde ver el desenlace de US-04018.
...
**Que el listado no arrastre componentes es una decisión que aguas abajo no se puede invertir sin romper un NFR** (`05` §6 y §8). Coincide con la proyección de listado que `GeometriaFactory-Contracts` separó del detalle en su ADR-04005, y `GeometriaFactory-Web` la consume sin invertirla.
