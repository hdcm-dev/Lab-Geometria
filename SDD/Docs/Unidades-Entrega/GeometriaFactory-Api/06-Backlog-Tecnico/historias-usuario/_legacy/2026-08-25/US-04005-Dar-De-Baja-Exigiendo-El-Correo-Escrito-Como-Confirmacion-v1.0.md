...
>
> Copia archivada de `US-04005-Dar-De-Baja-Exigiendo-El-Correo-Escrito-Como-Confirmacion.md` en su versión **1.0**, tomada el 2026-08-25 por el orquestador de migración normativa **antes** de aplicar el corte de la categoría 06 de la fase M4 (`Master-Prompt.md` §5 y §8).
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 1.0
> - **Fecha de archivado:** 2026-08-25
> - **Versión vigente:** [`US-04005-Dar-De-Baja-Exigiendo-El-Correo-Escrito-Como-Confirmacion.md`](../../US-04005-Dar-De-Baja-Exigiendo-El-Correo-Escrito-Como-Confirmacion.md)
>
...
| RN e invariantes que ejerce | RN-04001, RN-04007 |
...
**El arrastre es US-04006 y ocurre en la misma unidad de trabajo que esta baja.** Separarlos en dos historias no los separa en dos transacciones: `05` §4 declara la baja como el caso testigo de «un caso de uso, una unidad de trabajo».
