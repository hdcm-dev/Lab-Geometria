# BT-00005 — Anclar nombres de tipos, espacios de nombres y versiones de paquetes
...
Anclar nombres de tipos, espacios de nombres y versiones de paquetes.

## 2. Justificación

`05` §11 `PA-07`; `PRODUCT-INTAKE` §17.1.P.11 · GeometriaFactory-Api, que declara la versión de los paquetes abierta y anclada en la primera etapa

## 3. Criterios de aceptación

- Los nombres y las versiones quedan decididos y anclados según la regla de anclaje del producto, y registrados. **Caja temporal: la etapa `a`**
...
`indagación`. Los nombres y las versiones quedan decididos y anclados según la regla de anclaje del producto, y registrados. **Caja temporal: la etapa `a`**.
