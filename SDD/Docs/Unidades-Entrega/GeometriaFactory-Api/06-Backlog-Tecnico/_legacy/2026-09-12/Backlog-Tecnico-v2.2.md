...
>
> Copia archivada de `Backlog-Tecnico.md` en su versión **2.2**, tomada el 2026-09-12 antes del paso a
> **3.0** por el evento de `Rules-Backlog-Tecnico.md` §3.6: la entrada **4.3** del control de cambios de
> `PRODUCT-INTAKE-Fabrica-De-Geometria.md` (E-02, la API se expone públicamente), que agrega la fila `k`
> a `Roadmap-Producto.md` §3.
>
> - **Estado:** `Superado`
> - **Versión que preserva:** 2.2
> - **Fecha de archivado:** 2026-09-12
> - **Versión vigente:** [`../../Backlog-Tecnico.md`](../../Backlog-Tecnico.md)
>
> El cuerpo que sigue **no se modifica**; sólo se reescribieron los enlaces relativos.
...
**Estimación: no aplica.** El producto **no estima**: planifica por etapas con punto de control bloqueante. `PA-01` de [`Product-Backlog.md`](../../Product-Backlog.md) §6 quedó **cerrado por lectura** el 2026-08-25, y el fundamento está en su §4.1.
...
**Estimación: no aplica.** El producto **no estima**: planifica por etapas con punto de control bloqueante. `PA-01` de [`Product-Backlog.md`](../../Product-Backlog.md) §6 quedó **cerrado por lectura** el 2026-08-25, y el fundamento está en su §4.1. Lo que ordena las tareas es la **etapa** y las dependencias de §3, no un tamaño relativo.
...
| 2.1 | 2026-08-25 | **Ronda 2 del corte de la 06**, sobre el audit independiente que lo aprobó **con hallazgos**. **Recibe la propagación del cierre de `PA-01`** que la ronda 1 había afirmado sin hacer —hallazgo **P1** del audit—: **89 celdas** de la columna `Estimación` pasan a «No aplica» y **4 párrafos** dejan de remitir a `Product-Backlog.md` §4.1 como si esa sección declarara la estimación pendiente, cuando desde el 2026-08-25 declara lo contrario. **No era obligación normativa** —`Rules-Backlog-Tecnico.md` §4.5 no partió ningún ítem y las `BT` se gobiernan por ahí—, pero dejarlo habría dejado **130 celdas** apuntando a un fundamento que sostiene lo opuesto. **Y una constancia sobre los recuentos del mensaje de entrega de la ronda 1**, que el audit refutó (**P3**) y que no se pueden editar allí: los estados previos archivados son **148** y no 152 —144 historias, 2 `Product-Backlog` y 2 `Mini-Plan`—, y los enlaces reescritos **1099** y no 694. |
