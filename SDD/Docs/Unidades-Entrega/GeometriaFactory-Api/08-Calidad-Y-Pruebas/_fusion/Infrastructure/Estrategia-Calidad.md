...
Cada gate declara condición, cómo se verifica y qué pasa cuando no se cumple. Los cuatro primeros los declara el intake §17.3.P.8; los demás los deriva [`../05-Arquitectura-Tecnica/Arquitectura-Proyecto-Codigo.md`](../../../05-Arquitectura-Tecnica/_fusion/Infrastructure/Arquitectura-Proyecto-Codigo.md) §8, con una fila por NFR.
