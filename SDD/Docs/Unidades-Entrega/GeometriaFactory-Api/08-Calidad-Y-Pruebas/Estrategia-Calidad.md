...
Cada gate declara condición, cómo se verifica y qué pasa cuando no se cumple. Los cinco primeros salen del intake §17.1.P.8 · GeometriaFactory-Api; los demás los deriva [`../05-Arquitectura-Tecnica/Arquitectura-Unidad-Entrega.md`](../05-Arquitectura-Tecnica/Arquitectura-Unidad-Entrega.md) §8, con una fila por NFR.
...
Cada gate declara condición, cómo se verifica y qué pasa cuando no se cumple. Los cinco primeros los declara el intake §17.1.P.8 · GeometriaFactory-Domain; los tres siguientes los deriva [`../05-Arquitectura-Tecnica/Arquitectura-Unidad-Entrega.md`](../05-Arquitectura-Tecnica/Arquitectura-Unidad-Entrega.md) §8.
...
- [`../05-Arquitectura-Tecnica/Arquitectura-Unidad-Entrega.md`](../05-Arquitectura-Tecnica/Arquitectura-Unidad-Entrega.md) §8 y §10.5 ya habían resuelto la lectura antes de esa corrección: **la batería tiene 10 casos**, «los nueve obligatorios de la fuente más el décimo que §21 agregó con `E-8`».
