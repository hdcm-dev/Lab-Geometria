...
| 1.2 | 2026-08-09 | **Cierra la fila de este archivo del hallazgo `F26-20`** del informe de auditoría `SDD/Docs/Audit/F26-Propagacion-r1.md` 1.0. La entrada «condición de error del caso de uso» de §2 definía el término sobre «las **34** situaciones catalogadas» y son **36** desde que `CU-04011` entró al catálogo; `DX-Error-Messages.md` §7.1 y §3 ya declaraban 36. **Ningún término cambia de definición, de forma obligatoria ni de criterio de inclusión**, y el recuento de términos acuñados no cambia. Sube minor: corrige un número dentro de una definición. |
