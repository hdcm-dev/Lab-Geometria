...
| [`DX-Error-Messages.md`](DX-Error-Messages.md) | Catálogo de las **40 condiciones de error** derivadas una por una de la §6 de los doce casos de uso, con su categoría, su causa y su diagnóstico accionable | Propuesto |
