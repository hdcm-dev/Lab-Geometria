...
Esa frase es más fuerte de lo que parece, y es lo que hace verificable a la definición de calidad de [`../08-Calidad-Y-Pruebas/Estrategia-Calidad.md`](../../../08-Calidad-Y-Pruebas/_fusion/Application/Estrategia-Calidad.md) §1: **si un caso de uso necesitara algo del entorno que no entra por un puerto, dejaría de ser ejercible con dobles**, y con eso caería la propiedad que justifica el estilo entero del proyecto de código.
