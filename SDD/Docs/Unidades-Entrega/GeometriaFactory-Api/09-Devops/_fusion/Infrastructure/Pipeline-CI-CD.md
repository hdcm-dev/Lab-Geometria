...
| Qué relación tiene con `PT-04` | Es su mitad barata. `PT-04` exige que **la imagen** arranque, aplique las transformaciones sobre un almacén vacío y responda salud; este stage verifica la parte de las transformaciones **sin construir la imagen**, y por eso un fallo se ve antes | Intake §17.5.P.8; [`../08-Calidad-Y-Pruebas/README.md`](../../../08-Calidad-Y-Pruebas/_fusion/Infrastructure/README.md) §4, que asigna `PT-04` a la etapa `a` de este proyecto de código |
