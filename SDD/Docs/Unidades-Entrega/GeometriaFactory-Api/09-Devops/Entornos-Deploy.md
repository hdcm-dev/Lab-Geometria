...
| Aspecto | Decisión | Fundamento |
| --- | --- | --- |
| Quién conoce la dirección | **Únicamente el proceso del front**, y dentro de él, únicamente su cliente tipado del servicio de datos | Intake §17.6.P.3; `ADR-00007` de `GeometriaFactory-Web` §7 |
