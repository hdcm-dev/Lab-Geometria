# RC-06 — Los tres tiempos del trabajo son distintos y no se confunden

**Producto:** Fábrica de Geometría
**Proyecto de código:** GeometriaFactory-Infrastructure
**Documento:** RC-06-Tres-Sellos-De-Tiempo-Distintos.md
**Versión:** 1.0
**Estado:** Propuesto
**Fecha:** 2026-08-10
**Autor:** Analista Funcional + API Designer (AG-02)
**Trazabilidad upstream:** `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.11** §17.3.P.4, «Ampliación del 2026-08-09: sellos de tiempo del trabajo» **[DECISIÓN del Product Owner]**, y «El JSON del alumno no lleva fechas y no se le agrega ninguna» **[DECISIÓN 2026-08-09]**; §17.2.P.11 punto 3 (el reloj es un puerto); `Proyectos/GeometriaFactory-Domain/02-Especificacion-Funcional/Especificacion-Funcional.md` §9, que registra el cierre de este punto
...
- **El sello de desenlace** —cuándo el administrador aprobó o rechazó— acompaña al comentario, según `RC-07`.
...
`CU-09` CA-02, que fija el reloj en un momento concreto y exige que el sello registrado sea exactamente ése. Del lado del almacén, `CU-03` CA-01, que compara el texto materializado con el recuperado: **si se le hubiera agregado una fecha, los dos textos no serían idénticos**.
