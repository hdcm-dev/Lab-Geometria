...
- [CU-12](../Casos-De-Uso/CU-12-Configurar-La-Cuenta-De-Administrador.md) — Configurar la cuenta de administrador en el primer arranque.
- [CU-01](../Casos-De-Uso/CU-01-Registrar-El-Alta-De-Un-Alumno.md) — Registrar el alta de un alumno, **sólo** en cuanto al conjunto cerrado de dos papeles.
