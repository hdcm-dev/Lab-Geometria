...
**Trazabilidad upstream:** `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.14** §4.1 (enunciado de RN-02007, reglas sin invariante, y **RN-02012**), §4 (F-03, **F-26**), §4.2 (modelo de estados del trabajo), §7 (CL-6, **CL-7** reescrito), §9 (**X-2 retirada**), §11 (**RN-B6 tachado** el 2026-08-09; lo que sostenía vive en §7 CL-6), §17.1.P.2; [`NB-00001`](../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00001-Control-De-Admision-Al-Laboratorio.md) §2, §4 y §5; `00-Contexto/Vision-Producto.md` §8 (RG-06)
