...
Lo que la regla protege es la promesa de RN-02013 y de INV-09: la provisoria vale para un solo uso, el de llegar al cambio obligatorio. Una provisoria adivinable —derivada del correo, del nombre o de la fecha— o repetida entre cuentas dejaría que cualquiera entrase como cualquier alumno recién reseteado, y la ventana que RN-02013 acota a un solo ingreso quedaría abierta desde afuera.
