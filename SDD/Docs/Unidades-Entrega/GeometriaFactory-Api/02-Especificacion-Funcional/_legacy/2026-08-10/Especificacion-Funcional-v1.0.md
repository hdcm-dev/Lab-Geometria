...
**Trazabilidad upstream:** `00-Contexto/Vision-Producto.md` §9 (glosario raíz de la cadena); `00-Contexto/Alcance-Producto.md`; `01-Necesidades-Negocio/Necesidades-Negocio.md` y las necesidades NB-01 a NB-09; `PRODUCT-INTAKE-Fabrica-De-Geometria.md` **1.11**, §17.3 íntegro —en particular §17.3.P.2, §17.3.P.3, §17.3.P.4, §17.3.P.5, §17.3.P.6, §17.3.P.10, §17.3.P.11 y §17.3.P.12—, §4, §4.1 (**las quince reglas**), §4.2, §7, §10, §11 (RN-B3, RN-B5), §14 (RA-01 a RA-03), §20 y §21; `PRODUCT-MANIFEST-Fabrica-De-Geometria.md` **1.2** §2, §3 y §5; `Proyectos/GeometriaFactory-Application/02-Especificacion-Funcional/` completo, cuyos **cuatro puertos** este proyecto de código implementa; `Proyectos/GeometriaFactory-Domain/02-Especificacion-Funcional/` completo, cuyo modelo materializa
...
| --- | --- | --- | --- |
| CU-01 | [Interpretar el texto original y reconstruir las piezas](../../Casos-De-Uso/CU-06001-Interpretar-El-Texto-Original-Y-Reconstruir-Las-Piezas.md) | Lectura tolerante del texto real del alumno, con la cantidad de figuras del conjunto raíz, las piezas con su posición y los errores de validación ubicados | Propuesto |
| CU-02 | [Verificar los valores declarados contra los derivados](../../Casos-De-Uso/CU-06002-Verificar-Los-Valores-Declarados-Contra-Los-Derivados.md) | La comparación con tolerancia y operador estricto, que señala y no corrige ni rechaza | Propuesto |
| CU-03 | [Guardar y recuperar los trabajos](../../Casos-De-Uso/CU-06003-Guardar-Y-Recuperar-Los-Trabajos.md) | Materialización y consulta ya acotada, con el texto original conservado íntegro | Propuesto |
| CU-04 | [Ejecutar el borrado físico y el arrastre de la baja](../../Casos-De-Uso/CU-06004-Ejecutar-El-Borrado-Fisico-Y-El-Arrastre-De-La-Baja.md) | La única operación destructiva del producto: todo o nada, sin borrado lógico | Propuesto |
| CU-05 | [Guardar y recuperar las cuentas de la comisión](../../Casos-De-Uso/CU-06005-Guardar-Y-Recuperar-Las-Cuentas-De-La-Comision.md) | Las cuentas con su marca, y las dos preguntas sobre el conjunto que ninguna entidad sola responde | Propuesto |
| CU-06 | [Derivar la contraseña y verificar una credencial](../../Casos-De-Uso/CU-06006-Derivar-La-Contrasena-Y-Verificar-Una-Credencial.md) | El único punto del producto donde la contraseña en claro se convierte en el valor guardado, y el único que la compara | Propuesto |
| CU-07 | [Producir la contraseña provisoria del reseteo](../../Casos-De-Uso/CU-06007-Producir-La-Contrasena-Provisoria-Del-Reseteo.md) | **La delegación explícita de RN-14**: un valor no adivinable y que no se repite | Propuesto |
| CU-08 | [Emitir el acceso firmado](../../Casos-De-Uso/CU-06008-Emitir-El-Acceso-Firmado.md) | Los cuatro reclamos, la firma simétrica y la clave que vive fuera del repositorio de código y de la imagen | Propuesto |
| CU-09 | [Proveer el sello del reloj del sistema](../../Casos-De-Uso/CU-06009-Proveer-El-Sello-Del-Reloj-Del-Sistema.md) | El contrato más corto, y el que explica por qué la capa se puede probar entera con dobles | Propuesto |
| CU-10 | [Preparar el almacén al arrancar](../../Casos-De-Uso/CU-06010-Preparar-El-Almacen-Al-Arrancar.md) | Crear, transformar el esquema y detener el arranque antes que confiar en un almacén equivocado | Propuesto |
...
**Trece de las quince tienen tramo acá y dos no lo tienen**, y el recuento cierra en quince. **Tres tienen su tramo principal acá** —RN-08, RN-09 y **RN-14**—, y la consecuencia práctica es directa: **si acá se hacen mal, ninguna capa de más adentro puede repararlas**.

| RN | Enunciado en una línea | Dónde se ejerce en esta capa |
| --- | --- | --- |
| [RN-01](../../Reglas-De-Negocio/RN-02001-Administrador-Unico-Y-Papeles-Fijos.md) | Administrador único y papeles fijos | CU-05: la restricción de unicidad del almacén, que impide el resultado aunque no explique el camino. CU-08 transporta el papel en el acceso, sin decidir qué habilita |
| [RN-02](../../Reglas-De-Negocio/RN-02002-Correo-Del-Alumno-Unico.md) | El correo del alumno es único | CU-05: la segunda línea de la unicidad, con el motivo que la capa de aplicación ya declara recibir por esta vía |
| [RN-03](../../Reglas-De-Negocio/RN-02003-Trabajo-Ajeno-Indistinguible-De-Inexistente.md) | Un alumno sólo ve y opera sus propios trabajos | CU-03, **de forma negativa**: la consulta sin recorte declarado **no se resuelve**. Esta capa no comprueba pertenencia; lo que hace es no ofrecer el camino por el que la regla se rompería |
| [RN-04](../../Reglas-De-Negocio/RN-02004-Eliminacion-Acotada-Al-Borrador.md) | El alumno elimina sólo en borrador; el administrador, cualquier trabajo que ve | CU-04, **en su mitad de borrado físico**. La acotación por estado y por papel es de la capa de aplicación |
| [RN-05](../../Reglas-De-Negocio/RN-02005-Finalizacion-Sin-Errores-De-Validacion.md) | Un trabajo no pasa a estado `Pendiente` con errores de validación | CU-01 y CU-02 **producen el insumo**: la especie de cada observación. **El estado lo resuelve el dominio** y esta capa no lo decide |
| [RN-06](../../Reglas-De-Negocio/RN-02006-Cuenta-Pendiente-O-Bloqueada-Sin-Acceso.md) | Una cuenta `Pendiente` o `Bloqueado` no obtiene acceso | **Sin tramo acá.** La admisibilidad se resuelve antes y una cuenta no admitida **no llega** a CU-08. CU-05 guarda el estado, que es dato y no comprobación |
| [RN-07](../../Reglas-De-Negocio/RN-02007-Baja-Con-Arrastre-Y-Confirmacion-Escrita.md) | La baja arrastra los trabajos y exige confirmación escrita | CU-04, **en su mitad de arrastre**, con el todo o nada de la unidad de trabajo. La confirmación escrita es de la capa de aplicación |
| [RN-08](../../Reglas-De-Negocio/RN-02008-Texto-Original-Conservado-Integro.md) | El texto original del alumno se conserva íntegro | **Tramo principal acá.** CU-01 no lo devuelve corregido y CU-03 rechaza toda escritura que lo reemplace (`RC-01`). Es la capa donde el texto se escribe y se conserva, y por lo tanto donde puede perderse |
...
| [RN-10](../../Reglas-De-Negocio/RN-02010-Desenlace-Exclusivo-Del-Administrador-Y-Terminalidad.md) | El desenlace es exclusivo del administrador y es terminal | **Sin tramo acá.** Esta capa guarda el estado y el comentario; quién puede cambiarlo y desde dónde lo deciden el dominio y la capa de aplicación |
| [RN-11](../../Reglas-De-Negocio/RN-02011-El-Administrador-No-Ve-Los-Borradores.md) | El administrador no ve los trabajos en borrador | CU-03, **de forma negativa**, igual que RN-03: el predicado de alcance llega en el pedido y el borrador **no viaja** |
| [RN-12](../../Reglas-De-Negocio/RN-02012-Reseteo-Conserva-La-Cuenta-Y-Sus-Trabajos.md) | El reseteo conserva la cuenta y sus trabajos, y no es una baja | CU-05, que escribe la marca **sin tocar el estado ni los trabajos**, y CU-04 **por contraste**: el reseteo no pasa por el retiro (`RC-05`, `RC-07`) |
| [RN-13](../../Reglas-De-Negocio/RN-02013-Cambio-Forzado-Antes-De-Toda-Otra-Capacidad.md) | Con la provisoria sin cambiar, la cuenta no llega a ninguna otra parte | CU-05: **conserva la marca y la hace viajar**. Sin ese dato, la comprobación transversal de la capa de aplicación no tendría sobre qué decidir. La comprobación **no es de acá** |
| [**RN-14**](../../Reglas-De-Negocio/RN-02014-Provisoria-Producida-Por-El-Sistema.md) | La provisoria la produce el sistema: no es adivinable y no se repite | **Tramo principal, y único, acá: CU-07.** `GeometriaFactory-Application` §6 declara que es la única de las quince **sin tramo en su capa**, `GeometriaFactory-Contracts` `CU-08` §10 la exige sin declarar mecanismo, y `RN-14` §3 nombra a este proyecto de código como el lugar de la generación |
| [RN-15](../../Reglas-De-Negocio/RN-02015-Reseteo-Independiente-Del-Estado-De-Cuenta.md) | Resetear no exige que la cuenta esté habilitada | CU-07 **de forma estructural**: la invocación **no recibe** el estado de la cuenta, de modo que no puede comprobarlo. Y CU-05, que escribe la marca sobre los tres estados sin alterarlos (`RC-07`) |
...
| --- | --- | --- | --- |
| [NB-01](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00001-Control-De-Admision-Al-Laboratorio.md) · Control de admisión y de bajas del laboratorio | CU-04, CU-05, CU-07 | RN-01, RN-02, RN-07, RN-12, RN-14, RN-15 | US-12, US-13, US-14, US-15, US-16, US-19, US-20 |
| [NB-02](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00002-Identidad-Propia-Del-Alumno-Sin-Correo.md) · Identidad propia del alumno sin canal de correo | CU-05, CU-06, CU-07, CU-08 | RN-01, RN-13, RN-14 | US-14, US-17, US-18, US-19, US-20, US-21, US-22 |
| [NB-03](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00003-Trabajo-Con-Dueno-Estado-Y-Persistencia.md) · Trabajo con dueño, estado y persistencia | CU-03, CU-04, CU-10 | RN-03, RN-04, RN-08 | US-08, US-09, US-10, US-11, US-12, US-24, US-25 |
| [NB-04](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00004-Interpretacion-Fiel-Del-Dato-Del-Alumno.md) · Interpretación fiel del dato del alumno | CU-01 | RN-05, RN-08, RN-09 | US-01, US-02, US-03, US-04 |
| [NB-05](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00005-Visibilidad-Del-Error-De-Calculo.md) · Visibilidad del error de cálculo | CU-02 | RN-05, RN-09 | US-05, US-06, US-07 |
| [NB-06](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00006-Visualizacion-Dentro-Del-Producto.md) · Visualización del trabajo dentro del producto | CU-01 (parcial), CU-03 (parcial) | RN-09 | US-03, US-11 |
| [NB-07](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00007-Revision-De-La-Comision-En-Un-Solo-Lugar.md) · Revisión de la comisión desde un solo lugar | CU-03 (parcial) | RN-11 | US-10 |
| [NB-08](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00008-Alcance-Del-Laboratorio-Desde-El-Aula.md) · Alcance del laboratorio desde el aula | CU-10 (parcial) | — | US-24, US-25 |
| [NB-09](../../../../../01-Necesidades-Negocio/Necesidades-De-Negocio/NB-00009-Desenlace-Explicito-De-La-Entrega.md) · Desenlace explícito de la entrega | CU-03 (parcial), CU-04 | RN-04, RN-11 | US-09, US-13 |
...
| `_legacy/` | **No existe** | Es la emisión inicial de la categoría para este proyecto de código y no hay ninguna versión superada que archivar |
...
Diez, y ninguno bloqueante. **Cinco son propios de esta categoría y cinco vienen declarados de aguas arriba y no se reabren.**

| Punto | Situación | Quién lo resuelve |
| --- | --- | --- |
| **Qué devuelve el validador ante el texto del escenario E-8** | Propio. El texto es JSON sintácticamente válido y lo que falla es la lectura de un valor. **Ninguna fuente declara el resultado esperado para esta capa**: §20 lo declara borde de la pieza que dibuja y su punto 4 dice que no prescribe el desenlace del envío. La consecuencia para el alumno es visible en los dos caminos posibles. Detalle en `Definicion-Contrato-Del-Validador-De-Figuras.md` §9 | Product Owner, y `08-Calidad-Y-Pruebas` |
