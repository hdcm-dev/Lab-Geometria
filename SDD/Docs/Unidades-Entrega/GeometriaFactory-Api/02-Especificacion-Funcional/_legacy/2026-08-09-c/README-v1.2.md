...
>
> Copia archivada de `README.md` en su versión **1.2**, tomada el 2026-08-09 por el orquestador SDD **antes** de despachar la corrección, según `Master-Prompt.md` §8.
>
> - **Estado:** `Superado`
...
| CU-12 | [Configurar la cuenta de administrador en el primer arranque](../../Casos-De-Uso/CU-04010-Configurar-La-Cuenta-De-Administrador.md) | NB-01 |
...
2. **`Definicion-Modelo-De-Dominio.md`** — las entidades, los siete invariantes y las dos máquinas de estado. Los once casos de uso se leen sobre él, y en particular §5.2, que es donde vive el ciclo de vida completo del trabajo.
