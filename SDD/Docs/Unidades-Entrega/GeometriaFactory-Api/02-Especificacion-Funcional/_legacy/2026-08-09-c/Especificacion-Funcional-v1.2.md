...
>
> Copia archivada de `Especificacion-Funcional.md` en su versión **1.2**, tomada el 2026-08-09 por el orquestador SDD **antes** de despachar la corrección, según `Master-Prompt.md` §8.
>
> - **Estado:** `Superado`
...
| CU-12 | [Configurar la cuenta de administrador en el primer arranque](../../Casos-De-Uso/CU-04010-Configurar-La-Cuenta-De-Administrador.md) | Constituir la única cuenta de administrador, `Habilitado` y con credencial, mientras no exista ninguna | Propuesto |
...
| --- | --- | --- | --- | --- |
| RN-01 | [Administrador único y papeles fijos](../../Reglas-De-Negocio/RN-02001-Administrador-Unico-Y-Papeles-Fijos.md) | INV-05 | CU-12, CU-02, CU-01, CU-04 | Propuesto |
| RN-02 | [El correo del alumno es único](../../Reglas-De-Negocio/RN-02002-Correo-Del-Alumno-Unico.md) | INV-01 | CU-01, CU-12 | Propuesto |
...
| **Adopción del invariante candidato INV-08** | La corrección del P0 dejó ver una propiedad permanente que ninguno de los siete invariantes del intake enuncia: que la única cuenta que nace `Habilitado` es la del administrador, y sólo mientras no exista ninguna. Se **propone** en `Definicion-Modelo-De-Dominio.md` §4.2, declarado como no vigente y **no proveniente del intake**. El modelo es correcto sin él —CU-01 y CU-12 fijan cada uno su estado inicial y rechazan el del otro—; adoptarlo lo haría verificable como condición permanente | Product Owner, con su incorporación a `PRODUCT-INTAKE` §17.1.P.2 |
