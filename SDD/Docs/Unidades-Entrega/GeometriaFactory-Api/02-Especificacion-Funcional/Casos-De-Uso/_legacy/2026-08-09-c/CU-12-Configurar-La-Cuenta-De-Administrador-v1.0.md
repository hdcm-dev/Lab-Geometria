...
>
> Copia archivada de `CU-12-Configurar-La-Cuenta-De-Administrador.md` en su versión **1.0**, tomada el 2026-08-09 por el orquestador SDD **antes** de despachar la corrección, según `Master-Prompt.md` §8.
>
> - **Estado:** `Superado`
...
- La cuenta de administrador **no admite baja**, por RN-01 y por CU-02, que la rechaza con `CUENTA_DE_ADMINISTRADOR_NO_ADMITE_BAJA`. Por eso este caso de uso se ejerce una sola vez en la vida de la instancia.
