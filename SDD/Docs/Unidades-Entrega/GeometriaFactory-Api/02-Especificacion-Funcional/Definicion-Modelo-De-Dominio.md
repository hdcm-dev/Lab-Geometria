...
**RN-02001 e INV-08.** La tabla asigna INV-05 a RN-02001 porque es el invariante que expresa su núcleo, la unicidad del administrador. INV-08 la sostiene también, en su otra mitad —el estado permanente de esa cuenta—, y `PRODUCT-INTAKE` §17.1.P.2 lo declara sobre RN-02001 y RN-02006. Ninguna de las dos asignaciones desplaza a la otra.

## 5. Transiciones de estado

### 5.1 Estado de la cuenta del alumno

Los tres estados están declarados en PRODUCT-INTAKE §17.1.P.5. La baja no es un estado: es la desaparición de la cuenta y de sus trabajos (RN-02007).
