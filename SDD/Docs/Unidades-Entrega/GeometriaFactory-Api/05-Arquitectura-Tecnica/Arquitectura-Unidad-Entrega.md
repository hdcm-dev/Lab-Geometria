...
| Caudal sostenido | **20 peticiones por minuto** [ASUNCIÓN del intake], **provisorio desde el 2026-08-20**, derivado del uso previsto —una comisión operando durante una clase— y de la limitación de escritor único del almacén | Prueba de carga acotada en la batería de integración. **Desde `BT-00029` (2026-09-13) el NFR tiene mecanismo que lo hace cumplir**: límite de tasa por persona autenticada o por dirección de origen ([`Contratos-REST.md`](Contratos-REST.md) §4.1; 60, 120 y 30 por minuto por omisión, configurables), verificado por `RateLimitingTests` con los umbrales reales, incluida la ráfaga de la cuota entera de una persona en escritura contra el único escritor | [`ADR-00005`](Adrs/ADR-00005-Sin-Paginacion-Con-Condicion-De-Reingreso-Declarada.md) |
