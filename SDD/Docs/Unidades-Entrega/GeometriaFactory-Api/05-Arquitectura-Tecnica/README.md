...
2. [`Adrs/ADR-00003`](Adrs/ADR-00003-Credencial-Firmada-Papel-Por-Punto-Y-Guardia-Transversal.md) junto con [`Arquitectura-Proyecto-Codigo.md`](Arquitectura-Proyecto-Codigo.md) §3.4 — la guardia y la tabla de los quince puntos, que se leen mejor juntas. **Es la propiedad que se rompe agregando un punto y olvidándose.**
