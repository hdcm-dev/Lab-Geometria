...
| Castellano | Inglés | Clase | Dónde está declarado el concepto |
| --- | --- | --- | --- |
| `inicializar(elemento, opciones)` | `initialize(element, options)` | Función de fachada | Intake §17.2.P.3 · GeometriaFactory-Visor; `Definicion-Contrato-De-Fachada.md`; `Visor ADR-02` |
...
| Castellano | Inglés | Clase | Dónde está declarado el concepto |
| --- | --- | --- | --- |
| `ADMINISTRADOR_YA_CONFIGURADO` | `ADMINISTRATOR_ALREADY_CONFIGURED` | Domain · Application | `Domain/03` §3.12 · CU-12 · RN-02001 |
| `ADVERTENCIA_SIN_LOS_DOS_VALORES` | `WARNING_MISSING_BOTH_VALUES` | Domain | `Domain/03` §3.7 · CU-07 |
| `ALCANCE_SIN_PAPEL_DE_ADMINISTRADOR` | `SCOPE_REQUIRES_ADMINISTRATOR_ROLE` | Domain | `Domain/03` §3.11 · CU-11 · RN-02001, RN-02011 |
| `BAJA_SIN_ARRASTRE_DE_TRABAJOS` | `DELETION_WITHOUT_WORK_CASCADE` | Domain | `Domain/03` §3.2 · CU-02 · RN-02007 |
| `CAMBIO_DE_CONTRASENA_PENDIENTE` | `PASSWORD_CHANGE_PENDING` | Domain · Application | `Domain/03` §3.4 · CU-04 · RN-02013, RN-02016 |
...
| `CUENTA_BLOQUEADA` | `ACCOUNT_BLOCKED` | Domain · Application | `Domain/03` §3.4 · CU-04 · RN-02006 |
| `CUENTA_NO_HABILITADA_PARA_CREDENCIAL` | `ACCOUNT_NOT_ENABLED_FOR_CREDENTIAL` | Domain · Application | `Domain/03` §3.3 · CU-03 · RN-02006 |
| `CUENTA_PENDIENTE` | `ACCOUNT_PENDING` | Domain · Application | `Domain/03` §3.4 · CU-04 · RN-02006 |
| `DATO_OBLIGATORIO_AUSENTE` | `REQUIRED_FIELD_MISSING` | Domain · Application | `Domain/03` §3.1, §3.12, §3.5 · CU-01, CU-05, CU-12 |
| `DESENLACE_DESCONOCIDO` | `UNKNOWN_OUTCOME` | Domain · Application | `Domain/03` §3.10 · CU-10 · RN-02010 |
| `DESENLACE_FUERA_DE_PENDIENTE` | `OUTCOME_OUTSIDE_SUBMITTED` | Domain · Application | `Domain/03` §3.10 · CU-10 · RN-02010, RN-02011 |
| `DESENLACE_NO_ADMITIDO_EN_ESTE_CONTRATO` | `OUTCOME_NOT_ALLOWED_BY_CONTRACT` | Domain | `Domain/03` §3.8 · CU-08 · RN-02010 |
| `DESENLACE_SIN_PAPEL_DE_ADMINISTRADOR` | `OUTCOME_REQUIRES_ADMINISTRATOR_ROLE` | Domain | `Domain/03` §3.10 · CU-10 · RN-02010, RN-02001 |
| `ENVIO_FUERA_DE_BORRADOR` | `SUBMISSION_OUTSIDE_DRAFT` | Domain · Application | `Domain/03` §3.8 · CU-08 · RN-02005 |
| `ENVIO_SIN_INTERPRETACION` | `SUBMISSION_WITHOUT_PARSE_RESULT` | Domain | `Domain/03` §3.8 · CU-08 · RN-02005 |
| `ERROR_SIN_UBICACION` | `ERROR_WITHOUT_LOCATION` | Domain | `Domain/03` §3.7 · CU-07 · RN-02009 |
| `ESPECIE_DE_OBSERVACION_DESCONOCIDA` | `UNKNOWN_OBSERVATION_KIND` | Domain | `Domain/03` §3.7 · CU-07 · RN-02005 |
...
| `HABILITACION_SIN_CREDENCIAL_PROVISORIA` | `ENABLE_WITHOUT_TEMPORARY_CREDENTIAL` | Domain · Application | `Domain/03` §3.2 · CU-02 · RN-02016, RN-02014 |
| `OBSERVACION_SOBRE_PIEZA_INEXISTENTE` | `OBSERVATION_ON_MISSING_PIECE` | Domain | `Domain/03` §3.7 · CU-07 · RN-02009 |
| `OPERACION_DESCONOCIDA` | `UNKNOWN_OPERATION` | Domain | `Domain/03` §3.11, §3.9 · CU-09, CU-11 |
| `OPERACION_FUERA_DE_BORRADOR` | `OPERATION_OUTSIDE_DRAFT` | Domain · Application | `Domain/03` §3.9 · CU-09 · RN-02004 |
| `OPERACION_NO_APLICABLE_A_LA_CUENTA_DE_ADMINISTRADOR` | `OPERATION_NOT_APPLICABLE_TO_ADMINISTRATOR_ACCOUNT` | Domain | `Domain/03` §3.13, §3.2 · CU-02, CU-13 · RN-02001 · **unifica a `CUENTA_DE_ADMINISTRADOR_NO_ADMITE_BAJA`, §6.9** |
| `PAPEL_DE_ADMINISTRADOR_FUERA_DE_ESTE_CAMINO` | `ADMINISTRATOR_ROLE_OUTSIDE_THIS_PATH` | Domain · Application | `Domain/03` §3.1 · CU-01 · RN-02001 |
| `POSICION_DE_PIEZA_INVALIDA` | `INVALID_PIECE_POSITION` | Domain | `Domain/03` §3.6 · CU-06 |
| `RECONSTRUCCION_SOBRE_TRABAJO_TERMINAL` | `REBUILD_ON_TERMINAL_WORK` | Domain | `Domain/03` §3.6 · CU-06 · RN-02010 |
| `REEDICION_FUERA_DE_BORRADOR` | `EDIT_OUTSIDE_DRAFT` | Domain | `Domain/03` §3.5 · CU-05 · RN-02004 |
| `RESETEO_CON_ARRASTRE_DE_TRABAJOS` | `RESET_WITH_WORK_CASCADE` | Domain | `Domain/03` §3.13 · CU-13 · RN-02012 |
| `TEXTO_ORIGINAL_ALTERADO` | `ORIGINAL_JSON_ALTERED` | Domain · Application | `Domain/03` §3.5 · CU-05 · RN-02008 |
| `TIPO_DE_PIEZA_DESCONOCIDO` | `UNKNOWN_PIECE_TYPE` | Domain | `Domain/03` §3.6 · CU-06 · RN-02009 |
| `TRABAJO_FUERA_DEL_ALCANCE_DEL_ADMINISTRADOR` | `WORK_OUTSIDE_ADMINISTRATOR_SCOPE` | Domain · Application | `Domain/03` §3.11 · CU-11 · RN-02011, RN-02004 |
| `TRABAJO_INEXISTENTE_PARA_EL_SOLICITANTE` | `WORK_NOT_FOUND_FOR_REQUESTER` | Domain · Application | `Domain/03` §3.9 · CU-09 · RN-02003 |
| `TRABAJO_SIN_DUENO` | `WORK_WITHOUT_OWNER` | Domain · Application | `Domain/03` §3.5 · CU-05 · RN-02003 |
| `TRANSICION_DESDE_ESTADO_TERMINAL` | `TRANSITION_FROM_TERMINAL_STATUS` | Domain · Application | `Domain/03` §3.10, §3.8 · CU-08, CU-10 · RN-02010 |
| `TRANSICION_DE_CUENTA_NO_ADMITIDA` | `ACCOUNT_TRANSITION_NOT_ALLOWED` | Domain · Application | `Domain/03` §3.2 · CU-02 |
| `UNICIDAD_DE_CORREO_NO_VERIFICADA` | `EMAIL_UNIQUENESS_NOT_VERIFIED` | Domain | `Domain/03` §3.1, §3.12 · CU-01, CU-12 · RN-02002 |
...
| Castellano | Inglés | Clase | Dónde está declarado el concepto |
| --- | --- | --- | --- |
| `CONFIRMACION_DE_BAJA_NO_COINCIDE` | `DELETION_CONFIRMATION_MISMATCH` | Application | `Application/03` §3.2 · CU-02 · RN-02007 |
| `CONJUNTO_DE_PIEZAS_MAL_FORMADO` | `MALFORMED_PIECE_SET` | Application | `Application/03` §3.5 · CU-05 · RN-02009 |
| `CORREO_YA_REGISTRADO` | `EMAIL_ALREADY_REGISTERED` | Application · Infrastructure | `Application/03` §3.1 · CU-01, CU-10 · RN-02002 |
| `CUENTA_DE_ADMINISTRADOR_NO_ADMITE_BAJA` | `OPERATION_NOT_APPLICABLE_TO_ADMINISTRATOR_ACCOUNT` | Application | `Application/03` §3.2 · CU-02 · RN-02001 · **unificado con el de `Domain`, §6.9** |
| `CUENTA_INEXISTENTE` | `ACCOUNT_NOT_FOUND` | Application | `Application/03` §3.2 · CU-02, CU-03, CU-11 |
| `FACULTAD_DE_ADMINISTRADOR_REQUERIDA` | `ADMINISTRATOR_ROLE_REQUIRED` | Application | `Application/03` §3.2 · CU-02, CU-07, CU-08, CU-11 · RN-02001, RN-02010 |
| `INTERPRETACION_NO_DISPONIBLE` | `PARSE_RESULT_UNAVAILABLE` | Application · Infrastructure | `Application/03` §3.5 · CU-05 · RN-02008 |
| `OBSERVACION_MAL_FORMADA` | `MALFORMED_OBSERVATION` | Application | `Application/03` §3.5 · CU-05 · RN-02009, RN-02005 |
| `PAPEL_NO_RECONOCIDO` | `UNRECOGNIZED_ROLE` | Application | `Application/03` §3.9 · CU-09 · RN-02001 |
| `RESETEO_ACOTADO_A_CUENTAS_DE_ALUMNO` | `RESET_LIMITED_TO_STUDENT_ACCOUNTS` | Application | `Application/03` §3.11 · CU-11 · RN-02015, RN-02001 |
| `SOLICITANTE_NO_DECLARADO` | `REQUESTER_NOT_DECLARED` | Application | `Application/03` §3.6 · CU-06 · RN-02003 |
...
| `CONSULTA_SIN_ALCANCE_DECLARADO` | `QUERY_WITHOUT_DECLARED_SCOPE` | Infrastructure | `Infrastructure/03` §3.3 · CU-03 · RN-02003, RN-02011 |
...
| `ESCRITURA_QUE_REESCRIBE_EL_TEXTO_ORIGINAL` | `WRITE_REWRITES_ORIGINAL_JSON` | Infrastructure | `Infrastructure/03` §3.3 · CU-03 · RN-02008 |
| `FUENTE_DE_ALEATORIEDAD_NO_DISPONIBLE` | `RANDOMNESS_SOURCE_UNAVAILABLE` | Infrastructure | `Infrastructure/03` §3.7 · CU-07 · RN-02014 |
...
| `RETIRO_PARCIAL_NO_ADMITIDO` | `PARTIAL_DELETION_NOT_ALLOWED` | Infrastructure | `Infrastructure/03` §3.4 · CU-04 · RN-02007, RN-02004 |
...
| `UNICIDAD_DE_ADMINISTRADOR_VIOLADA` | `ADMINISTRATOR_UNIQUENESS_VIOLATED` | Infrastructure | `Infrastructure/03` §3.5 · CU-05 · RN-02001 |
...
| `VisorFiguras` ⟶ `VisorFiguras.razor` | `FigureViewer` ⟶ `FigureViewer.razor` | Componente Blazor que envuelve al visor: **tipo y nombre de archivo** | Intake §17.2.P.2 · GeometriaFactory-Visor, que lo declara como la **capa 1** de las tres; `Visor ADR-01`. Es el único identificador de tipo que ninguna de las seis clases había contado |
...
| Opciones de firma | `SigningOptions` | Tipo, configuración de infraestructura | `Infrastructure ADR-04` §2 puntos 3 y 5; intake §17.1.P.5 · GeometriaFactory-Infrastructure |
...
| Existe administrador | `AdministratorExistsAsync` | Miembro de `IAccountRepository` | `Application ADR-02` §2 punto 1; `RN-02001` |
| Correo ya registrado | `EmailIsRegisteredAsync` | Miembro de `IAccountRepository` | `Application ADR-02` §2 punto 1; `RN-02002` |
...
| Contraseña vigente | `CurrentPassword` | Miembro de `OwnPasswordChangeRequest` | `Contracts CU-02` FA-02; `RN-02016` |
...
| Índice de figura | `FigureIndex` | Miembro de `ErrorDetail` | `Contracts CU-06` §4 paso 3; `RN-02009` |
...
| Solicitud de cambio de situación de cuenta | `AccountStatusChangeRequest` | Tipo, contrato de solicitud | `Contracts CU-02` §4 paso 5 y `CA-06`, que le fija dos campos y **0 de contraseña** (`RN-02014`) |
| Resultado del cambio de situación de cuenta | `AccountStatusChangeResponse` | Tipo, contrato de respuesta | `Contracts CU-02` §4 paso 6 y `CA-02`; `RN-02016`, que hace que la habilitación devuelva la provisoria |
| Solicitud de baja de cuenta | `AccountDeletionRequest` | Tipo, contrato de solicitud | `Contracts CU-02` FA-01; `RN-02007`, que exige la confirmación escrita del correo |
...
| Habilitar | `Enable` | Operación de `Account` | `Domain CU-02` §4 pasos 4 y 5; `RN-02016`. **Cubre habilitar y rehabilitar, que son la misma transición** (`Contracts CU-02` FA-05) |
| Bloquear | `Block` | Operación de `Account` | `Domain CU-02` §4, tabla de transiciones |
| Admitir la baja | `AdmitDeletion` | Operación de `Account` | `Domain CU-02` FA-01; `RN-02007`. **Admite o rechaza, y no elimina**: la baja es física y la ejecuta la infraestructura |
| Resetear la contraseña | `ResetPassword` | Operación de `Account` | `Domain CU-13`; `RN-02012`, `RN-02015` |
...
| Retirar | `RemoveAsync` | Miembro de `IAccountRepository` | `Application CU-02` FA-02; `RN-02007`, que hace del retiro de la cuenta y de sus trabajos **una sola unidad de trabajo** |
...
| Dar de baja | `DeleteAsync` | Operación de `GovernCommissionAccountsUseCase` y de `AccountsPanel` | `Application CU-02` FA-02; `Definicion-Superficie-HTTP.md` §3, punto `A-08` **[el alcance se amplía en la 1.13, con la operación del panel; es el mismo concepto y por eso no lleva fila nueva]** |
...
| Correo escrito como confirmación | `ConfirmationEmail` | Miembro de `AccountDeletionRequest` y de `AccountDeletionForm` | `Contracts CU-02` FA-01; `RN-02007`, que hace de la confirmación escrita la condición de la baja **[el alcance se amplía en la 1.13, con el campo del diálogo de baja del panel; es el mismo concepto y por eso no lleva fila nueva]** |
...
| Enviar la solicitud al servicio de datos | `SendAsync` | Operación de `DataServiceClient` | `Web CU-10`; `RA-03`. **[decisión de esta emisión, declarada: es la generalización de `PostAsync` a los cuatro verbos, y existe para que el manejo del error de transporte y el reemplazo del texto que lleva la dirección interna estén escritos UNA sola vez]** |
...
| Traducir el motivo del contrato | `Explain` | Operación de `AccountsPanel` | Ídem §5, las cinco filas de error de operación; `Contracts CU-06` |
...
otra parte— y **`Web ADR-03` §2 tampoco** —la marca de sesión es `HttpOnly` y el guion no la ve, no
...
| Dibujar el estado en curso | `markPending` | Función de `surface-interaction.js` | `Wireframes-Panel-De-Cuentas.md` §5, estados «Aplicando un cambio de situación», «Ejecutando el reseteo» y «Ejecutando la baja»; `Wireframes-Registro-De-Cuenta.md` §5, estado «Enviando»; `Linea-Base-Visual.md` §2, `EST-05`, `EST-49` y `EST-50` |
...
**Por qué existe esta sección.** `Web ADR-03` §2 declara **cuatro guardianes de ruta** y la etapa `c`
...
| Intermediario del guardián de aprovisionamiento | `ProvisioningGateMiddleware` | Tipo de `GeometriaFactory.Web.Services` | `Web ADR-03` §2, guardián 1. La forma del nombre es la de `PanelSessionGateMiddleware`, que es el guardián 2, para que los dos se lean como lo que son: dos guardianes del mismo encaminamiento |

#### 6.18.2 Miembros y propiedades (5)

| Castellano | Inglés | Clase | Dónde está declarado el concepto |
| --- | --- | --- | --- |
| Si el administrador está configurado | `AdministratorConfigured` | Propiedad de `LaboratoryProvisioning` | `Web ADR-03` §2, guardián 1: el único dato que el punto responde. **No hay ninguna propiedad más**, y ésa es la decisión: ni correo, ni nombre, ni fecha, ni cantidad de cuentas |
| Si el laboratorio ya está configurado | `IsConfiguredAsync` | Miembro de `ConfigureAdministratorUseCase` **y** de `ProvisioningStateProbe` | `Application CU-10` §4 paso 2, que ya hacía esta pregunta adentro del flujo de alta: el miembro nuevo la expone de sólo lectura y no la duplica. **Un concepto, un nombre** (corolario 1 de §6.1): las dos capas preguntan lo mismo y lo llaman igual |
...
| A dónde desvía el aprovisionamiento ya resuelto | `NeutralDestination` | Miembro de `ProvisioningGateMiddleware` | `Web ADR-03` §2, guardián 1 y §6.4: el desvío es **neutro y no explica por qué**. El nombre dice **neutro** para que nadie le cuelgue después un motivo en la dirección; el destino es el de `NAV-03` de `Linea-Base-Visual.md` §5 |
| Los prefijos exentos del guardián | `ExemptPrefixes` | Miembro de `ProvisioningGateMiddleware` | **[decisión de esta emisión, declarada]**: el recurso estático y el guion del navegador **no son rutas pedidas** en el sentido de `ADR-03` §2, y desviarlos rompería la pantalla a la que el guardián manda. La lista es **cerrada** y se lee al lado de la de exclusión de `PanelRoutes`, que es de inclusión: los dos guardianes eligen el riesgo del lado en que se nota |
...
| Castellano | Inglés | Clase | Dónde está declarado el concepto |
| --- | --- | --- | --- |
| Operación sobre un trabajo | `WorkOperation` | Tipo, conjunto cerrado del dominio | `Domain CU-09` §3, que declara **ver, reeditar y eliminar** para el alumno, y `Domain CU-11` §3, que declara **ver y eliminar** para el administrador. El conjunto es **uno** y cada resolución declara qué subconjunto admite |
| Desenlace de la revisión | `WorkOutcome` | Tipo, conjunto cerrado del dominio | `Domain CU-10` §3; `Contratos-Abstractions.md` §4.2, que lo cuenta entre los seis conjuntos cerrados con **2** valores |
| Elemento de la proyección de listado | `WorkListEntry` | Tipo, resultado de la capa de aplicación | `Application CU-06` §4 paso 3 y `CU-07` §4 paso 4; `Contracts ADR-05`, que separa la proyección del detalle. **Es el complemento de `WorkDetail`, y su razón de ser es lo que NO declara** |
| Detalle del trabajo | `WorkDetail` | Tipo, resultado de la capa de aplicación | `Application CU-06` FA-01 y `CU-07` FA-03; `Contracts CU-05` §4, que declara sus bloques |
| Resultado del guardado del trabajo | `WorkOutcomeSnapshot` | Tipo, resultado de la capa de aplicación | `Application CU-04` §7, que declara identificador y estado; `Api CU-06` §4 paso 4, que le suma la fecha de registro |
| Caso de uso de cargar y reeditar un trabajo propio | `LoadAndEditOwnWorkUseCase` | Tipo, caso de uso | `Application CU-04` |
| Caso de uso de consultar los trabajos propios | `ConsultOwnWorksUseCase` | Tipo, caso de uso | `Application CU-06` |
| Caso de uso de revisar los trabajos de la comisión | `ReviewCommissionWorksUseCase` | Tipo, caso de uso | `Application CU-07` |
| Caso de uso de eliminar un trabajo | `DeleteWorkUseCase` | Tipo, caso de uso | `Application CU-09`, que reúne **los dos alcances opuestos** en un solo contrato |
| Solicitud de envío de trabajo | `WorkSubmissionRequest` | Tipo, contrato de solicitud | `Contracts CU-03` §4 paso 1 y `CA-01`, que le fija cuatro campos, el texto como **una sola cadena** y **0 campos de estado pretendido** |
| Resultado del envío de trabajo | `WorkSubmissionResponse` | Tipo, contrato de respuesta | `Contracts CU-03` §4 paso 4; `Api CU-06` §4 paso 4 |
| Elemento de listado de trabajo | `WorkListItem` | Tipo, contrato de respuesta | `Contracts CU-04` §4 paso 3 y §10, que declara **un solo tipo sin variante por papel** |
| Detalle del trabajo interpretado | `WorkDetailResponse` | Tipo, contrato de respuesta | `Contracts CU-05` §4 paso 2 y `CA-06`, que exige que sea **el mismo para los dos papeles** |
| Mapeo del trabajo | `WorkConfiguration` | Tipo, mapeo de persistencia | `Modelo-Datos-Logico.md` §2.2, tabla `Trabajo`; `Infrastructure BT-05`. La forma del nombre es la de `AccountConfiguration` |
| Repositorio de trabajos sobre el mapeador | `EfCoreWorkRepository` | Tipo, adaptador de infraestructura | `Infrastructure BT-10`; `Infrastructure CU-03` y `CU-04`. Es el **único** adaptador de `IWorkRepository`, y el tercero de los cuatro puertos en conectarse |
| Puntos de los trabajos | `WorkEndpoints` | Tipo, agrupador de puntos de acceso | `Definicion-Superficie-HTTP.md` §3, puntos `A-10` a `A-14`; `Api CU-06` y `CU-07` |
...
| Castellano | Inglés (identificador) | Etiqueta que ve la persona | Clase | Dónde está declarado el concepto |
| --- | --- | --- | --- | --- |
| `Ver` | `View` | — · no llega a la pantalla | Valor de `WorkOperation` | `Domain CU-09` §3 y `CU-11` §3. La admiten **las dos** resoluciones |
| `Eliminar` | `Delete` | — · no llega a la pantalla | Valor de `WorkOperation` | `Domain CU-09` §3 y `CU-11` §3. La admiten las dos, **con alcances opuestos** |
| `Aprobar` | `Approve` | «Aprobar» | Valor de `WorkOutcome` | `Domain CU-10` §4 paso 5, que lo lleva a `Approved`; `RN-02010` |
| `Rechazar` | `Reject` | «Rechazar» | Valor de `WorkOutcome` | `Domain CU-10` §4 paso 5, que lo lleva a `Rejected`; `RN-02010` |
...
| Estado fuera del alcance del administrador | `StatusOutsideAdministratorScope` | Miembro de `Work` | `Domain CU-11` §4 paso 3 y §10, `RN-02011`. **[decisión de la etapa `e`, declarada]**: el predicado de alcance se expone **como dato y no como método** para que la consulta del adaptador lo use tal cual; un método no lo traduce el motor de datos y terminaría copiado en la consulta, que es el segundo lugar donde `RN-02011` podría decir otra cosa |
| Constituir el trabajo | `Create` | Operación de `Work` | `Domain CU-05` §4, el único camino de alta de un trabajo |
| Reeditar | `Edit` | Operación de `Work` **y** valor de `WorkOperation` | `Domain CU-05` FA-01; `RN-02004`, que la acota al borrador. **Un concepto, un nombre** (corolario 1 de §6.1): la operación y el valor con el que se la consulta son lo mismo |
| Enviar | `Submit` | Operación de `Work` | `Domain CU-08` §4; `RN-02005`, que decide entre `Draft` y `Submitted` **por las observaciones y no por la operación** |
| Aplicar el desenlace | `ApplyOutcome` | Operación de `Work` | `Domain CU-10` §4; `RN-02010`. **Se escribe en la etapa `e` por `Domain BT-12` y NO se expone**: el punto `A-15` es de la etapa `h` |
| Resolver el acceso del alumno | `ResolveStudentAccess` | Operación de `Work` | `Domain CU-09`; `RN-02003`, `RN-02004`, `INV-02`, `INV-03` |
| Resolver el alcance del administrador | `ResolveAdministratorScope` | Operación de `Work` | `Domain CU-11`; `RN-02011`, `RN-02004`. Es el **contrato simétrico** del anterior, y no comparte ningún motivo con él |
| Listar los trabajos de un dueño | `ListOwnedByAsync` | Miembro de `IWorkRepository` | `Application CU-06` §4 paso 2, que exige que el recorte **viaje en el pedido** y no se aplique después |
| Listar los trabajos del alcance del administrador | `ListInAdministratorScopeAsync` | Miembro de `IWorkRepository` | `Application CU-07` §4 paso 3 y FA-02; `Infrastructure CU-03` §6, `CONSULTA_SIN_ALCANCE_DECLARADO`. **El nombre lleva el recorte adentro**, que es lo que hace estructuralmente imposible pedir el conjunto completo |
| Cargar un trabajo | `LoadAsync` | Operación de `LoadAndEditOwnWorkUseCase` | `Application CU-04` §4; `Definicion-Superficie-HTTP.md` §3, punto `A-10` |
| Reeditar un trabajo | `EditAsync` | Operación de `LoadAndEditOwnWorkUseCase` | `Application CU-04` FA-01; `Definicion-Superficie-HTTP.md` §3, punto `A-11` |
| Traer el detalle | `DetailAsync` | Operación de `ConsultOwnWorksUseCase` y de `ReviewCommissionWorksUseCase` | `Application CU-06` FA-01 y `CU-07` FA-03; `Definicion-Superficie-HTTP.md` §3, punto `A-14`. **Un solo nombre para los dos casos de uso**, porque el detalle es el mismo (`Contracts CU-05` `CA-06`) |
...
| Fecha de registro | `RegisteredAt` | Miembro de `WorkOutcomeSnapshot` y de `WorkSubmissionResponse` | `Api CU-06` §4 paso 4; `Modelo-Datos-Logico.md` §2.2, columna `Momento de creación`. **Es un sello del sistema y no la fecha del alumno** |
| Correo del dueño | `OwnerEmail` | Miembro de `WorkListEntry`, de `WorkDetail`, de `WorkListItem` y de `WorkDetailResponse` | `Contracts CU-04` §4 paso 3 y `CA-03`, que exige los datos del dueño **sin una segunda solicitud** |
| Nombre del dueño | `OwnerFirstName` | Ídem | `Contracts CU-04` §4 paso 3, «datos de identificación del alumno dueño» |
| Apellido del dueño | `OwnerLastName` | Ídem | `Contracts CU-04` §4 paso 3, «datos de identificación del alumno dueño» |
...
| La escritura de trabajos es del alumno | `WorkWritingLimitedToStudents` | Operación de `ContractTranslation` | `Definicion-Superficie-HTTP.md` §3, papel exigido de `A-10` y `A-11`. **[APARTAMIENTO DECLARADO DE LA ETAPA `e`, ELEVADO AL PRODUCT OWNER]**: el conjunto cerrado tiene código para la negativa de facultad **del administrador** y **ninguno para la simétrica**; se responde con el genérico y `403`, y el hueco se declara en lugar de inventarse un código (`Api ADR-04`) |
| Momento ordenable | `SortableMoment` | Miembro de `WorkConfiguration` | `Modelo-Datos-Logico.md` §2.1 y `RC-06`. **[decisión de la etapa `e`, declarada]**: el motor de datos **no ordena por un momento con desplazamiento**, y sin esta conversión la consulta de listado no se puede traducir. El nombre dice **qué propiedad se compra** —que el texto guardado se ordene como se ordenan los momentos— y no cómo |
