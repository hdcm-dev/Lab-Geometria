...
| Agregados por la capa 3 del visor y su anfitrión (1.21), **fuera de los 155** | 19 | 19 | §6.23 |
...
**Diecinueve filas: 4 tipos, 10 miembros, 3 funciones y 2 atributos de marcado.** Los dos atributos llevan a **once** los que `verify-stage-c.sh` autoriza, y los dos son **marcado servido**: el guion sigue sin pedir nada.
