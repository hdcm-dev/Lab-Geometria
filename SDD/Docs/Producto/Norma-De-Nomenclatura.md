...
`UseAccessToken`, `Open` y `Close` también. `Open` y `Close` **no se retiran**: la operación cambia
...
**32 filas, contadas:** 7 tipos y 25 miembros, propiedades y valores. Las 27 primeras las trajo
la marca de sesión (1.8); las **5 últimas** las trae el **guardián 2 de `Web ADR-03` §2** —«ninguna
...
#### 6.14.2 Miembros, propiedades y valores (25)
...
| Datos escritos en el formulario | `Input` | Propiedad de `SignIn`, ligada al envío del formulario | `Wireframes-Ingreso.md` §3 |
| Enviar el formulario | `SubmitAsync` | Operación de `SignIn` | `Wireframes-Ingreso.md` §4, fila «Enviar el formulario» |
...
| Formulario vigente | `Form` | Propiedad de `SignIn` | `Wireframes-Ingreso.md` §3 |
