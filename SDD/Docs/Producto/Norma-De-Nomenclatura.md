...
| --- | --- | --- |
| `V-1` | **Verificable con la precisión de la 1.4** | La población es la del instrumento de §2.1 —tokens de región de código— y el rango es el glosario entero: **catorce tablas desde la 1.14** —eran doce en la 1.12, trece con §6.16 en la 1.13—. El único residuo es distinguir el identificador **declarado** del **citado**, y esa distinción ya está escrita: es la de §4.1 entre uso propio y reporte de fuente |
