...
| Agregados por la capa 3 del visor y su anfitrión (1.21), **fuera de los 155** | 30 | 30 | §6.23 |
...
**Treinta filas: 4 tipos, 15 miembros, 5 funciones, 2 clases CSS portadas y 4 atributos de marcado.** Los cuatro atributos, con sus dos marcas de enlace, llevan a **quince** los que `verify-stage-c.sh` autoriza, y los dos son **marcado servido**: el guion sigue sin pedir nada.
