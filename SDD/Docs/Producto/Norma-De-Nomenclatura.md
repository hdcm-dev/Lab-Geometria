...
> **La regla que rige desde la 1.3.** Los dos actos van en **commits separados cuando tocan archivos distintos**. Cuando los dos caen sobre **el mismo archivo**, se admite **un solo commit**, con dos condiciones: el mensaje **declara los dos actos por separado**, cada uno con su cuadre; y si el acto 2 escribe, **dentro de una región de código**, un identificador de la población del tramo, **se separa igual** —ahí sí el acto 2 mueve una cifra de `V-4` y el cuadre deja de ser mecánico—.
