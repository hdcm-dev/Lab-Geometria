...
**Compatibilidad hacia atrás y deprecación, en este ensamblado.** No hay ninguna de las dos para los tipos de este ensamblado, y es deliberado: las dos unidades que compilan contra él son del mismo producto. La política es **el despliegue conjunto** de las dos unidades desplegables ante cualquier cambio incompatible. **La premisa «no hay clientes de terceros» dejó de ser cierta el 2026-09-12** (`PRODUCT-INTAKE` **4.3**/**4.4** §17.1.P.3): hay aplicaciones propias además del front que no compilan contra este ensamblado, y para ellas la compatibilidad y la deprecación viven en la **superficie REST**, versionada en la ruta por `/v{MAJOR}/` ([`ADR-00010`](../../Unidades-Entrega/GeometriaFactory-Api/05-Arquitectura-Tecnica/Adrs/ADR-00010-Version-En-La-Ruta-Solo-Major-Para-La-Superficie-Publica.md)), no en este ensamblado. **La versión vigente del contrato ya ejerció esa política**: el conjunto cerrado de estados y el de códigos de error cambiaron los dos (`RT-06` de la categoría 02).
