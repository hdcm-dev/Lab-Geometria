...
- [5. Cómo se verifica el cierre de la etapa](#5-cómo-se-verifica-el-cierre-de-la-etapa)
  ...
  - [5.2 El estado de cierre completo, con `PT-01.a` cerrada](#52-el-estado-de-cierre-completo-con-pt-01a-cerrada)
...
| 5 | `PT-01.c`: veinte minutos y reconexión | **NO CERRADO, y es el único.** Medido en el entorno de desarrollo contenido, las dos mitades pasaron; **sobre el hosting sigue sin medir**, y el reciclado del proceso sólo se observa ahí | [`../00-Contexto/Compatibilidad-Plataformas.md`](../00-Contexto/Compatibilidad-Plataformas.md) §2.5 y §2.6 |
...
**Lo que esta sección no hace: dar por cerrado lo que no lo está.** De los ocho criterios propios, **siete están cerrados** —1, 2, 3, 4, 6, 7 y 8— y **uno no**: el **5**, `PT-01.c`, cuya mitad de hosting sigue sin medir. Lo que falta **no es código**: es correr sobre la dirección pública la misma corrida cronometrada de veinte minutos y el mismo corte de red que §2.5 de [`../00-Contexto/Compatibilidad-Plataformas.md`](../00-Contexto/Compatibilidad-Plataformas.md) describe, que es el único lugar donde se puede observar si el proceso del hosting gratuito recicla la sesión. `R-07` de §7 sigue en pie.
