...
| `…/Persistence/Migrations/` | Transformaciones de esquema, versionadas con el código de su etapa. **Una transformación ya fusionada no se edita** | Intake §17.1.P.7 · GeometriaFactory-Infrastructure; `ADR-07` |
