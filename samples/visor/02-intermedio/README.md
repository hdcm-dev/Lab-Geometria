...
**Nivel:** Intermedio
**Estado de esta carpeta:** **Implementado.** Corre en 0 y **las 16 líneas coinciden con §6**, desde que el 2026-09-12 su documento pasó a 2.1 con el acto `[15]` (selección desde la escena por `onPieceSelected`). El defecto que este sample encontró también está cerrado.
**Documento que la gobierna:** [`ejemplo-02-intermedio.md`](../../../SDD/Docs/Unidades-Entrega/GeometriaFactory-Web/10-Examples/ejemplo-02-intermedio.md) 2.1, del que este README es la copia corta de §1, §3 y §4
